...
@C    constantFloat_id193 => Material.AmbientOcclusionValue
@C    constantFloat_id195 => Material.AmbientOcclusionDirectLightingFactorValue
@C    constantFloat_id197 => Material.CavityValue
@C    constantFloat_id199 => Material.CavityDiffuseValue
@C    constantFloat_id201 => Material.CavitySpecularValue
...
//
#line 954 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Game\log\shader_XenkoEditorForwardShadingEffect_10f60a2fb55daeca995bdf3852b82a72.hlsl"
...
@G    Pixel => 58c3aa1e12edaec1d01384b66b8eb160
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float constantFloat_id193;         // Offset:   24 Size:     4
//   float constantFloat_id195;         // Offset:   28 Size:     4
//   float constantFloat_id197;         // Offset:   32 Size:     4
//   float constantFloat_id199;         // Offset:   36 Size:     4
//   float constantFloat_id201;         // Offset:   40 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 983 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Game\log\shader_XenkoEditorForwardShadingEffect_10f60a2fb55daeca995bdf3852b82a72.hlsl"
...
#line 635
and r3.w, r4.y, l(0x0000ffff)  // r3.w <- <GetMaxLightCount_id272 return value>
...
#line 490
  ld_indexable(buffer)(uint,uint,uint,uint) r7.w, r10.xxxx, t1.yzwx  // r7.w <- realLightIndex
  iadd r10.x, r10.x, l(1)  // r10.x <- streams.lightIndex_id84
  ishl r8.w, r7.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyzw, r8.wwww, t2.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  bfi r7.w, l(31), l(1), r7.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r7.wwww, t2.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 216
  ...
  mul r6.x, r6.x, r6.x  // r6.x <- <SmoothDistanceAttenuation_id90 return value>
...
#line 279
  ...
  mul r8.z, r8.z, r8.z
  mul r7.w, r7.w, r8.z
  mad r14.xyz, r14.xyzx, r7.wwww, r9.yzwy  // r14.x <- <FresnelSchlick_id220 return value>.x; r14.y <- <FresnelSchlick_id220 return value>.y; r14.z <- <FresnelSchlick_id220 return value>.z

#line 274
  mul r7.w, r4.z, l(0.500000)  // r7.w <- k
  mad r8.z, -r4.z, l(0.500000), l(1.000000)
  mad r8.w, r6.x, r8.z, r7.w
  div r8.w, r6.x, r8.w  // r8.w <- <VisibilityhSchlickGGX_id238 return value>
  mad r7.w, r10.z, r8.z, r7.w
  div r7.w, r10.z, r7.w  // r7.w <- <VisibilityhSchlickGGX_id238 return value>

#line 326
  mul r7.w, r7.w, r8.w
  mul r6.x, r10.z, r6.x
  div r6.x, r7.w, r6.x  // r6.x <- <VisibilitySmithSchlickGGX_id240 return value>
...
#line 321
  ...
  div r7.x, r7.w, r7.x  // r7.x <- <NormalDistributionGGX_id254 return value>
...
#line 596
ushr r3.w, r4.y, l(16)  // r3.w <- <GetMaxLightCount_id281 return value>
...
#line 459
  ld_indexable(buffer)(uint,uint,uint,uint) r7.w, r5.wwww, t1.yzwx  // r7.w <- realLightIndex
...
#line 210
  ...
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id98 return value>
...
#line 586
  ...
  mul r12.xyz, r4.wwww, r12.xyzx  // r12.x <- streams.lightColorNdotL_id40.x; r12.y <- streams.lightColorNdotL_id40.y; r12.z <- streams.lightColorNdotL_id40.z
...
#line 279
  ...
  mul r9.w, r9.w, r9.w
  mul r9.y, r9.w, r9.y
  mad r14.xyz, r14.xyzx, r9.yyyy, r8.xyzx  // r14.x <- <FresnelSchlick_id220 return value>.x; r14.y <- <FresnelSchlick_id220 return value>.y; r14.z <- <FresnelSchlick_id220 return value>.z

#line 274
  mul r9.y, r9.x, l(0.500000)  // r9.y <- k
  mad r9.w, -r9.x, l(0.500000), l(1.000000)
  mad r11.w, r7.w, r9.w, r9.y
  div r11.w, r7.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id238 return value>
  mad r9.y, r9.z, r9.w, r9.y
  div r9.y, r9.z, r9.y  // r9.y <- <VisibilityhSchlickGGX_id238 return value>

#line 326
  mul r9.y, r9.y, r11.w
  mul r7.w, r9.z, r7.w
  div r7.w, r9.y, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id240 return value>
...
#line 321
  ...
  div r8.w, r9.y, r8.w  // r8.w <- <NormalDistributionGGX_id254 return value>
...
mov r8.x, r2.w  // r8.x <- streams.alphaRoughness_id63
...
#line 568
  ...
  mul r11.xyz, r6.wwww, cb1[r5.w + 26].xyzx
  mul r11.xyz, r3.wwww, r11.xyzx  // r11.x <- streams.lightColorNdotL_id40.x; r11.y <- streams.lightColorNdotL_id40.y; r11.z <- streams.lightColorNdotL_id40.z
...
#line 279
  ...
  mul r8.y, r8.y, r8.y
  mul r5.w, r5.w, r8.y
  mad r13.xyz, r13.xyzx, r5.wwww, r7.xyzx  // r13.x <- <FresnelSchlick_id220 return value>.x; r13.y <- <FresnelSchlick_id220 return value>.y; r13.z <- <FresnelSchlick_id220 return value>.z

#line 274
  mul r5.w, r8.x, l(0.500000)  // r5.w <- k
  mad r8.y, -r8.x, l(0.500000), l(1.000000)
  mad r8.w, r6.w, r8.y, r5.w
  div r8.w, r6.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id238 return value>
  mad r5.w, r8.z, r8.y, r5.w
  div r5.w, r8.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id238 return value>

#line 326
  mul r5.w, r5.w, r8.w
  mul r6.w, r8.z, r6.w
  div r5.w, r5.w, r6.w  // r5.w <- <VisibilitySmithSchlickGGX_id240 return value>
...
#line 321
  ...
  div r6.w, r6.w, r7.w  // r6.w <- <NormalDistributionGGX_id254 return value>
...
#line 298
dp2 r3.w, cb1[61].xxxx, cb1[43].zzzz
...
mov r10.xyz, r2.xyzx  // r10.x <- streams.matSpecularVisible_id64.x; r10.y <- streams.matSpecularVisible_id64.y; r10.z <- streams.matSpecularVisible_id64.z
...
loop 
  ige r8.w, r7.w, l(1)
  breakc_nz r8.w
  ige r8.w, r7.w, cb1[40].w
  if_nz r8.w
    break 
  endif 

#line 550
  dp3 r8.w, r6.xyzx, -cb1[41].xyzx
...
#line 407
  lt r10.w, cb1[r9.w + 62].x, r5.w

#line 410
  and r10.w, r10.w, l(1)  // r10.w <- cascadeIndex

#line 407
  bfi r11.yw, l(0, 30, 0, 30), l(0, 2, 0, 2), r7.wwww, l(0, 1, 0, 2)
  lt r11.y, cb1[r11.y + 62].x, r5.w

#line 410
  movc r10.w, r11.y, l(2), r10.w

#line 407
  lt r11.y, cb1[r11.w + 62].x, r5.w

#line 410
  movc r10.w, r11.y, l(3), r10.w
...
#line 290
  bfi r11.w, l(30), l(2), r7.w, r10.w
  ishl r12.w, r10.w, l(2)
  bfi r12.w, l(30), l(4), r7.w, r12.w
  dp4 r13.x, r4.xyzw, cb1[r12.w + 44].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r12.w + 45].xyzw  // r13.y <- shadowPosition.y
  dp4 r13.w, r4.xyzw, cb1[r12.w + 46].xyzw  // r13.w <- shadowPosition.z
  dp4 r12.w, r4.xyzw, cb1[r12.w + 47].xyzw  // r12.w <- shadowPosition.w
  add r13.z, r13.w, -cb1[60].x  // r13.z <- shadowPosition.z
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r18.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id118 return value>

#line 248
  mul r13.yw, r14.zzzw, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r18.zwzz, t4.xxxx, s1, r13.z  // r15.z <- <SampleTextureAndCompare_id118 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.xyxx, t4.xxxx, s1, r13.z  // r14.z <- <SampleTextureAndCompare_id118 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r19.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id118 return value>

#line 248
  mad r12.w, r13.w, r13.x, r12.w

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r19.zwzz, t4.xxxx, s1, r13.z
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t4.xxxx, s1, r13.z  // r14.z <- <SampleTextureAndCompare_id118 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r17.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id118 return value>

#line 251
  mad r12.w, r13.y, r13.x, r12.w

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r17.zwzz, t4.xxxx, s1, r13.z

#line 252
  mad r12.w, r13.w, r13.x, r12.w
  mul r13.x, r15.y, r15.x
  mad r13.yw, r16.xxxy, cb1[43].zzzw, r14.xxxy

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r13.y, r13.ywyy, t4.xxxx, s1, r13.z  // r13.y <- <SampleTextureAndCompare_id118 return value>
...
#line 419
  iadd r13.y, r11.w, l(-1)
  add r13.y, -cb1[r13.y + 62].x, cb1[r11.w + 62].x
  movc r13.y, r10.w, r13.y, cb1[r11.w + 62].x  // r13.y <- splitSize
  add r11.w, -r5.w, cb1[r11.w + 62].x
  div r11.w, r11.w, r13.y  // r11.w <- splitDist
  lt r13.y, r11.w, l(0.200000)

#line 290
  ishl r9.w, r9.w, l(2)
  imad r9.w, r10.w, l(4), r9.w
  iadd r9.w, r9.w, l(4)
  dp4 r14.x, r4.xyzw, cb1[r9.w + 44].xyzw  // r14.x <- shadowPosition.x
  dp4 r14.y, r4.xyzw, cb1[r9.w + 45].xyzw  // r14.y <- shadowPosition.y
  dp4 r10.w, r4.xyzw, cb1[r9.w + 46].xyzw  // r10.w <- shadowPosition.z
  dp4 r4.x, r4.xyzw, cb1[r9.w + 47].xyzw  // r4.x <- shadowPosition.w
  add r14.z, r10.w, -cb1[60].x  // r14.z <- shadowPosition.z
...
#line 226
  ...
  round_ni r13.zw, r4.xxxy  // r13.z <- base_uv.x; r13.w <- base_uv.y
  add r4.xy, r4.xyxx, -r13.zwzz  // r4.x <- s; r4.y <- t
  add r13.zw, r13.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
  mul r13.zw, r13.zzzw, cb1[43].zzzw
...
#line 239
  ...
  mad r17.xyzw, r16.xwzw, cb1[43].zwzw, r13.zwzw

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id118 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id118 return value>

#line 250
  mov r15.zw, r16.wwwy
  mad r17.xyzw, r15.xzxw, cb1[43].zwzw, r13.zwzw

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r17.xyxx, t4.xxxx, s1, r4.z  // r9.w <- <SampleTextureAndCompare_id118 return value>

#line 249
  mad r18.xyzw, r16.xyzy, cb1[43].zwzw, r13.zwzw

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r10.w, r18.xyxx, t4.xxxx, s1, r4.z  // r10.w <- <SampleTextureAndCompare_id118 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r18.zwzz, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id118 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r17.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id118 return value>

#line 251
  mov r16.y, r15.y
  mad r16.xyzw, r16.xyzy, cb1[43].zwzw, r13.zwzw

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r16.x, r16.xyxx, t4.xxxx, s1, r4.z  // r16.x <- <SampleTextureAndCompare_id118 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r16.y, r16.zwzz, t4.xxxx, s1, r4.z  // r16.y <- <SampleTextureAndCompare_id118 return value>

#line 253
  mad r13.zw, r15.xxxy, cb1[43].zzzw, r13.zzzw

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.zwzz, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id118 return value>
...
#line 424
    if_z r11.y
      mul_sat r11.y, r11.w, l(5.000000)
      mad r11.w, r11.y, l(-2.000000), l(3.000000)
      mul r11.y, r11.y, r11.y
      mul r11.y, r11.y, r11.w  // r11.y <- lerpAmt

#line 245
      mul r11.w, r14.x, r14.y
      mul r4.y, r14.x, r4.y
      mul r4.y, r4.y, l(7.000000)
      mad r4.x, r11.w, r4.x, r4.y  // r4.x <- shadow

#line 251
      mul r13.yz, r14.xxyx, r14.zzwz

#line 247
      mad r4.x, r13.y, r9.w, r4.x
      mul r4.y, r10.w, r14.y
...
#line 430
      ...
      mad r13.x, r11.y, r4.y, r4.x
    endif 
  endif   // r13.x <- shadow

#line 552
  mul r4.xyz, r13.xxxx, cb1[42].xyzx
...
#line 617
  ...
  dp3 r10.w, -cb1[41].xyzx, r13.xyzx
...
#line 279
  ...
  mad r14.xyz, r14.xyzx, r10.wwww, r10.xyzx  // r14.x <- <FresnelSchlick_id220 return value>.x; r14.y <- <FresnelSchlick_id220 return value>.y; r14.z <- <FresnelSchlick_id220 return value>.z

#line 274
  mul r10.w, r11.x, l(0.500000)  // r10.w <- k
  mad r11.y, -r11.x, l(0.500000), l(1.000000)
  mad r11.w, r8.w, r11.y, r10.w
  div r11.w, r8.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id238 return value>
  mad r10.w, r11.z, r11.y, r10.w
  div r10.w, r11.z, r10.w  // r10.w <- <VisibilityhSchlickGGX_id238 return value>

#line 326
  mul r10.w, r10.w, r11.w
  mul r8.w, r11.z, r8.w
  div r8.w, r10.w, r8.w  // r8.w <- <VisibilitySmithSchlickGGX_id240 return value>

#line 321
  mul r10.w, r11.x, r11.x  // r10.w <- alphaR2
  mul r9.w, r9.w, r9.w
  ...
  div r9.w, r10.w, r9.w  // r9.w <- <NormalDistributionGGX_id254 return value>
...
#line 543
mul r4.xyz, cb0[1].zzzz, cb1[66].xyzx  // r4.x <- lightColor.x; r4.y <- lightColor.y; r4.z <- lightColor.z
...
mad r2.xyz, r2.xyzx, r0.wwww, r1.wwww  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id255 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id255 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id255 return value>.z

#line 534
mul r5.xyz, r4.xyzx, r2.xyzx  // r5.x <- <ComputeEnvironmentLightContribution_id473 return value>.x; r5.y <- <ComputeEnvironmentLightContribution_id473 return value>.y; r5.z <- <ComputeEnvironmentLightContribution_id473 return value>.z
...
#line 360
mad r5.yzw, cb1[68].xxyz, r1.wwww, cb1[67].xxyz  // r5.y <- color.x; r5.z <- color.y; r5.w <- color.z
mad r5.yzw, cb1[69].xxyz, -r3.wwww, r5.yyzw
mad r5.yzw, cb1[70].xxyz, r0.wwww, r5.yyzw

#line 365
mul r6.xyz, r1.wwww, cb1[71].xyzx
mad r5.yzw, r6.xxyz, r0.wwww, r5.yyzw
mul r6.xyz, r1.wwww, cb1[72].xyzx
mad r5.yzw, r6.xxyz, -r3.wwww, r5.yyzw
mad r1.w, r5.x, l(3.000000), l(-1.000000)
mad r5.xyz, cb1[73].xyzx, r1.wwww, r5.yzwy  // r5.x <- color.x; r5.y <- color.y; r5.z <- color.z
...
#line 525
mul r5.xyz, r5.xyzx, cb1[80].xxxx
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id307 return value>.x; r0.y <- <Compute_id307 return value>.y; r0.z <- <Compute_id307 return value>.z

#line 529
mul r0.xyz, r0.xyzx, cb1[80].xxxx
...
float FilterShadow_id114(float2 position, float positionDepth)
{
...

    {
        ...
        float v1 = (3 + t) / vw1;
        float v2 = t / vw2 + 2;
        shadow += uw0 * vw0 * SampleTextureAndCompare_id118(base_uv + float2(u0, v0) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw1 * vw0 * SampleTextureAndCompare_id118(base_uv + float2(u1, v0) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw2 * vw0 * SampleTextureAndCompare_id118(base_uv + float2(u2, v0) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw0 * vw1 * SampleTextureAndCompare_id118(base_uv + float2(u0, v1) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw1 * vw1 * SampleTextureAndCompare_id118(base_uv + float2(u1, v1) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw2 * vw1 * SampleTextureAndCompare_id118(base_uv + float2(u2, v1) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw0 * vw2 * SampleTextureAndCompare_id118(base_uv + float2(u0, v2) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw1 * vw2 * SampleTextureAndCompare_id118(base_uv + float2(u1, v2) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw2 * vw2 * SampleTextureAndCompare_id118(base_uv + float2(u2, v2) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow /= 144.0f;
    }
    return shadow;
}
float GetAngleAttenuation_id100(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float ComputeShadowFromCascade_id117(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    ...
    return FilterShadow_id114(shadowPosition.xy, shadowPosition.z);
}
float3 GetShadowPositionOffset_id116(float offsetScale, float nDotL, float3 normal)
{
    float normalOffsetScale = saturate(1.0f - nDotL);
    return 2.0f * ShadowMapTextureTexelSize_id102.x * offsetScale * normalOffsetScale * normal;
}
void ComputeShadow_id115(inout PS_STREAMS streams, int lightIndex)
{
...
void ProcessLight_id101(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    attenuation *= GetAngleAttenuation_id100(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
...
float NormalDistributionGGX_id254(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id207 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    ComputeShadow_id115(streams, lightIndex);
    ...
    shadowPosition += GetShadowPositionOffset_id116(OffsetScales_id165[lightIndex], streams.NdotL_id43, streams.normalWS_id16);
    if (cascadeIndex < TCascadeCount_id166)
    {
        shadow = ComputeShadowFromCascade_id117(shadowPosition, cascadeIndex, lightIndex);
        ...
        if (splitDist < 0.2)
        {
            ...
            {
                float nextShadow = ComputeShadowFromCascade_id117(shadowPosition, cascadeIndex + 1, lightIndex);
...
void PrepareDirectLightCore_id104(inout PS_STREAMS streams, int lightIndex)
{
...
float Compute_id394(inout PS_STREAMS streams)
{
...
void PrepareEnvironmentLight_id319(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id302(sampleDirection).rgb * Intensity_id180 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id307(streams, sampleDirection).rgb * Intensity_id180 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeEnvironmentLightContribution_id473(inout PS_STREAMS streams)
{
...
float3 ComputeEnvironmentLightContribution_id424(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id472(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id336(streams, specularColor);
    float geometricShadowing = Compute_id365(streams);
    float normalDistribution = Compute_id394(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeDirectLightContribution_id423(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id207 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
void Compute_id528(inout PS_STREAMS streams)
{
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id423(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id472(streams);
            }
        }
    }
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id424(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id473(streams);
        }
    }
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id207 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id513(inout PS_STREAMS streams)
{
    streams.matCavitySpecular_id55 = Compute_id334().r;
}
void Compute_id508(inout PS_STREAMS streams)
{
    streams.matCavityDiffuse_id54 = Compute_id332().r;
}
void Compute_id503(inout PS_STREAMS streams)
{
    streams.matCavity_id53 = Compute_id330().r;
}
void Compute_id498(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusionDirectLightingFactor_id52 = Compute_id328().r;
}
void Compute_id493(inout PS_STREAMS streams)
{
    streams.matAmbientOcclusion_id51 = Compute_id326().r;
}
void Compute_id488(inout PS_STREAMS streams)
{
    float metalness = Compute_id324().r;
