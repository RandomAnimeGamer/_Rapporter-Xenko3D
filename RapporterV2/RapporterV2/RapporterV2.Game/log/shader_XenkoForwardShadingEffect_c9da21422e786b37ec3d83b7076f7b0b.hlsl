...
//
#line 694 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Game\log\shader_XenkoForwardShadingEffect_c9da21422e786b37ec3d83b7076f7b0b.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
@G    Pixel => d1b37eb626c392bef40bd796a667c692
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 764 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Game\log\shader_XenkoForwardShadingEffect_c9da21422e786b37ec3d83b7076f7b0b.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t0.xyzw, s1  // r2.x <- <Compute_id255 return value>.x; r2.y <- <Compute_id255 return value>.y; r2.z <- <Compute_id255 return value>.z; r2.w <- <Compute_id255 return value>.w
...
mov r5.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r4.xy, r5.xyzw, t1.xyzw  // r4.x <- streams.lightData_id87.x; r4.y <- streams.lightData_id87.y
...
#line 359
  ld_indexable(buffer)(uint,uint,uint,uint) r4.z, r10.xxxx, t2.yzxw  // r4.z <- realLightIndex
  iadd r10.x, r10.x, l(1)  // r10.x <- streams.lightIndex_id88
  ishl r4.w, r4.z, l(1)
  ld_indexable(buffer)(float,float,float,float) r11.xyzw, r4.wwww, t3.xyzw  // r11.x <- pointLight1.x; r11.y <- pointLight1.y; r11.z <- pointLight1.z; r11.w <- pointLight1.w
  bfi r4.z, l(31), l(1), r4.z, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r4.zzzz, t3.xyzw  // r12.x <- pointLight2.x; r12.y <- pointLight2.y; r12.z <- pointLight2.z
...
#line 328
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r4.wwww, t2.yzwx  // r5.w <- realLightIndex
  iadd r4.w, r4.w, l(1)  // r4.w <- streams.lightIndex_id88
  ishl r6.w, r5.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r11.xyz, r6.wwww, t4.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z

#line 334
  bfi r12.xyz, l(30, 30, 30, 0), l(2, 2, 2, 0), r5.wwww, l(1, 2, 3, 0)
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r12.xxxx, t4.xyzw  // r13.x <- spotLight2.x; r13.y <- spotLight2.y; r13.z <- spotLight2.z
  ld_indexable(buffer)(float,float,float,float) r12.xyw, r12.yyyy, t4.xywz  // r12.x <- spotLight3.x; r12.y <- spotLight3.y; r12.w <- spotLight3.z
  ld_indexable(buffer)(float,float,float,float) r14.xyz, r12.zzzz, t4.xyzw  // r14.x <- spotLight4.x; r14.y <- spotLight4.y; r14.z <- spotLight4.z
...
#line 231
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r12.xyz, r5.wwww, r14.xyzx  // r12.x <- streams.lightColor_id43.x; r12.y <- streams.lightColor_id43.y; r12.z <- streams.lightColor_id43.z
...
#line 263
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, cb1[50].w  // r0.x <- <Compute_id242 return value>.x; r0.y <- <Compute_id242 return value>.y; r0.z <- <Compute_id242 return value>.z
