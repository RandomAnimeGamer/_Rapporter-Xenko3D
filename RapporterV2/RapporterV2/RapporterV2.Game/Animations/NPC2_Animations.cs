...
namespace RapporterV2.Animations { public class NPC2_Animations : SyncScript {
    private readonly EventReceiver<int> talk = new EventReceiver<int>(NPCTalk2.ttm); AnimationComponent anim;
