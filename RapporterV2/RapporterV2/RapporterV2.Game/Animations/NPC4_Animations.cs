...
namespace RapporterV2.Animations { public class NPC4_Animations : SyncScript {
    private readonly EventReceiver<int> talk = new EventReceiver<int>(NPCTalk4.ttm); AnimationComponent anim;
