...
namespace SiliconStudio.DataSerializers
{
   	...
   	public static class RapporterV2SerializerFactory
	{
        ...
        internal static void Initialize()
        {
			...
			assemblySerializers.Modules.Add(typeof(SiliconStudio.DataSerializers.RapporterV2_GameSerializerFactory).GetTypeInfo().Module);
            ...
            AssemblyRegistry.Register(typeof(RapporterV2SerializerFactory).GetTypeInfo().Assembly, AssemblyCommonCategories.Engine);
        }
	}
}
