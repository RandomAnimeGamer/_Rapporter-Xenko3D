...
@C    Bias_id174 => ShadowMapFilterPcf.Bias.directLightGroups[3]
...
*****     Stages      *****
***************************
@G    Vertex => 0369769d6049a5a5635712d5ce4da48e
//
...
//   float Bias_id174;                  // Offset: 1044 Size:     4 [unused]
//   float3 AmbientLight_id175;         // Offset: 1056 Size:    12 [unused]
//   float3 SphericalColors_id177[9];   // Offset: 1072 Size:   140 [unused]
//   float MipCount_id178;              // Offset: 1212 Size:     4 [unused]
//   float4x4 SkyMatrix_id180;          // Offset: 1216 Size:    64 [unused]
//   float Intensity_id181;             // Offset: 1280 Size:     4 [unused]
//
// }
//
//
...
//
#line 174 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_Picking_bd43f2bfded24ef4de416d8e326faaeb.hlsl"
...
//
#line 200 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_Picking_bd43f2bfded24ef4de416d8e326faaeb.hlsl"
...
cbuffer PerMaterial 
{
    ...
    float2 scale_id231;
    float2 offset_id232;
    float4 constantColor_id234;
    float2 scale_id238;
    float2 offset_id239;
    float constantFloat_id244;
    float4 constantColor_id247;
    float constantFloat_id249;
    float2 scale_id253;
    float2 offset_id254;
    float constantFloat_id256;
    float constantFloat_id258;
    float constantFloat_id260;
    float constantFloat_id262;
    float2 scale_id266;
    float2 offset_id267;
    float4 constantColor_id268;
    float constantFloat_id272;
};
cbuffer PerView 
{
    float4x4 View_id22;
