...
@C    constantColor_id103 => Material.DiffuseValue
@C    constantFloat_id107 => Material.GlossinessValue
@C    constantFloat_id110 => Material.MetalnessValue
...
//
#line 660 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_273e796c7089fead56ffe89a8ec22eec.hlsl"
...
@G    Pixel => 3b40a6d494bfd950b3a557f336897f30
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float4 constantColor_id103;        // Offset:   16 Size:    16
//   float constantFloat_id107;         // Offset:   32 Size:     4
//   float constantFloat_id110;         // Offset:   36 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 689 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_273e796c7089fead56ffe89a8ec22eec.hlsl"
...
mul r1.w, r2.w, r0.w
mad r2.xyz, r1.wwww, r2.xyzx, r3.xyzx  // r2.x <- <BasicBlend_id400 return value>.x; r2.y <- <BasicBlend_id400 return value>.y; r2.z <- <BasicBlend_id400 return value>.z
...
#line 434
and r2.w, r4.y, l(0x0000ffff)  // r2.w <- <GetMaxLightCount_id193 return value>
...
#line 306
  ld_indexable(buffer)(uint,uint,uint,uint) r7.w, r4.zzzz, t2.yzwx  // r7.w <- realLightIndex
  iadd r4.z, r4.z, l(1)  // r4.z <- streams.lightIndex_id84
  ishl r8.w, r7.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r11.xyzw, r8.wwww, t3.xyzw  // r11.x <- pointLight1.x; r11.y <- pointLight1.y; r11.z <- pointLight1.z; r11.w <- pointLight1.w
  bfi r7.w, l(31), l(1), r7.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r7.wwww, t3.xyzw  // r12.x <- pointLight2.x; r12.y <- pointLight2.y; r12.z <- pointLight2.z
...
#line 164
  ...
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id71 return value>
...
#line 184
  ...
  div r10.w, r7.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id159 return value>
...
#line 220
  mul r7.y, r7.y, r10.w
  mul r7.w, r4.w, r7.w
  div r7.y, r7.y, r7.w  // r7.y <- <VisibilitySmithSchlickGGX_id161 return value>
...
#line 215
  ...
  div r7.x, r7.w, r7.x  // r7.x <- <NormalDistributionGGX_id175 return value>
...
#line 395
ushr r2.w, r4.y, l(16)  // r2.w <- <GetMaxLightCount_id202 return value>
...
#line 275
  ld_indexable(buffer)(uint,uint,uint,uint) r7.w, r6.wwww, t2.yzwx  // r7.w <- realLightIndex
  iadd r6.w, r6.w, l(1)  // r6.w <- streams.lightIndex_id84
  ishl r8.w, r7.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r8.wwww, t4.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z
...
#line 158
  ...
  mad r7.w, -r7.w, r7.w, l(1.000000)
  max r7.w, r7.w, l(0.000000)  // r7.w <- smoothFactor
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id79 return value>
...
#line 189
  ...
  mul r9.y, r9.y, r9.y
  mul r8.w, r8.w, r9.y
  mad r14.xyz, r14.xyzx, r8.wwww, r8.xyzx  // r14.x <- <FresnelSchlick_id141 return value>.x; r14.y <- <FresnelSchlick_id141 return value>.y; r14.z <- <FresnelSchlick_id141 return value>.z

#line 184
  mul r8.w, r9.x, l(0.500000)  // r8.w <- k
  mad r9.y, -r9.x, l(0.500000), l(1.000000)
  mad r9.w, r7.w, r9.y, r8.w
  div r9.w, r7.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id159 return value>
  mad r8.w, r9.z, r9.y, r8.w
  div r8.w, r9.z, r8.w  // r8.w <- <VisibilityhSchlickGGX_id159 return value>

#line 220
  mul r8.w, r8.w, r9.w
  mul r7.w, r9.z, r7.w
  div r7.w, r8.w, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id161 return value>
...
#line 189
  ...
  mul r6.w, r6.w, r6.w
  mul r3.w, r3.w, r6.w
  mad r13.xyz, r13.xyzx, r3.wwww, r7.xyzx  // r13.x <- <FresnelSchlick_id141 return value>.x; r13.y <- <FresnelSchlick_id141 return value>.y; r13.z <- <FresnelSchlick_id141 return value>.z

#line 184
  mul r3.w, r8.x, l(0.500000)  // r3.w <- k
  mad r6.w, -r8.x, l(0.500000), l(1.000000)
  mad r7.w, r5.w, r6.w, r3.w
  div r7.w, r5.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id159 return value>
  mad r3.w, r8.z, r6.w, r3.w
  div r3.w, r8.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id159 return value>

#line 220
  mul r3.w, r3.w, r7.w
  mul r5.w, r8.z, r5.w
  div r3.w, r3.w, r5.w  // r3.w <- <VisibilitySmithSchlickGGX_id161 return value>
...
#line 215
  ...
  div r5.x, r5.w, r5.x  // r5.x <- <NormalDistributionGGX_id175 return value>
...
const static bool TIsEnergyConservative_id114 = false;
static const float PI_id116 = 3.14159265358979323846;
...
float NormalDistributionGGX_id175(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id116 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id116 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
{
    return float4(constantFloat_id110, constantFloat_id110, constantFloat_id110, constantFloat_id110);
}
...
{
    float4 backColor = Compute_id218(streams);
    float4 frontColor = Compute_id220();
...
void Compute_id395(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id116 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id380(inout PS_STREAMS streams)
{
    float metalness = Compute_id226().r;
