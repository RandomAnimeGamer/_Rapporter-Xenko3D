...
@R    ShadowMapTexture_id100 => ShadowMap.Texture.directLightGroups[3] [Stage: Pixel, Slot: (6-6)]
...
//
#line 808 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_8d86b332536b10306fb287cc957c861a.hlsl"
...
@G    Pixel => 73c8bfce2eafb82f63f24ba112d0f60e
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
// Sampler_id184                     sampler      NA          NA    1        1
...
// ShadowMapTexture_id100            texture  float4          2d    6        1
...
//
#line 837 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_8d86b332536b10306fb287cc957c861a.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s1  // r1.x <- <Compute_id221 return value>.x; r1.y <- <Compute_id221 return value>.y; r1.z <- <Compute_id221 return value>.z; r1.w <- <Compute_id221 return value>.w

#line 603
mad r2.xy, v3.xyxx, cb0[1].xyxx, cb0[1].zwzz
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t1.xyzw, s1  // r2.x <- <Compute_id223 return value>.x; r2.y <- <Compute_id223 return value>.y; r2.z <- <Compute_id223 return value>.z
...
#line 568
and r0.w, r3.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id173 return value>
...
#line 538
ushr r0.w, r3.y, l(16)  // r0.w <- <GetMaxLightCount_id182 return value>
...
#line 214
  ...
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id79 return value>
...
#line 293
dp2 r0.w, cb1[61].xxxx, cb1[43].zzzz
...
mov r8.xyz, r5.xyzx  // r8.x <- directLightingContribution.x; r8.y <- directLightingContribution.y; r8.z <- directLightingContribution.z
mov r2.w, l(0)  // r2.w <- i
loop 
  ige r5.w, r2.w, l(1)
  breakc_nz r5.w
  ige r5.w, r2.w, cb1[40].w
  if_nz r5.w
    break 
  endif 

#line 492
  dp3 r5.w, r6.xyzx, -cb1[41].xyzx
...
#line 366
  ...
  lt r8.w, cb1[r9.x + 62].x, r4.w

#line 369
  movc r7.w, r8.w, l(2), r7.w

#line 366
  lt r8.w, cb1[r9.y + 62].x, r4.w
...
#line 373
  mad r3.xyz, r9.xxxx, r6.xyzx, r4.xyzx  // r3.x <- shadowPosition.x; r3.y <- shadowPosition.y; r3.z <- shadowPosition.z

#line 285
  bfi r9.x, l(30), l(2), r2.w, r7.w
  ishl r9.y, r7.w, l(2)
  bfi r9.y, l(30), l(4), r2.w, r9.y
  dp4 r10.x, r3.xyzw, cb1[r9.y + 44].xyzw  // r10.x <- shadowPosition.x
  dp4 r10.y, r3.xyzw, cb1[r9.y + 45].xyzw  // r10.y <- shadowPosition.y
  dp4 r9.z, r3.xyzw, cb1[r9.y + 46].xyzw  // r9.z <- shadowPosition.z
  dp4 r9.y, r3.xyzw, cb1[r9.y + 47].xyzw  // r9.y <- shadowPosition.w
  add r10.z, r9.z, -cb1[60].x  // r10.z <- shadowPosition.z
  div r9.yzw, r10.xxyz, r9.yyyy  // r9.y <- shadowPosition.x; r9.z <- shadowPosition.y; r9.w <- shadowPosition.z

#line 230
  mad r9.yz, r9.yyzy, cb1[43].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
  ...
  mul r10.xy, r10.xyxx, cb1[43].zwzz
...
#line 243
  ...
  mad r14.xyzw, r13.xwzw, cb1[43].zwzw, r10.xyxy

#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r9.z, r14.xyxx, t6.xxxx, s0, r9.w  // r9.z <- <SampleTextureAndCompare_id99 return value>

#line 252
  mul r11.zw, r10.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r14.x, r14.zwzz, t6.xxxx, s0, r9.w  // r14.x <- <SampleTextureAndCompare_id99 return value>
...
#line 255
  ...
  mov r12.zw, r13.wwwy
  mad r14.xyzw, r12.xzxw, cb1[43].zwzw, r10.xyxy
...
#line 251
  ...
  mad r15.xyzw, r13.xyzy, cb1[43].zwzw, r10.xyxy
...
#line 254
  ...
  mov r13.y, r12.y
  mad r13.xyzw, r13.xyzy, cb1[43].zwzw, r10.xyxy
...
#line 256
  ...
  mad r10.xy, r12.xyxx, cb1[43].zwzz, r10.xyxx

#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r10.xyxx, t6.xxxx, s0, r9.w  // r9.w <- <SampleTextureAndCompare_id99 return value>
...
#line 378
  iadd r9.w, r9.x, l(-1)
  add r9.w, -cb1[r9.w + 62].x, cb1[r9.x + 62].x
  movc r9.w, r7.w, r9.w, cb1[r9.x + 62].x  // r9.w <- splitSize
  add r9.x, -r4.w, cb1[r9.x + 62].x
...
#line 285
  ...
  iadd r6.w, r6.w, l(4)
  dp4 r10.x, r3.xyzw, cb1[r6.w + 44].xyzw  // r10.x <- shadowPosition.x
  dp4 r10.y, r3.xyzw, cb1[r6.w + 45].xyzw  // r10.y <- shadowPosition.y
  dp4 r7.w, r3.xyzw, cb1[r6.w + 46].xyzw  // r7.w <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb1[r6.w + 47].xyzw  // r3.x <- shadowPosition.w
  add r10.z, r7.w, -cb1[60].x  // r10.z <- shadowPosition.z
...
#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r3.x, r14.xyxx, t6.xxxx, s0, r3.z  // r3.x <- <SampleTextureAndCompare_id99 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r3.y, r14.zwzz, t6.xxxx, s0, r3.z  // r3.y <- <SampleTextureAndCompare_id99 return value>
...
#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r6.w, r14.xyxx, t6.xxxx, s0, r3.z  // r6.w <- <SampleTextureAndCompare_id99 return value>

#line 253
  mad r15.xyzw, r13.xyzy, cb1[43].zwzw, r10.xyxy

#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r15.xyxx, t6.xxxx, s0, r3.z  // r7.w <- <SampleTextureAndCompare_id99 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r11.z, r15.zwzz, t6.xxxx, s0, r3.z  // r11.z <- <SampleTextureAndCompare_id99 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r14.zwzz, t6.xxxx, s0, r3.z  // r11.w <- <SampleTextureAndCompare_id99 return value>
...
#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r12.z, r13.xyxx, t6.xxxx, s0, r3.z  // r12.z <- <SampleTextureAndCompare_id99 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r13.zwzz, t6.xxxx, s0, r3.z  // r12.w <- <SampleTextureAndCompare_id99 return value>

#line 257
  mad r10.xy, r12.xyxx, cb1[43].zwzz, r10.xyxx

#line 210
  sample_c_indexable(texture2d)(float,float,float,float) r3.z, r10.xyxx, t6.xxxx, s0, r3.z  // r3.z <- <SampleTextureAndCompare_id99 return value>
...
#line 494
  mul r3.xyz, r9.zzzz, cb1[42].xyzx
...
#line 342
mad r3.xyz, cb1[68].xyzx, r2.wwww, cb1[67].xyzx  // r3.x <- color.x; r3.y <- color.y; r3.z <- color.z
mad r3.xyz, cb1[69].xyzx, -r0.xxxx, r3.xyzx
mad r3.xyz, cb1[70].xyzx, r0.wwww, r3.xyzx

#line 347
mul r4.xyz, r2.wwww, cb1[71].xyzx
mad r3.xyz, r4.xyzx, r0.wwww, r3.xyzx
mul r4.xyz, r2.wwww, cb1[72].xyzx
mad r3.xyz, r4.xyzx, -r0.xxxx, r3.xyzx
mad r0.z, r0.z, l(3.000000), l(-1.000000)
mad r3.xyz, cb1[73].xyzx, r0.zzzz, r3.xyzx
mul r4.xyz, r0.wwww, cb1[74].xyzx
mad r3.xyz, r4.xyzx, -r0.xxxx, r3.xyzx
mad r0.x, r0.w, r0.w, -r0.y
mad r0.xyz, cb1[75].xyzx, r0.xxxx, r3.xyzx  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z

#line 472
mul r0.xyz, r0.xyzx, cb1[80].xxxx  // r0.x <- streams.envLightDiffuseColor_id41.x; r0.y <- streams.envLightDiffuseColor_id41.y; r0.z <- streams.envLightDiffuseColor_id41.z

#line 481
mul r0.xyz, r0.xyzx, r1.xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id228 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id228 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id228 return value>.z

#line 718
mad r0.xyz, r1.xyzx, cb1[66].xyzx, r0.xyzx  // r0.x <- environmentLightingContribution.x; r0.y <- environmentLightingContribution.y; r0.z <- environmentLightingContribution.z
...
float FilterShadow_id95(float2 position, float positionDepth)
{
...

    {
        ...
        float v1 = (3 + t) / vw1;
        float v2 = t / vw2 + 2;
        shadow += uw0 * vw0 * SampleTextureAndCompare_id99(base_uv + float2(u0, v0) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw1 * vw0 * SampleTextureAndCompare_id99(base_uv + float2(u1, v0) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw2 * vw0 * SampleTextureAndCompare_id99(base_uv + float2(u2, v0) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw0 * vw1 * SampleTextureAndCompare_id99(base_uv + float2(u0, v1) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw1 * vw1 * SampleTextureAndCompare_id99(base_uv + float2(u1, v1) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw2 * vw1 * SampleTextureAndCompare_id99(base_uv + float2(u2, v1) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw0 * vw2 * SampleTextureAndCompare_id99(base_uv + float2(u0, v2) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw1 * vw2 * SampleTextureAndCompare_id99(base_uv + float2(u1, v2) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow += uw2 * vw2 * SampleTextureAndCompare_id99(base_uv + float2(u2, v2) * ShadowMapTextureTexelSize_id102, positionDepth);
        shadow /= 144.0f;
    }
    return shadow;
}
...
float4 Compute_id208(inout PS_STREAMS streams, float3 direction)
{
...
void ComputeShadow_id90(inout PS_STREAMS streams, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id97(OffsetScales_id165[lightIndex], streams.NdotL_id43, streams.normalWS_id16);
...
void PrepareEnvironmentLight_id220(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id203(sampleDirection).rgb * Intensity_id180 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id208(streams, sampleDirection).rgb * Intensity_id180 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
...
void PrepareEnvironmentLight_id214(inout PS_STREAMS streams)
{
...
int GetLightCount_id198()
{
    return LightCount_id97;
}
int GetMaxLightCount_id199()
{
...
int GetLightCount_id190()
{
    return LightCount_id94;
}
int GetMaxLightCount_id191()
{
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id200 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
void PrepareDirectLights_id172(inout PS_STREAMS streams)
{
    PrepareLightData_id73(streams);
}
void PrepareMaterialForLightingAndShading_id152(inout PS_STREAMS streams)
{
...
void ResetLightStream_id151(inout PS_STREAMS streams)
{
...
float4 Compute_id223(inout PS_STREAMS streams)
{
    return Texture_id192.Sample(Sampler_id184, streams.TexCoord_id151 * scale_id194 + offset_id195).rgba;
}
float4 Compute_id221(inout PS_STREAMS streams)
{
    return Texture_id183.Sample(Sampler_id184, streams.TexCoord_id151 * scale_id186 + offset_id187).rgba;
}
void ResetStream_id162(inout PS_STREAMS streams)
{
    ResetStream_id159();
...
void Compute_id275(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id151(streams);
    PrepareMaterialForLightingAndShading_id152(streams);
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id172(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id191();
        int count = GetLightCount_id190();
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id199();
        int count = GetLightCount_id198();
    ...
    {
        PrepareEnvironmentLight_id214(streams);
    ...
    {
        PrepareEnvironmentLight_id220(streams);

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id228(streams);
        }
    }
    streams.shadingColor_id66 += directLightingContribution * PI_id200 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id260(inout PS_STREAMS streams)
{
    streams.matEmissiveIntensity_id57 = Compute_id225().r;
}
void Compute_id255(inout PS_STREAMS streams)
{
    streams.matEmissive_id56 = Compute_id223(streams).rgba;
}
void Compute_id250(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id221(streams);
    streams.matDiffuse_id47 = colorBase;
    streams.matColorBase_id46 = colorBase;
}
void ResetStream_id164(inout PS_STREAMS streams)
{
    ResetStream_id162(streams);
