...
@P   - ColorTransformGroup.Transforms: SiliconStudio.Xenko.Rendering.Images.ToneMap
***************************
****  ConstantBuffers  ****
***************************
...
//
#line 126 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_ColorTransformGroupEffect_399e2e9fade90282a534f579954d3188.hlsl"
...
@G    Pixel => f78ac57e0928caff4480046f85006838
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//      = 0x3e3851ec 
//   float LuminanceLocalFactor_id79;   // Offset:   88 Size:     4 [unused]
//      = 0x00000000 
...
//      = 0x00000000 
//   float Exposure_id83;               // Offset:  104 Size:     4
//      = 0x3f800000 
//
// }
//
...
//
#line 95 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_ColorTransformGroupEffect_399e2e9fade90282a534f579954d3188.hlsl"
...
#line 93
exp r0.y, cb0[5].w  // r0.y <- globalAverageLum
...
#line 78
mul r0.xyz, r0.xyzx, cb0[6].zzzz  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z
...
***************************
*************************/
const static bool TAutoKeyValue_id75 = false;
const static bool TAutoExposure_id76 = false;
