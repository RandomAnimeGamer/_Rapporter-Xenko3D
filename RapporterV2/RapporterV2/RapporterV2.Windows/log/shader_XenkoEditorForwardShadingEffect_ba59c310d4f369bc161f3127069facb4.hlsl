...
//
#line 671 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_ba59c310d4f369bc161f3127069facb4.hlsl"
...
@G    Pixel => 668830fd0e493e032d4651d76b7b3343
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 700 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_ba59c310d4f369bc161f3127069facb4.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s0  // r1.x <- <Compute_id222 return value>.x; r1.y <- <Compute_id222 return value>.y; r1.z <- <Compute_id222 return value>.z; r1.w <- <Compute_id222 return value>.w

#line 462
mad r2.xy, v3.xyxx, cb0[1].xyxx, cb0[1].zwzz
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t1.xyzw, s0  // r2.x <- <Compute_id224 return value>.x; r2.y <- <Compute_id224 return value>.y; r2.z <- <Compute_id224 return value>.z
...
#line 306
  ld_indexable(buffer)(uint,uint,uint,uint) r3.w, r8.xxxx, t3.yzwx  // r3.w <- realLightIndex
  iadd r8.x, r8.x, l(1)  // r8.x <- streams.lightIndex_id84
  ishl r5.w, r3.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r9.xyzw, r5.wwww, t4.xyzw  // r9.x <- pointLight1.x; r9.y <- pointLight1.y; r9.z <- pointLight1.z; r9.w <- pointLight1.w
  bfi r3.w, l(31), l(1), r3.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r8.yzw, r3.wwww, t4.wxyz  // r8.y <- pointLight2.x; r8.z <- pointLight2.y; r8.w <- pointLight2.z
...
#line 232
  ...
  div r9.xyz, r9.xyzx, r5.xxxx  // r9.x <- lightVectorNorm.x; r9.y <- lightVectorNorm.y; r9.z <- lightVectorNorm.z
...
#line 238
  mul r8.yzw, r3.wwww, r8.yyzw  // r8.y <- streams.lightColor_id39.x; r8.z <- streams.lightColor_id39.y; r8.w <- streams.lightColor_id39.z
...
#line 287
  ...
  ishl r6.w, r5.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r8.yzw, r6.wwww, t5.wxyz  // r8.y <- spotLight1.x; r8.z <- spotLight1.y; r8.w <- spotLight1.z
...
#line 217
  add r8.yzw, -r3.xxyz, r8.yyzw  // r8.y <- lightVector.x; r8.z <- lightVector.y; r8.w <- lightVector.z
