...
@P ParticleBase.BaseColor: mixin ComputeColorMultiply [{color1 = ComputeColorConstantColorLink<ParticleBase.EmissiveValue>}, {color2 = mixin ComputeColorMultiply [{color1 = ComputeColorTextureScaledOffsetDynamicSampler<ParticleBase.EmissiveMap,TEXCOORD0,Material.Sampler.i0,rgba,Material.TextureScale,Material.TextureOffset>}, {color2 = mixin ComputeColorMultiply [{color1 = ComputeColorTextureScaledOffsetDynamicSampler<ParticleBase.EmissiveMap.i1,TEXCOORD0,Material.Sampler.i0,rgba,Material.TextureScale.i1,Material.TextureOffset.i1>}, {color2 = ComputeColorFromStream<COLOR0,rgba>}]}]}]
***************************
****  ConstantBuffers  ****
***************************
...
@C    scale_id103 => Material.TextureScale.i1
@C    offset_id104 => Material.TextureOffset.i1
...
@R    Sampler_id97 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Texture_id101 => ParticleBase.EmissiveMap.i1 [Stage: None, Slot: (-1--1)]
@R    Texture_id101 => ParticleBase.EmissiveMap.i1 [Stage: None, Slot: (-1--1)]
...
@R    Texture_id101 => ParticleBase.EmissiveMap.i1 [Stage: Pixel, Slot: (1-1)]
@R    DepthStencil_id63 => DepthBase.DepthStencil [Stage: Pixel, Slot: (2-2)]
...
//   float2 scale_id103;                // Offset:   64 Size:     8 [unused]
//   float2 offset_id104;               // Offset:   72 Size:     8 [unused]
//
// }
//
// cbuffer PerView
...
//   v2.x <- __input__.LocalColor_id105.x; v2.y <- __input__.LocalColor_id105.y; v2.z <- __input__.LocalColor_id105.z; v2.w <- __input__.LocalColor_id105.w; 
//   o2.x <- <VSMain return value>.LocalColor_id105.x; o2.y <- <VSMain return value>.LocalColor_id105.y; o2.z <- <VSMain return value>.LocalColor_id105.z; o2.w <- <VSMain return value>.LocalColor_id105.w; 
...
//
#line 174 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_ParticleEffect_193c609922d4b8b0720c83462588cd3e.hlsl"
mov r0.w, l(1.000000)
...
@G    Pixel => 64d72b50d9745773ec7a4b96317eb606
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id103;                // Offset:   64 Size:     8
//   float2 offset_id104;               // Offset:   72 Size:     8
//
// }
//
// cbuffer PerView
...
// Texture_id101                     texture  float4          2d    1        1
// DepthStencil_id63                 texture  float4          2d    2        1
// PerMaterial                       cbuffer      NA          NA    0        1
// PerView                           cbuffer      NA          NA    1        1
//
//
...
//
#line 148 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_ParticleEffect_193c609922d4b8b0720c83462588cd3e.hlsl"
div r0.xy, v0.xyxx, cb1[14].xyxx  // r0.x <- screenCoords.x; r0.y <- screenCoords.y
mad r0.xy, r0.xyxx, cb1[15].zwzz, cb1[15].xyxx
sample_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t2.xyzw, s0
...
#line 88
mad r0.yz, v1.yyzy, cb0[4].xxyx, cb0[4].zzwz
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.yzyy, t1.xyzw, s1  // r1.x <- <Compute_id16 return value>.x; r1.y <- <Compute_id16 return value>.y; r1.z <- <Compute_id16 return value>.z; r1.w <- <Compute_id16 return value>.w
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r0.yzyy, t0.xyzw, s1  // r2.x <- <Compute_id14 return value>.x; r2.y <- <Compute_id14 return value>.y; r2.z <- <Compute_id14 return value>.z; r2.w <- <Compute_id14 return value>.w

#line 105
mul r1.xyzw, r1.xyzw, r2.xyzw  // r1.x <- mix1.x; r1.y <- mix1.y; r1.z <- mix1.z; r1.w <- mix1.w
...
struct VS_OUTPUT 
{
    ...
    float4 LocalColor_id105 : COLOR0;
};
struct VS_INPUT 
{
...
float4 Compute_id18(inout PS_STREAMS streams)
{
    return streams.LocalColor_id105.rgba;
}
float4 Compute_id16(inout PS_STREAMS streams)
{
    return Texture_id101.Sample(Sampler_id97, streams.TexCoord_id53 * scale_id103 + offset_id104).rgba;
}
float4 Compute_id21(inout PS_STREAMS streams)
{
    float4 tex1 = Compute_id16(streams);
    float4 tex2 = Compute_id18(streams);
...
float4 Compute_id23(inout PS_STREAMS streams)
{
    float4 tex1 = Compute_id14(streams);
    float4 tex2 = Compute_id21(streams);
    float4 mix1 = tex1 * tex2;
    return mix1;
}
float4 Compute_id12()
...
float4 Compute_id11(inout PS_STREAMS streams)
{
    ...
    float4 tex2 = Compute_id23(streams);
    float4 mix1 = tex1 * tex2;
    return mix1;
}
float4 Shading_id9()
...
PS_OUTPUT PSMain(VS_OUTPUT __input__)
{
    ...
    streams.LocalColor_id105 = __input__.LocalColor_id105;
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    __output__.LocalColor_id105 = streams.LocalColor_id105;
    return __output__;
}
