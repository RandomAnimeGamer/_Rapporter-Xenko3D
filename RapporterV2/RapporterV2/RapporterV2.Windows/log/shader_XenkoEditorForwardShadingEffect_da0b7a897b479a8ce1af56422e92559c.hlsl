...
@C    scale_id80 => Material.TextureScale
@C    offset_id81 => Material.TextureOffset
...
******  Resources    ******
***************************
@R    Texture_id77 => Material.DiffuseMap [Stage: None, Slot: (-1--1)]
@R    Texture_id77 => Material.DiffuseMap [Stage: None, Slot: (-1--1)]
@R    Sampler_id78 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Sampler_id78 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    PerMaterial => PerMaterial [Stage: None, Slot: (-1--1)]
@R    PerDraw => PerDraw [Stage: Vertex, Slot: (0-0)]
@R    PerView => PerView [Stage: Vertex, Slot: (1-1)]
@R    Sampler_id78 => Material.Sampler.i0 [Stage: Pixel, Slot: (0-0)]
@R    Texture_id77 => Material.DiffuseMap [Stage: Pixel, Slot: (0-0)]
...
@S    EffectCompiling => 795500e4419b9bbf68f2be17560a57d5
@S    Global => 49a2dc1b05cab24fb27be6434eb89fe2
...
//   v2.x <- __input__.TexCoord_id79.x; v2.y <- __input__.TexCoord_id79.y; 
//   o3.x <- <VSMain return value>.TexCoord_id79.x; o3.y <- <VSMain return value>.TexCoord_id79.y; 
...
//
#line 245 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_da0b7a897b479a8ce1af56422e92559c.hlsl"
...
@G    Pixel => e40c2c689850276dc51f7a7ab9940abb
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
// {
//
//   float2 scale_id80;                 // Offset:    0 Size:     8
//   float2 offset_id81;                // Offset:    8 Size:     8
//
// }
//
//
...
// Name                                 Type  Format         Dim Slot Elements
// ------------------------------ ---------- ------- ----------- ---- --------
// Sampler_id78                      sampler      NA          NA    0        1
// Texture_id77                      texture  float4          2d    0        1
...
//   v3.x <- __input__.TexCoord_id79.x; v3.y <- __input__.TexCoord_id79.y; 
//   o0.x <- <PSMain return value>.ColorTarget_id1.x; o0.y <- <PSMain return value>.ColorTarget_id1.y; o0.z <- <PSMain return value>.ColorTarget_id1.z; o0.w <- <PSMain return value>.ColorTarget_id1.w
//
#line 249 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoEditorForwardShadingEffect_da0b7a897b479a8ce1af56422e92559c.hlsl"
mul r0.x, cb0[0].x, l(6.000000)
sincos r0.x, null, r0.x
mad r0.x, r0.x, l(0.250000), l(0.250000)  // r0.x <- factor

#line 148
mad r0.yz, v3.xxyx, cb1[0].xxyx, cb1[0].zzwz
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r0.yzyy, t0.xyzw, s0  // r1.x <- <Compute_id78 return value>.x; r1.y <- <Compute_id78 return value>.y; r1.z <- <Compute_id78 return value>.z; r1.w <- <Compute_id78 return value>.w

#line 251
add r2.xyzw, -r1.xyzw, l(0.660000, 1.000000, 0.250000, 1.000000)
...
***************************
*************************/
static const float PI_id84 = 3.14159265358979323846;
const static bool TIsEnergyConservative_id85 = false;
Texture2D Texture_id77;
SamplerState Sampler_id78;
struct PS_STREAMS 
{
    float3 normalWS_id16;
    float4 PositionWS_id19;
    float2 TexCoord_id79;
    float3 viewWS_id61;
...
struct VS_OUTPUT 
{
    ...
    float2 TexCoord_id79 : TEXCOORD0;
};
struct VS_INPUT 
{
...
float GetFilterSquareRoughnessAdjustment_id57(inout PS_STREAMS streams, float3 averageNormal)
{
...
void ResetStream_id68()
{
}
float3 ComputeEnvironmentLightContribution_id81(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor * streams.envLightDiffuseColor_id41;
}
void PrepareEnvironmentLight_id77(inout PS_STREAMS streams)
{
    streams.envLightDiffuseColor_id41 = 1;
    streams.envLightSpecularColor_id42 = 1;
}
void PrepareMaterialForLightingAndShading_id67(inout PS_STREAMS streams)
{
    ...
    float roughnessAdjust = GetFilterSquareRoughnessAdjustment_id57(streams, streams.matNormal_id45);
    streams.alphaRoughness_id63 = max(roughness * roughness + roughnessAdjust, 0.001);
}
void ResetLightStream_id66(inout PS_STREAMS streams)
{
...
{
    return Texture_id77.Sample(Sampler_id78, streams.TexCoord_id79 * scale_id80 + offset_id81).rgba;
}
...
void Compute_id118(inout PS_STREAMS streams)
{
    UpdateNormalFromTangentSpace_id19(streams.matNormal_id45);
    ResetLightStream_id66(streams);
    PrepareMaterialForLightingAndShading_id67(streams);
    float3 directLightingContribution = 0;
    float3 environmentLightingContribution = 0;

    {
        PrepareEnvironmentLight_id77(streams);

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id81(streams);
        }
    }
    streams.shadingColor_id66 += directLightingContribution * PI_id84 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id103(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id78(streams);
...
float4 Shading_id29(inout PS_STREAMS streams)
{
    ...
    return lerp(Shading_id28(streams), reloadColor, factor);
}
void PSMain_id1()
{
}
...
PS_OUTPUT PSMain(VS_OUTPUT __input__)
{
    ...
    streams.TexCoord_id79 = __input__.TexCoord_id79;
...
VS_OUTPUT VSMain(VS_INPUT __input__)
{
    ...
    __output__.TexCoord_id79 = streams.TexCoord_id79;
    return __output__;
}
