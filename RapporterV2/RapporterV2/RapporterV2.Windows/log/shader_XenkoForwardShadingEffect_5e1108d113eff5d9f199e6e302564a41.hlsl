...
//
#line 732 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoForwardShadingEffect_5e1108d113eff5d9f199e6e302564a41.hlsl"
...
@G    Pixel => 1d93c52b2ef03e69fa4b10311454585e
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 761 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\RapporterV2.Windows\log\shader_XenkoForwardShadingEffect_5e1108d113eff5d9f199e6e302564a41.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t0.xyzw, s1  // r2.x <- <Compute_id260 return value>.x; r2.y <- <Compute_id260 return value>.y; r2.z <- <Compute_id260 return value>.z; r2.w <- <Compute_id260 return value>.w
...
#line 329
  ld_indexable(buffer)(uint,uint,uint,uint) r7.w, r5.wwww, t2.yzwx  // r7.w <- realLightIndex
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id247 return value>.x; r0.y <- <Compute_id247 return value>.y; r0.z <- <Compute_id247 return value>.z
