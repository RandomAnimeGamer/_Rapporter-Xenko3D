...
mov r4.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r3.xy, r4.xyzw, t0.xyzw  // r3.x <- streams.lightData_id87.x; r3.y <- streams.lightData_id87.y
...
#line 307
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation
  mul r11.xyz, r4.wwww, r13.xyzx  // r11.x <- streams.lightColor_id43.x; r11.y <- streams.lightColor_id43.y; r11.z <- streams.lightColor_id43.z
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r11.x, r16.xyxx, t4.xxxx, s1, r11.z  // r11.x <- <SampleTextureAndCompare_id106 return value>

#line 245
  mul r11.yw, r12.zzzw, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r13.z, r16.zwzz, t4.xxxx, s1, r11.z  // r13.z <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r12.z, r16.xyxx, t4.xxxx, s1, r11.z  // r12.z <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r11.x, r17.xyxx, t4.xxxx, s1, r11.z  // r11.x <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r12.z, r16.zwzz, t4.xxxx, s1, r11.z  // r12.z <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r11.x, r15.xyxx, t4.xxxx, s1, r11.z  // r11.x <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r11.y, r11.ywyy, t4.xxxx, s1, r11.z  // r11.y <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r3.x, r15.xyxx, t4.xxxx, s1, r3.z  // r3.x <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r3.y, r15.zwzz, t4.xxxx, s1, r3.z  // r3.y <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r6.w, r15.xyxx, t4.xxxx, s1, r3.z  // r6.w <- <SampleTextureAndCompare_id106 return value>

#line 246
  mad r16.xyzw, r14.xyzy, cb1[27].zwzw, r11.zwzw

#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r16.xyxx, t4.xxxx, s1, r3.z  // r7.w <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r13.z, r16.zwzz, t4.xxxx, s1, r3.z  // r13.z <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r15.zwzz, t4.xxxx, s1, r3.z  // r13.w <- <SampleTextureAndCompare_id106 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r14.x, r14.xyxx, t4.xxxx, s1, r3.z  // r14.x <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.y, r14.zwzz, t4.xxxx, s1, r3.z  // r14.y <- <SampleTextureAndCompare_id106 return value>

#line 250
  mad r11.zw, r13.xxxy, cb1[27].zzzw, r11.zzzw

#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r3.z, r11.zwzz, t4.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id106 return value>
...
#line 339
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, cb1[59].w  // r0.x <- <Compute_id254 return value>.x; r0.y <- <Compute_id254 return value>.y; r0.z <- <Compute_id254 return value>.z
