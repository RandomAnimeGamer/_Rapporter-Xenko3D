...
*****     Stages      *****
***************************
@G    Vertex => 3678b2b79d2d12f5d84f481ddf8dd744
//
...
@G    Pixel => 8e5819089b945542cf7a430eca365d00
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
sample r1.xyzw, r0.yzyy, t1.xyzw, s1  // r1.x <- <Compute_id16 return value>.x; r1.y <- <Compute_id16 return value>.y; r1.z <- <Compute_id16 return value>.z; r1.w <- <Compute_id16 return value>.w
...
sample r2.xyzw, r0.yzyy, t0.xyzw, s1  // r2.x <- <Compute_id14 return value>.x; r2.y <- <Compute_id14 return value>.y; r2.z <- <Compute_id14 return value>.z; r2.w <- <Compute_id14 return value>.w
