...
//
#line 826 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d5cf35241c2e1aa2518d4c437337bfe1.hlsl"
...
@G    Pixel => 8e0d9ae26e6658670a8163e8bf8ec124
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 855 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d5cf35241c2e1aa2518d4c437337bfe1.hlsl"
...
#line 301
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation
  mul r10.xyz, r4.wwww, r11.xyzx  // r10.x <- streams.lightColor_id39.x; r10.y <- streams.lightColor_id39.y; r10.z <- streams.lightColor_id39.z

#line 545
  dp3 r4.w, r4.xyzx, -r12.xyzx
  max r4.w, r4.w, l(0.000100)  // r4.w <- streams.NdotL_id43
  mul r10.xyz, r4.wwww, r10.xyzx  // r10.x <- streams.lightColorNdotL_id40.x; r10.y <- streams.lightColorNdotL_id40.y; r10.z <- streams.lightColorNdotL_id40.z
...
#line 197
  sample_c r11.x, r16.xyxx, t4.xxxx, s1, r11.z  // r11.x <- <SampleTextureAndCompare_id102 return value>

#line 239
  mul r11.yw, r12.zzzw, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 197
  sample_c r13.z, r16.zwzz, t4.xxxx, s1, r11.z  // r13.z <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r11.x, r17.xyxx, t4.xxxx, s1, r11.z  // r11.x <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r12.z, r16.zwzz, t4.xxxx, s1, r11.z  // r12.z <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r11.x, r15.xyxx, t4.xxxx, s1, r11.z  // r11.x <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r11.y, r11.ywyy, t4.xxxx, s1, r11.z  // r11.y <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r9.w, r15.xyxx, t4.xxxx, s1, r3.z  // r9.w <- <SampleTextureAndCompare_id102 return value>

#line 240
  mad r16.xyzw, r14.xyzy, cb1[27].zwzw, r11.yzyz

#line 197
  sample_c r11.w, r16.xyxx, t4.xxxx, s1, r3.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
  sample_c r13.z, r16.zwzz, t4.xxxx, s1, r3.z  // r13.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r13.w, r15.zwzz, t4.xxxx, s1, r3.z  // r13.w <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r14.x, r14.xyxx, t4.xxxx, s1, r3.z  // r14.x <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.y, r14.zwzz, t4.xxxx, s1, r3.z  // r14.y <- <SampleTextureAndCompare_id102 return value>

#line 244
  mad r11.yz, r13.xxyx, cb1[27].zzwz, r11.yyzy

#line 197
  sample_c r3.z, r11.yzyy, t4.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id102 return value>
...
#line 333
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, cb1[59].w  // r0.x <- <Compute_id250 return value>.x; r0.y <- <Compute_id250 return value>.y; r0.z <- <Compute_id250 return value>.z
