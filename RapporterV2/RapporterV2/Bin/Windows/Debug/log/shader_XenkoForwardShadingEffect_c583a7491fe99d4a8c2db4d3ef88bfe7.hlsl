...
//
#line 600 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_c583a7491fe99d4a8c2db4d3ef88bfe7.hlsl"
...
@G    Pixel => 5b753793eb848844dd2807e94724429b
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 629 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_c583a7491fe99d4a8c2db4d3ef88bfe7.hlsl"
...
sample r1.xyzw, r1.xyxx, t0.xyzw, s0  // r1.x <- <Compute_id168 return value>.x; r1.y <- <Compute_id168 return value>.y; r1.z <- <Compute_id168 return value>.z; r1.w <- <Compute_id168 return value>.w
...
#line 412
and r0.w, r2.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id130 return value>
...
#line 183
  ...
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id61 return value>
...
#line 382
ushr r0.w, r2.y, l(16)  // r0.w <- <GetMaxLightCount_id139 return value>
...
#line 280
  ld r8.xyzw, r2.wwww, t2.xyzw  // r8.x <- realLightIndex
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id84
  ishl r4.w, r8.x, l(2)
  ld r8.xyzw, r4.wwww, t4.xyzw  // r8.x <- spotLight1.x; r8.y <- spotLight1.y; r8.z <- spotLight1.z
...
#line 210
  add r7.yzw, -r2.xxyz, r8.xxyz  // r7.y <- lightVector.x; r7.z <- lightVector.y; r7.w <- lightVector.z
...
#line 177
  ...
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id69 return value>
...
#line 372
  dp3 r4.w, r3.xyzx, r7.yzwy
  max r4.w, r4.w, l(0.000100)  // r4.w <- streams.NdotL_id43
  mul r7.yzw, r4.wwww, r8.xxyz  // r7.y <- streams.lightColorNdotL_id40.x; r7.z <- streams.lightColorNdotL_id40.y; r7.w <- streams.lightColorNdotL_id40.z
...
dp3 r2.x, r0.xyzx, cb1[52].xyzx  // r2.x <- sampleDirection.y
...
#line 251
mad r2.yzw, cb1[43].xxyz, r2.xxxx, cb1[42].xxyz  // r2.y <- color.x; r2.z <- color.y; r2.w <- color.z
mad r2.yzw, cb1[44].xxyz, -r0.xxxx, r2.yyzw
mad r2.yzw, cb1[45].xxyz, r0.wwww, r2.yyzw

#line 256
mul r3.xyz, r2.xxxx, cb1[46].xyzx
mad r2.yzw, r3.xxyz, r0.wwww, r2.yyzw
mul r3.xyz, r2.xxxx, cb1[47].xyzx
mad r2.xyz, r3.xyzx, -r0.xxxx, r2.yzwy  // r2.x <- color.x; r2.y <- color.y; r2.z <- color.z
mad r0.z, r0.z, l(3.000000), l(-1.000000)
mad r2.xyz, cb1[48].xyzx, r0.zzzz, r2.xyzx
mul r3.xyz, r0.wwww, cb1[49].xyzx
mad r2.xyz, r3.xyzx, -r0.xxxx, r2.xyzx
mad r0.x, r0.w, r0.w, -r0.y
mad r0.xyz, cb1[50].xyzx, r0.xxxx, r2.xyzx  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z
...
#line 343
mul r0.xyz, r0.xyzx, r1.xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id171 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id171 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id171 return value>.z
...
static const float PI_id171 = 3.14159265358979323846;
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id171 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
void Compute_id208(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id171 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id193(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id168(streams);
