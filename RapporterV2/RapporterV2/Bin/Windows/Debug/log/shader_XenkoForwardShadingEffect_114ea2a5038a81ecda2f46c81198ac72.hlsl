...
@G    Pixel => 656d91a00199d61cccdc83dc40685542
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
sample r1.xyzw, r1.xyxx, t0.xyzw, s1  // r1.x <- <Compute_id180 return value>.x; r1.y <- <Compute_id180 return value>.y; r1.z <- <Compute_id180 return value>.z; r1.w <- <Compute_id180 return value>.w
...
#line 401
  ld r7.xyzw, r2.wwww, t2.xyzw  // r7.x <- realLightIndex
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id84
  ishl r4.w, r7.x, l(2)
  ld r7.xyzw, r4.wwww, t4.xyzw  // r7.x <- spotLight1.x; r7.y <- spotLight1.y; r7.z <- spotLight1.z

#line 407
  iadd r8.xyz, r4.wwww, l(1, 2, 3, 0)
...
#line 206
  mul r4.w, r10.z, r4.w  // r4.w <- factor
...
#line 302
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation
  mul r8.xyz, r4.wwww, r8.xyzx  // r8.x <- streams.lightColor_id39.x; r8.y <- streams.lightColor_id39.y; r8.z <- streams.lightColor_id39.z
...
#line 202
  sample_c r8.w, r13.xyxx, t5.xxxx, s0, r9.z  // r8.w <- <SampleTextureAndCompare_id86 return value>

#line 244
  mul r13.xy, r10.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 202
  sample_c r9.w, r13.zwzz, t5.xxxx, s0, r9.z  // r9.w <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c r8.w, r14.xyxx, t5.xxxx, s0, r9.z  // r8.w <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c r9.x, r9.xyxx, t5.xxxx, s0, r9.z  // r9.x <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c r2.x, r13.xyxx, t5.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id86 return value>
  sample_c r2.y, r13.zwzz, t5.xxxx, s0, r2.z  // r2.y <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c r8.y, r13.xyxx, t5.xxxx, s0, r2.z  // r8.y <- <SampleTextureAndCompare_id86 return value>

#line 245
  mad r14.xyzw, r12.xyzy, cb1[27].zwzw, r9.xyxy

#line 202
  sample_c r10.z, r14.xyxx, t5.xxxx, s0, r2.z  // r10.z <- <SampleTextureAndCompare_id86 return value>
  sample_c r10.w, r14.zwzz, t5.xxxx, s0, r2.z  // r10.w <- <SampleTextureAndCompare_id86 return value>
  sample_c r11.z, r13.zwzz, t5.xxxx, s0, r2.z  // r11.z <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c r11.w, r12.xyxx, t5.xxxx, s0, r2.z  // r11.w <- <SampleTextureAndCompare_id86 return value>
  sample_c r12.x, r12.zwzz, t5.xxxx, s0, r2.z  // r12.x <- <SampleTextureAndCompare_id86 return value>

#line 249
  mad r9.xy, r11.xyxx, cb1[27].zwzz, r9.xyxx

#line 202
  sample_c r2.z, r9.xyxx, t5.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id86 return value>
