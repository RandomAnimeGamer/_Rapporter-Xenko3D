...
//
#line 721 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_114ea2a5038a81ecda2f46c81198ac72.hlsl"
...
@G    Pixel => 1fd972c802daadc016510e509141a6b6
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 750 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_114ea2a5038a81ecda2f46c81198ac72.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s1  // r1.x <- <Compute_id180 return value>.x; r1.y <- <Compute_id180 return value>.y; r1.z <- <Compute_id180 return value>.z; r1.w <- <Compute_id180 return value>.w
...
mov r3.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r2.xy, r3.xyzw, t1.xyzw  // r2.x <- streams.lightData_id83.x; r2.y <- streams.lightData_id83.y

#line 533
and r0.w, r2.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id140 return value>
...
#line 503
ushr r0.w, r2.y, l(16)  // r0.w <- <GetMaxLightCount_id149 return value>
...
#line 302
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation
  mul r8.xyz, r4.wwww, r10.xyzx  // r8.x <- streams.lightColor_id39.x; r8.y <- streams.lightColor_id39.y; r8.z <- streams.lightColor_id39.z

#line 493
  dp3 r4.w, r3.xyzx, r7.xyzx
  max r4.w, r4.w, l(0.000100)  // r4.w <- streams.NdotL_id43
  mul r7.xyz, r4.wwww, r8.xyzx  // r7.x <- streams.lightColorNdotL_id40.x; r7.y <- streams.lightColorNdotL_id40.y; r7.z <- streams.lightColorNdotL_id40.z
...
#line 358
  lt r7.w, cb1[r6.w + 46].x, r3.w

#line 361
  and r7.w, r7.w, l(1)  // r7.w <- cascadeIndex

#line 358
  bfi r8.xy, l(30, 30, 0, 0), l(2, 2, 0, 0), r4.wwww, l(1, 2, 0, 0)
  lt r8.x, cb1[r8.x + 46].x, r3.w

#line 361
  movc r7.w, r8.x, l(2), r7.w

#line 358
  lt r8.x, cb1[r8.y + 46].x, r3.w
...
#line 365
  mad r2.xyz, r8.yyyy, r4.xyzx, r3.xyzx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 277
  bfi r8.y, l(30), l(2), r4.w, r7.w
  ishl r8.z, r7.w, l(2)
  bfi r8.z, l(30), l(4), r4.w, r8.z
  dp4 r9.x, r2.xyzw, cb1[r8.z + 28].xyzw  // r9.x <- shadowPosition.x
  dp4 r9.y, r2.xyzw, cb1[r8.z + 29].xyzw  // r9.y <- shadowPosition.y
  dp4 r8.w, r2.xyzw, cb1[r8.z + 30].xyzw  // r8.w <- shadowPosition.z
  dp4 r8.z, r2.xyzw, cb1[r8.z + 31].xyzw  // r8.z <- shadowPosition.w
  add r9.z, r8.w, -cb1[44].x  // r9.z <- shadowPosition.z
  div r9.xyz, r9.xyzx, r8.zzzz
...
#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r13.xyxx, t5.xxxx, s0, r9.z  // r8.w <- <SampleTextureAndCompare_id86 return value>

#line 244
  mul r13.xy, r10.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r13.zwzz, t5.xxxx, s0, r9.z  // r9.w <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r14.xyxx, t5.xxxx, s0, r9.z  // r8.w <- <SampleTextureAndCompare_id86 return value>
...
#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r15.xyxx, t5.xxxx, s0, r9.z

#line 244
  mad r8.z, r13.y, r8.w, r8.z

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r15.zwzz, t5.xxxx, s0, r9.z
...
#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r14.zwzz, t5.xxxx, s0, r9.z
...
#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r12.xyxx, t5.xxxx, s0, r9.z

#line 247
  mad r8.z, r10.y, r8.w, r8.z

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r12.zwzz, t5.xxxx, s0, r9.z
...
#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r9.x, r9.xyxx, t5.xxxx, s0, r9.z  // r9.x <- <SampleTextureAndCompare_id86 return value>
...
#line 370
  iadd r9.x, r8.y, l(-1)
  add r9.x, -cb1[r9.x + 46].x, cb1[r8.y + 46].x
  movc r9.x, r7.w, r9.x, cb1[r8.y + 46].x  // r9.x <- splitSize
  add r8.y, -r3.w, cb1[r8.y + 46].x
  div r8.y, r8.y, r9.x  // r8.y <- splitDist
  lt r9.x, r8.y, l(0.200000)

#line 277
  ishl r6.w, r6.w, l(2)
  imad r6.w, r7.w, l(4), r6.w
  iadd r6.w, r6.w, l(4)
  dp4 r10.x, r2.xyzw, cb1[r6.w + 28].xyzw  // r10.x <- shadowPosition.x
  dp4 r10.y, r2.xyzw, cb1[r6.w + 29].xyzw  // r10.y <- shadowPosition.y
  dp4 r7.w, r2.xyzw, cb1[r6.w + 30].xyzw  // r7.w <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb1[r6.w + 31].xyzw  // r2.x <- shadowPosition.w
  add r10.z, r7.w, -cb1[44].x  // r10.z <- shadowPosition.z
  div r2.xyz, r10.xyzx, r2.xxxx  // r2.x <- shadowPosition.x; r2.y <- shadowPosition.y; r2.z <- shadowPosition.z

#line 222
  mad r2.xy, r2.xyxx, cb1[27].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r9.yz, r2.xxyx  // r9.y <- base_uv.x; r9.z <- base_uv.y
  add r2.xy, r2.xyxx, -r9.yzyy  // r2.x <- s; r2.y <- t
  add r9.yz, r9.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
  mul r9.yz, r9.yyzy, cb1[27].zzwz

#line 235
  mad r10.xy, -r2.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r10.y <- uw0; r10.x <- vw0
  mad r10.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r10.z <- uw2
  mad r11.xy, -r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r11.xy, r11.xyxx, r10.yxyy
  add r11.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  div r2.xy, r2.xyxx, r10.zwzz
  add r12.xw, r11.xxxy, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r12.x <- u0; r12.w <- v0
  mul r12.yz, r11.wwzw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r12.z <- u1; r12.y <- v1
  add r11.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r11.x <- u2; r11.y <- v2
  mad r13.xyzw, r12.xwzw, cb1[27].zwzw, r9.yzyz

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r2.x, r13.xyxx, t5.xxxx, s0, r2.z  // r2.x <- <SampleTextureAndCompare_id86 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r2.y, r13.zwzz, t5.xxxx, s0, r2.z  // r2.y <- <SampleTextureAndCompare_id86 return value>

#line 246
  mov r11.zw, r12.wwwy
  mad r13.xyzw, r11.xzxw, cb1[27].zwzw, r9.yzyz

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r6.w, r13.xyxx, t5.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id86 return value>

#line 245
  mad r14.xyzw, r12.xyzy, cb1[27].zwzw, r9.yzyz

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r14.xyxx, t5.xxxx, s0, r2.z  // r7.w <- <SampleTextureAndCompare_id86 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r14.zwzz, t5.xxxx, s0, r2.z  // r9.w <- <SampleTextureAndCompare_id86 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r11.z, r13.zwzz, t5.xxxx, s0, r2.z  // r11.z <- <SampleTextureAndCompare_id86 return value>

#line 247
  mov r12.y, r11.y
  mad r12.xyzw, r12.xyzy, cb1[27].zwzw, r9.yzyz

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r12.xyxx, t5.xxxx, s0, r2.z  // r11.w <- <SampleTextureAndCompare_id86 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r12.x, r12.zwzz, t5.xxxx, s0, r2.z  // r12.x <- <SampleTextureAndCompare_id86 return value>

#line 249
  mad r9.yz, r11.xxyx, cb1[27].zzwz, r9.yyzy

#line 202
  sample_c_indexable(texture2d)(float,float,float,float) r2.z, r9.yzyy, t5.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id86 return value>
...
#line 375
    if_z r8.x
      mul_sat r8.x, r8.y, l(5.000000)
      mad r8.y, r8.x, l(-2.000000), l(3.000000)
      mul r8.x, r8.x, r8.x
      mul r8.x, r8.x, r8.y  // r8.x <- lerpAmt

#line 241
      mul r8.y, r10.x, r10.y
      mul r2.y, r10.x, r2.y
      mul r2.y, r2.y, l(7.000000)
      mad r2.x, r8.y, r2.x, r2.y  // r2.x <- shadow

#line 247
      mul r9.xy, r10.xyxx, r10.zwzz

#line 243
      mad r2.x, r9.x, r6.w, r2.x
      mul r2.y, r7.w, r10.y
      mad r2.x, r2.y, l(7.000000), r2.x
      mad r2.x, r9.w, l(49.000000), r2.x
      mul r2.y, r10.z, r11.z
      mad r2.x, r2.y, l(7.000000), r2.x
      mad r2.x, r9.y, r11.w, r2.x
      mul r2.y, r10.w, r12.x
      mad r2.x, r2.y, l(7.000000), r2.x
      mul r2.y, r10.w, r10.z
      mad r2.x, r2.y, r2.z, r2.x
      mul r2.x, r2.x, l(0.006944)

#line 381
      mad r2.y, r8.z, l(0.006944), -r2.x
      mad r8.w, r8.x, r2.y, r2.x
    endif 
  endif   // r8.w <- shadow
...
dp3 r2.x, r0.xyzx, cb1[61].xyzx  // r2.x <- sampleDirection.y
dp3 r0.x, r0.xyzx, cb1[62].xyzx  // r0.x <- sampleDirection.z

#line 329
mul r0.y, r2.x, r2.x  // r0.y <- y2
mul r0.z, r0.x, r0.x  // r0.z <- z2

#line 334
mad r2.yzw, cb1[52].xxyz, r2.xxxx, cb1[51].xxyz  // r2.y <- color.x; r2.z <- color.y; r2.w <- color.z
mad r2.yzw, cb1[53].xxyz, -r0.xxxx, r2.yyzw
mad r2.yzw, cb1[54].xxyz, r0.wwww, r2.yyzw

#line 339
mul r3.xyz, r2.xxxx, cb1[55].xyzx
mad r2.yzw, r3.xxyz, r0.wwww, r2.yyzw
mul r3.xyz, r2.xxxx, cb1[56].xyzx
mad r2.xyz, r3.xyzx, -r0.xxxx, r2.yzwy  // r2.x <- color.x; r2.y <- color.y; r2.z <- color.z
mad r0.z, r0.z, l(3.000000), l(-1.000000)
mad r2.xyz, cb1[57].xyzx, r0.zzzz, r2.xyzx
mul r3.xyz, r0.wwww, cb1[58].xyzx
mad r2.xyz, r3.xyzx, -r0.xxxx, r2.xyzx
mad r0.x, r0.w, r0.w, -r0.y
mad r0.xyz, cb1[59].xyzx, r0.xxxx, r2.xyzx  // r0.x <- color.x; r0.y <- color.y; r0.z <- color.z
...
#line 464
mul r0.xyz, r0.xyzx, r1.xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id183 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id183 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id183 return value>.z
...
static const float PI_id187 = 3.14159265358979323846;
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id187 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
void Compute_id220(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id187 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id205(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id180(streams);
