...
@G    Pixel => c259b84b9c0744a64a5af5f0aaf44be9
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, r1.xyxx, t0.xyzw, s1  // r1.x <- <Compute_id234 return value>.x; r1.y <- <Compute_id234 return value>.y; r1.z <- <Compute_id234 return value>.z; r1.w <- <Compute_id234 return value>.w

#line 583
mad r2.xy, v3.xyxx, cb0[1].xyxx, cb0[1].zwzz
sample_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t1.xyzw, s1  // r2.x <- <Compute_id236 return value>.x; r2.y <- <Compute_id236 return value>.y; r2.z <- <Compute_id236 return value>.z
...
#line 427
  ld_indexable(buffer)(uint,uint,uint,uint) r3.w, r7.xxxx, t3.yzwx  // r3.w <- realLightIndex
  iadd r7.x, r7.x, l(1)  // r7.x <- streams.lightIndex_id84
  ishl r5.w, r3.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r8.xyzw, r5.wwww, t4.xyzw  // r8.x <- pointLight1.x; r8.y <- pointLight1.y; r8.z <- pointLight1.z; r8.w <- pointLight1.w
  bfi r3.w, l(31), l(1), r3.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r9.xyz, r3.wwww, t4.xyzw  // r9.x <- pointLight2.x; r9.y <- pointLight2.y; r9.z <- pointLight2.z
...
#line 408
  ...
  ishl r6.w, r5.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r8.xyz, r6.wwww, t5.xyzw  // r8.x <- spotLight1.x; r8.y <- spotLight1.y; r8.z <- spotLight1.z

#line 414
  bfi r9.xyz, l(30, 30, 30, 0), l(2, 2, 2, 0), r5.wwww, l(1, 2, 3, 0)
...
#line 213
  mul r5.w, r9.w, r5.w  // r5.w <- factor
...
#line 263
  ...
  mad_sat r6.w, r6.w, r9.x, r9.y  // r6.w <- attenuation
  mul r6.w, r6.w, r6.w

#line 309
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r9.xyz, r5.wwww, r11.xyzx  // r9.x <- streams.lightColor_id39.x; r9.y <- streams.lightColor_id39.y; r9.z <- streams.lightColor_id39.z
...
#line 365
  bfi r9.xy, l(30, 30, 0, 0), l(2, 2, 0, 0), r5.wwww, l(1, 2, 0, 0)
...
#line 284
  bfi r9.y, l(30), l(2), r5.w, r8.w
  ishl r9.z, r8.w, l(2)
  bfi r9.z, l(30), l(4), r5.w, r9.z
  dp4 r10.x, r3.xyzw, cb1[r9.z + 28].xyzw  // r10.x <- shadowPosition.x
  dp4 r10.y, r3.xyzw, cb1[r9.z + 29].xyzw  // r10.y <- shadowPosition.y
  dp4 r9.w, r3.xyzw, cb1[r9.z + 30].xyzw  // r9.w <- shadowPosition.z
  dp4 r9.z, r3.xyzw, cb1[r9.z + 31].xyzw  // r9.z <- shadowPosition.w
  add r10.z, r9.w, -cb1[44].x  // r10.z <- shadowPosition.z
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r14.xyxx, t6.xxxx, s0, r10.z  // r9.w <- <SampleTextureAndCompare_id100 return value>

#line 251
  mul r14.xy, r11.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r10.w, r14.zwzz, t6.xxxx, s0, r10.z  // r10.w <- <SampleTextureAndCompare_id100 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r15.xyxx, t6.xxxx, s0, r10.z  // r9.w <- <SampleTextureAndCompare_id100 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r16.xyxx, t6.xxxx, s0, r10.z

#line 251
  mad r9.z, r14.y, r9.w, r9.z

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r16.zwzz, t6.xxxx, s0, r10.z
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r15.zwzz, t6.xxxx, s0, r10.z
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r13.xyxx, t6.xxxx, s0, r10.z

#line 254
  mad r9.z, r11.y, r9.w, r9.z

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r13.zwzz, t6.xxxx, s0, r10.z
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r10.x, r10.xyxx, t6.xxxx, s0, r10.z  // r10.x <- <SampleTextureAndCompare_id100 return value>
...
#line 377
  iadd r10.x, r9.y, l(-1)
  add r10.x, -cb1[r10.x + 46].x, cb1[r9.y + 46].x
  movc r10.x, r8.w, r10.x, cb1[r9.y + 46].x  // r10.x <- splitSize
  add r9.y, -r4.w, cb1[r9.y + 46].x
  div r9.y, r9.y, r10.x  // r9.y <- splitDist
  lt r10.x, r9.y, l(0.200000)

#line 284
  ishl r7.w, r7.w, l(2)
  imad r7.w, r8.w, l(4), r7.w
  iadd r7.w, r7.w, l(4)
  dp4 r11.x, r3.xyzw, cb1[r7.w + 28].xyzw  // r11.x <- shadowPosition.x
  dp4 r11.y, r3.xyzw, cb1[r7.w + 29].xyzw  // r11.y <- shadowPosition.y
  dp4 r8.w, r3.xyzw, cb1[r7.w + 30].xyzw  // r8.w <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb1[r7.w + 31].xyzw  // r3.x <- shadowPosition.w
  add r11.z, r8.w, -cb1[44].x  // r11.z <- shadowPosition.z
  div r3.xyz, r11.xyzx, r3.xxxx  // r3.x <- shadowPosition.x; r3.y <- shadowPosition.y; r3.z <- shadowPosition.z

#line 229
  mad r3.xy, r3.xyxx, cb1[27].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r10.yz, r3.xxyx  // r10.y <- base_uv.x; r10.z <- base_uv.y
  add r3.xy, r3.xyxx, -r10.yzyy  // r3.x <- s; r3.y <- t
  add r10.yz, r10.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000)
  mul r10.yz, r10.yyzy, cb1[27].zzwz

#line 242
  mad r11.xy, -r3.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r11.y <- uw0; r11.x <- vw0
  mad r11.zw, r3.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r11.z <- uw2
  mad r12.xy, -r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r12.xy, r12.xyxx, r11.yxyy
  add r12.zw, r3.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  div r3.xy, r3.xyxx, r11.zwzz
  add r13.xw, r12.xxxy, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r13.x <- u0; r13.w <- v0
  mul r13.yz, r12.wwzw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r13.z <- u1; r13.y <- v1
  add r12.xy, r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r12.x <- u2; r12.y <- v2
  mad r14.xyzw, r13.xwzw, cb1[27].zwzw, r10.yzyz

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r3.x, r14.xyxx, t6.xxxx, s0, r3.z  // r3.x <- <SampleTextureAndCompare_id100 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r3.y, r14.zwzz, t6.xxxx, s0, r3.z  // r3.y <- <SampleTextureAndCompare_id100 return value>

#line 253
  mov r12.zw, r13.wwwy
  mad r14.xyzw, r12.xzxw, cb1[27].zwzw, r10.yzyz

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r14.xyxx, t6.xxxx, s0, r3.z  // r7.w <- <SampleTextureAndCompare_id100 return value>

#line 252
  mad r15.xyzw, r13.xyzy, cb1[27].zwzw, r10.yzyz

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r15.xyxx, t6.xxxx, s0, r3.z  // r8.w <- <SampleTextureAndCompare_id100 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r10.w, r15.zwzz, t6.xxxx, s0, r3.z  // r10.w <- <SampleTextureAndCompare_id100 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r12.z, r14.zwzz, t6.xxxx, s0, r3.z  // r12.z <- <SampleTextureAndCompare_id100 return value>

#line 254
  mov r13.y, r12.y
  mad r13.xyzw, r13.xyzy, cb1[27].zwzw, r10.yzyz

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r13.xyxx, t6.xxxx, s0, r3.z  // r12.w <- <SampleTextureAndCompare_id100 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r13.zwzz, t6.xxxx, s0, r3.z  // r13.x <- <SampleTextureAndCompare_id100 return value>

#line 256
  mad r10.yz, r12.xxyx, cb1[27].zzwz, r10.yyzy

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r3.z, r10.yzyy, t6.xxxx, s0, r3.z  // r3.z <- <SampleTextureAndCompare_id100 return value>
...
#line 382
    if_z r9.x
      mul_sat r9.x, r9.y, l(5.000000)
      mad r9.y, r9.x, l(-2.000000), l(3.000000)
      mul r9.x, r9.x, r9.x
      mul r9.x, r9.x, r9.y  // r9.x <- lerpAmt

#line 248
      mul r9.y, r11.x, r11.y
      mul r3.y, r11.x, r3.y
      mul r3.y, r3.y, l(7.000000)
      mad r3.x, r9.y, r3.x, r3.y  // r3.x <- shadow

#line 254
      mul r10.xy, r11.xyxx, r11.zwzz

#line 250
      mad r3.x, r10.x, r7.w, r3.x
      mul r3.y, r8.w, r11.y
      mad r3.x, r3.y, l(7.000000), r3.x
      mad r3.x, r10.w, l(49.000000), r3.x
      mul r3.y, r11.z, r12.z
      mad r3.x, r3.y, l(7.000000), r3.x
      mad r3.x, r10.y, r12.w, r3.x
      mul r3.y, r11.w, r13.x
      mad r3.x, r3.y, l(7.000000), r3.x
      mul r3.y, r11.w, r11.z
      mad r3.x, r3.y, r3.z, r3.x
      mul r3.x, r3.x, l(0.006944)

#line 388
      mad r3.y, r9.z, l(0.006944), -r3.x
      mad r9.w, r9.x, r3.y, r3.x
    endif 
  endif   // r9.w <- shadow
