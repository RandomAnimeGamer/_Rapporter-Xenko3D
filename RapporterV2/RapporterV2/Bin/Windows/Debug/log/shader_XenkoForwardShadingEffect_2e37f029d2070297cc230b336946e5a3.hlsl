...
//
#line 1014 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_2e37f029d2070297cc230b336946e5a3.hlsl"
...
@G    Pixel => 6a932d63c8bca6841b587b6ef6fafd00
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 995 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_2e37f029d2070297cc230b336946e5a3.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xy, r2.xyxx, t0.xyzw, s2  // r2.x <- <Compute_id352 return value>.x; r2.y <- <Compute_id352 return value>.y
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r5.xyxx, t1.yzwx, s2  // r0.w <- <Compute_id360 return value>.x

#line 537
mad r5.xy, v4.xyxx, cb1[6].zwzz, cb1[7].xyxx
sample_indexable(texture2d)(float,float,float,float) r5.xyz, r5.xyxx, t2.xyzw, s2  // r5.x <- <Compute_id370 return value>.x; r5.y <- <Compute_id370 return value>.y; r5.z <- <Compute_id370 return value>.z

#line 677
mul r5.xyz, r5.xyzx, cb1[8].xyzx  // r5.x <- mix1.x; r5.y <- mix1.y; r5.z <- mix1.z
...
mad r3.xy, cb1[6].xyxx, r2.wwww, l(1.000000, 1.000000, 0.000000, 0.000000)
...
ftoi r6.xy, v1.xyxx  // r6.x <- shadingPosition.x; r6.y <- shadingPosition.y
...
ushr r7.xy, r6.xyxx, l(6, 6, 0, 0)
mov r7.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r2.yz, r7.xyzw, t3.zxyw  // r2.y <- streams.lightData_id83.x; r2.z <- streams.lightData_id83.y

#line 639
and r3.y, r2.z, l(0x0000ffff)  // r3.y <- <GetMaxLightCount_id310 return value>
...
mov r12.y, r1.w  // r12.y <- streams.lightDirectAmbientOcclusion_id44
mov r12.xz, r2.yywy  // r12.x <- streams.lightIndex_id84; r12.z <- streams.NdotV_id65
...
#line 504
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r12.xxxx, t4.yzwx  // r5.w <- realLightIndex
  iadd r12.x, r12.x, l(1)  // r12.x <- streams.lightIndex_id84
  ishl r6.w, r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r14.xyzw, r6.wwww, t5.xyzw  // r14.x <- pointLight1.x; r14.y <- pointLight1.y; r14.z <- pointLight1.z; r14.w <- pointLight1.w
  bfi r5.w, l(31), l(1), r5.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r15.xyz, r5.wwww, t5.xyzw  // r15.x <- pointLight2.x; r15.y <- pointLight2.y; r15.z <- pointLight2.z
...
#line 239
  ...
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id98 return value>

#line 308
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation

#line 363
  mul r15.xyz, r5.wwww, r15.xyzx  // r15.x <- streams.lightColor_id39.x; r15.y <- streams.lightColor_id39.y; r15.z <- streams.lightColor_id39.z
...
#line 621
  ...
  rsq r6.w, r6.w
  mul r16.xyz, r6.wwww, r16.xyzx  // r16.x <- streams.H_id68.x; r16.y <- streams.H_id68.y; r16.z <- streams.H_id68.z
...
#line 302
  ...
  mul r7.w, r7.w, r10.z
  mad r14.xyz, r16.xyzx, r7.wwww, r14.xyzx  // r14.x <- <FresnelSchlick_id252 return value>.x; r14.y <- <FresnelSchlick_id252 return value>.y; r14.z <- <FresnelSchlick_id252 return value>.z

#line 297
  mul r7.w, r10.y, l(0.500000)  // r7.w <- k
  mad r10.z, -r10.y, l(0.500000), l(1.000000)
  mad r10.w, r5.w, r10.z, r7.w
  div r10.w, r5.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id270 return value>
  mad r7.w, r12.z, r10.z, r7.w
  div r7.w, r12.z, r7.w  // r7.w <- <VisibilityhSchlickGGX_id270 return value>

#line 349
  mul r7.w, r7.w, r10.w
  mul r5.w, r12.z, r5.w
  div r5.w, r7.w, r5.w  // r5.w <- <VisibilitySmithSchlickGGX_id272 return value>

#line 344
  mul r7.w, r10.y, r10.y  // r7.w <- alphaR2
  mul r6.w, r6.w, r6.w
  mad r10.z, r10.y, r10.y, l(-1.000000)
  mad r6.w, r6.w, r10.z, l(1.000000)
  max r6.w, r6.w, l(0.000100)
  mul r6.w, r6.w, r6.w
  mul r6.w, r6.w, l(3.141593)
  div r6.w, r7.w, r6.w  // r6.w <- <NormalDistributionGGX_id286 return value>
...
#line 600
ushr r2.y, r2.z, l(16)  // r2.y <- <GetMaxLightCount_id319 return value>

#line 765
mov r6.xyz, v0.xyzx
mov r7.yw, r2.xxxw  // r7.y <- streams.alphaRoughness_id63; r7.w <- streams.NdotV_id65
mov r8.xyz, r0.xyzx  // r8.x <- streams.viewWS_id61.x; r8.y <- streams.viewWS_id61.y; r8.z <- streams.viewWS_id61.z
mov r9.xyz, r3.xzwx  // r9.x <- streams.matDiffuseVisible_id62.x; r9.y <- streams.matDiffuseVisible_id62.y; r9.z <- streams.matDiffuseVisible_id62.z
...
mov r3.y, r12.x  // r3.y <- streams.lightIndex_id84
mov r4.w, l(0)  // r4.w <- i
loop 
  ige r5.w, r4.w, r2.y
  breakc_nz r5.w
...
#line 473
  ld_indexable(buffer)(uint,uint,uint,uint) r5.w, r3.yyyy, t4.yzwx  // r5.w <- realLightIndex
...
#line 233
  ...
  mad r5.w, -r5.w, r5.w, l(1.000000)
  max r5.w, r5.w, l(0.000000)  // r5.w <- smoothFactor
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id106 return value>
...
#line 338
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r15.xyz, r5.wwww, r17.xyzx  // r15.x <- streams.lightColor_id39.x; r15.y <- streams.lightColor_id39.y; r15.z <- streams.lightColor_id39.z

#line 590
  dp3 r5.w, r11.xyzx, r14.xyzx
  max r5.w, r5.w, l(0.000100)  // r5.w <- streams.NdotL_id43
  mul r15.xyz, r5.wwww, r15.xyzx
  mul r15.xyz, r2.zzzz, r15.xyzx  // r15.x <- streams.lightColorNdotL_id40.x; r15.y <- streams.lightColorNdotL_id40.y; r15.z <- streams.lightColorNdotL_id40.z
...
#line 297
  ...
  mad r8.w, r5.w, r7.z, r7.x
  div r8.w, r5.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id270 return value>
...
#line 349
  mul r7.x, r7.x, r8.w
  mul r5.w, r7.w, r5.w
  div r5.w, r7.x, r5.w  // r5.w <- <VisibilitySmithSchlickGGX_id272 return value>
...
mov r14.xyz, r12.yzwy  // r14.x <- directLightingContribution.x; r14.y <- directLightingContribution.y; r14.z <- directLightingContribution.z
mov r2.z, r1.w
mov r3.y, l(0)  // r3.y <- i
loop 
  ige r4.w, r3.y, l(1)
...
#line 572
  dp3 r4.w, r13.xyzx, -cb2[25].xyzx
  max r4.w, r4.w, l(0.000100)  // r4.w <- streams.NdotL_id43

#line 423
  ishl r5.w, r3.y, l(2)  // r5.w <- cascadeIndexBase

#line 430
  lt r8.x, cb2[r5.w + 46].x, r7.w

#line 433
  and r8.x, r8.x, l(1)  // r8.x <- cascadeIndex

#line 430
  bfi r15.xy, l(30, 30, 0, 0), l(2, 2, 0, 0), r3.yyyy, l(1, 2, 0, 0)
...
#line 313
  bfi r9.w, l(30), l(2), r3.y, r8.x
  ishl r10.w, r8.x, l(2)
  bfi r10.w, l(30), l(4), r3.y, r10.w
  dp4 r15.x, r6.xyzw, cb2[r10.w + 28].xyzw  // r15.x <- shadowPosition.x
  dp4 r15.y, r6.xyzw, cb2[r10.w + 29].xyzw  // r15.y <- shadowPosition.y
  dp4 r11.w, r6.xyzw, cb2[r10.w + 30].xyzw  // r11.w <- shadowPosition.z
  dp4 r10.w, r6.xyzw, cb2[r10.w + 31].xyzw  // r10.w <- shadowPosition.w
  add r15.z, r11.w, -cb2[44].x  // r15.z <- shadowPosition.z
  div r15.xyz, r15.xyzx, r10.wwww
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r20.xyxx, t7.xxxx, s1, r15.z  // r11.w <- <SampleTextureAndCompare_id122 return value>

#line 271
  mul r15.xy, r16.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r12.x, r20.zwzz, t7.xxxx, s1, r15.z  // r12.x <- <SampleTextureAndCompare_id122 return value>

#line 269
  mul r12.x, r12.x, r15.x
  mad r10.w, r10.w, r11.w, r12.x  // r10.w <- shadow
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r21.xyxx, t7.xxxx, s1, r15.z

#line 271
  mad r10.w, r15.y, r11.w, r10.w

#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r21.zwzz, t7.xxxx, s1, r15.z
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r20.zwzz, t7.xxxx, s1, r15.z
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r19.xyxx, t7.xxxx, s1, r15.z

#line 274
  mad r10.w, r15.w, r11.w, r10.w

#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r19.zwzz, t7.xxxx, s1, r15.z
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r12.x, r15.xyxx, t7.xxxx, s1, r15.z  // r12.x <- <SampleTextureAndCompare_id122 return value>

#line 276
  mad r10.w, r11.w, r12.x, r10.w
  mul r11.w, r10.w, l(0.006944)  // r11.w <- shadow

#line 442
  iadd r12.x, r9.w, l(-1)
  add r12.x, -cb2[r12.x + 46].x, cb2[r9.w + 46].x
  movc r12.x, r8.x, r12.x, cb2[r9.w + 46].x  // r12.x <- splitSize
  add r9.w, -r7.w, cb2[r9.w + 46].x
  div r9.w, r9.w, r12.x  // r9.w <- splitDist
  lt r12.x, r9.w, l(0.200000)

#line 313
  ishl r5.w, r5.w, l(2)
  imad r5.w, r8.x, l(4), r5.w
  iadd r5.w, r5.w, l(4)
  dp4 r15.x, r6.xyzw, cb2[r5.w + 28].xyzw  // r15.x <- shadowPosition.x
  dp4 r15.y, r6.xyzw, cb2[r5.w + 29].xyzw  // r15.y <- shadowPosition.y
  dp4 r8.x, r6.xyzw, cb2[r5.w + 30].xyzw  // r8.x <- shadowPosition.z
  dp4 r5.w, r6.xyzw, cb2[r5.w + 31].xyzw  // r5.w <- shadowPosition.w
  add r15.z, r8.x, -cb2[44].x  // r15.z <- shadowPosition.z
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r5.w, r19.xyxx, t7.xxxx, s1, r6.z  // r5.w <- <SampleTextureAndCompare_id122 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r6.x, r19.zwzz, t7.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id122 return value>
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r6.y, r19.xyxx, t7.xxxx, s1, r6.z  // r6.y <- <SampleTextureAndCompare_id122 return value>

#line 272
  mad r20.xyzw, r18.xyzy, cb2[27].zwzw, r15.xyxy

#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r8.x, r20.xyxx, t7.xxxx, s1, r6.z  // r8.x <- <SampleTextureAndCompare_id122 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r20.zwzz, t7.xxxx, s1, r6.z  // r13.w <- <SampleTextureAndCompare_id122 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r19.zwzz, t7.xxxx, s1, r6.z  // r14.w <- <SampleTextureAndCompare_id122 return value>
...
#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r16.z, r18.xyxx, t7.xxxx, s1, r6.z  // r16.z <- <SampleTextureAndCompare_id122 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r16.w, r18.zwzz, t7.xxxx, s1, r6.z  // r16.w <- <SampleTextureAndCompare_id122 return value>

#line 276
  mad r15.xy, r17.xyxx, cb2[27].zwzz, r15.xyxx

#line 229
  sample_c_indexable(texture2d)(float,float,float,float) r6.z, r15.xyxx, t7.xxxx, s1, r6.z  // r6.z <- <SampleTextureAndCompare_id122 return value>
...
#line 447
    if_z r8.z
      mul_sat r8.z, r9.w, l(5.000000)
      mad r9.w, r8.z, l(-2.000000), l(3.000000)
      mul r8.z, r8.z, r8.z
      mul r8.z, r8.z, r9.w  // r8.z <- lerpAmt

#line 268
      mul r9.w, r15.z, r15.w
      mul r6.x, r15.z, r6.x
      mul r6.x, r6.x, l(7.000000)
      mad r5.w, r9.w, r5.w, r6.x  // r5.w <- shadow

#line 274
      mul r15.xy, r15.zwzz, r16.xyxx

#line 270
      mad r5.w, r15.x, r6.y, r5.w
      mul r6.x, r8.x, r15.w
      mad r5.w, r6.x, l(7.000000), r5.w
      mad r5.w, r13.w, l(49.000000), r5.w
      mul r6.x, r14.w, r16.x
      mad r5.w, r6.x, l(7.000000), r5.w
      mad r5.w, r15.y, r16.z, r5.w
      mul r6.x, r16.y, r16.w
      mad r5.w, r6.x, l(7.000000), r5.w
      mul r6.x, r16.y, r16.x
      mad r5.w, r6.x, r6.z, r5.w
      mul r5.w, r5.w, l(0.006944)

#line 453
      mad r6.x, r10.w, l(0.006944), -r5.w
      mad r11.w, r8.z, r6.x, r5.w
    endif 
  endif   // r11.w <- shadow
...
#line 297
  ...
  mad r9.w, r4.w, r8.z, r8.x
  div r9.w, r4.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id270 return value>
...
#line 349
  mul r8.x, r8.x, r9.w
  mul r4.w, r8.w, r4.w
  div r4.w, r8.x, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id272 return value>
...
#line 344
  ...
  div r5.w, r8.x, r5.w  // r5.w <- <NormalDistributionGGX_id286 return value>
...
#line 565
mul r6.xyz, r0.wwww, cb2[50].xyzx  // r6.x <- lightColor.x; r6.y <- lightColor.y; r6.z <- lightColor.z
...
mad r2.yzw, r4.xxyz, r1.wwww, r2.yyyy  // r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id287 return value>.x; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id287 return value>.y; r2.w <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id287 return value>.z

#line 556
mul r4.xyz, r6.xyzx, r2.yzwy  // r4.x <- <ComputeEnvironmentLightContribution_id515 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id515 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id515 return value>.z

#line 817
mad r4.xyz, r3.xzwx, r6.xyzx, r4.xyzx  // r4.x <- environmentLightingContribution.x; r4.y <- environmentLightingContribution.y; r4.z <- environmentLightingContribution.z
...
#line 378
mul r5.w, r3.y, r3.y  // r5.w <- y2
mul r6.x, r4.w, r4.w  // r6.x <- z2

#line 383
mad r6.yzw, cb2[52].xxyz, r3.yyyy, cb2[51].xxyz  // r6.y <- color.x; r6.z <- color.y; r6.w <- color.z
mad r6.yzw, cb2[53].xxyz, -r4.wwww, r6.yyzw
mad r6.yzw, cb2[54].xxyz, r1.wwww, r6.yyzw

#line 388
mul r7.xyz, r3.yyyy, cb2[55].xyzx
mad r6.yzw, r7.xxyz, r1.wwww, r6.yyzw
mul r7.xyz, r3.yyyy, cb2[56].xyzx
mad r6.yzw, r7.xxyz, -r4.wwww, r6.yyzw
mad r3.y, r6.x, l(3.000000), l(-1.000000)
mad r6.xyz, cb2[57].xyzx, r3.yyyy, r6.yzwy  // r6.x <- color.x; r6.y <- color.y; r6.z <- color.z
mul r7.xyz, r1.wwww, cb2[58].xyzx
mad r6.xyz, r7.xyzx, -r4.wwww, r6.xyzx
mad r1.w, r1.w, r1.w, -r5.w
mad r6.xyz, cb2[59].xyzx, r1.wwww, r6.xyzx

#line 547
mul r6.xyz, r6.xyzx, cb2[64].xxxx
mul r6.xyz, r0.wwww, r6.xyzx  // r6.x <- streams.envLightDiffuseColor_id41.x; r6.y <- streams.envLightDiffuseColor_id41.y; r6.z <- streams.envLightDiffuseColor_id41.z
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t8.xyzw, s0, r0.x  // r0.x <- <Compute_id337 return value>.x; r0.y <- <Compute_id337 return value>.y; r0.z <- <Compute_id337 return value>.z
...
#line 825
mad r1.xyz, r3.xzwx, r6.xyzx, r4.xyzx  // r1.x <- environmentLightingContribution.x; r1.y <- environmentLightingContribution.y; r1.z <- environmentLightingContribution.z
...
#line 727
mad o0.xyz, r5.xyzx, cb1[9].xxxx, r0.xyzx
