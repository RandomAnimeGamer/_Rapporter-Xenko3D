...
//
#line 758 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_a7995fd1d983cadf94b82abfa1ace19e.hlsl"
...
@G    Pixel => 336fe2c9ebd812114254bd13812efadc
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 787 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_a7995fd1d983cadf94b82abfa1ace19e.hlsl"
...
sample r1.xyzw, r1.xyxx, t0.xyzw, s1  // r1.x <- <Compute_id207 return value>.x; r1.y <- <Compute_id207 return value>.y; r1.z <- <Compute_id207 return value>.z; r1.w <- <Compute_id207 return value>.w

#line 573
mad r2.xy, v3.xyxx, cb0[1].xyxx, cb0[1].zwzz
sample r2.xyzw, r2.xyxx, t1.xyzw, s1  // r2.x <- <Compute_id209 return value>.x; r2.y <- <Compute_id209 return value>.y; r2.z <- <Compute_id209 return value>.z
...
#line 425
  ...
  ishl r3.z, r8.x, l(1)
  ld r8.xyzw, r3.zzzz, t4.xyzw  // r8.x <- pointLight1.x; r8.y <- pointLight1.y; r8.z <- pointLight1.z; r8.w <- pointLight1.w
  iadd r3.z, r3.z, l(1)
  ld r9.xyzw, r3.zzzz, t4.xyzw  // r9.x <- pointLight2.x; r9.y <- pointLight2.y; r9.z <- pointLight2.z
...
#line 406
  ld r8.xyzw, r2.wwww, t3.xyzw  // r8.x <- realLightIndex
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id84
  ishl r4.w, r8.x, l(2)
  ld r8.xyzw, r4.wwww, t5.xyzw  // r8.x <- spotLight1.x; r8.y <- spotLight1.y; r8.z <- spotLight1.z
...
#line 307
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation
  mul r8.xyz, r4.wwww, r9.xyzx  // r8.x <- streams.lightColor_id39.x; r8.y <- streams.lightColor_id39.y; r8.z <- streams.lightColor_id39.z
...
#line 282
  iadd r6.w, r6.w, r7.w
  ishl r9.x, r6.w, l(2)
  dp4 r10.x, r3.xyzw, cb1[r9.x + 28].xyzw  // r10.x <- shadowPosition.x
  dp4 r10.y, r3.xyzw, cb1[r9.x + 29].xyzw  // r10.y <- shadowPosition.y
  dp4 r9.y, r3.xyzw, cb1[r9.x + 30].xyzw  // r9.y <- shadowPosition.z
  dp4 r9.z, r3.xyzw, cb1[r9.x + 31].xyzw  // r9.z <- shadowPosition.w
  add r10.z, r9.y, -cb1[44].x  // r10.z <- shadowPosition.z
  div r9.yzw, r10.xxyz, r9.zzzz  // r9.y <- shadowPosition.x; r9.z <- shadowPosition.y; r9.w <- shadowPosition.z
...
#line 207
  sample_c r9.z, r14.xyxx, t6.xxxx, s0, r9.w  // r9.z <- <SampleTextureAndCompare_id93 return value>

#line 249
  mul r11.zw, r10.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 207
  sample_c r14.x, r14.zwzz, t6.xxxx, s0, r9.w  // r14.x <- <SampleTextureAndCompare_id93 return value>
...
#line 207
  sample_c r9.z, r15.xyxx, t6.xxxx, s0, r9.w

#line 249
  mad r9.y, r11.w, r9.z, r9.y

#line 207
  sample_c r9.z, r15.zwzz, t6.xxxx, s0, r9.w
...
#line 207
  sample_c r9.z, r14.zwzz, t6.xxxx, s0, r9.w
...
#line 207
  sample_c r9.z, r13.xyxx, t6.xxxx, s0, r9.w

#line 252
  mad r9.y, r10.w, r9.z, r9.y

#line 207
  sample_c r9.z, r13.zwzz, t6.xxxx, s0, r9.w
...
#line 207
  sample_c r9.w, r10.xyxx, t6.xxxx, s0, r9.w  // r9.w <- <SampleTextureAndCompare_id93 return value>
...
#line 375
  iadd r9.w, r6.w, l(-1)
  add r9.w, -cb1[r9.w + 46].x, cb1[r6.w + 46].x
  movc r7.w, r7.w, r9.w, cb1[r6.w + 46].x  // r7.w <- splitSize
...
#line 282
  ...
  dp4 r10.x, r3.xyzw, cb1[r9.x + 28].xyzw  // r10.x <- shadowPosition.x
  dp4 r10.y, r3.xyzw, cb1[r9.x + 29].xyzw  // r10.y <- shadowPosition.y
  dp4 r9.w, r3.xyzw, cb1[r9.x + 30].xyzw  // r9.w <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb1[r9.x + 31].xyzw  // r3.x <- shadowPosition.w
...
#line 227
  ...
  round_ni r9.xw, r3.xxxy  // r9.x <- base_uv.x; r9.w <- base_uv.y
  add r3.xy, r3.xyxx, -r9.xwxx  // r3.x <- s; r3.y <- t
  add r9.xw, r9.xxxw, l(-0.500000, 0.000000, 0.000000, -0.500000)
  mul r9.xw, r9.xxxw, cb1[27].zzzw

#line 240
  mad r10.xy, -r3.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r10.y <- uw0; r10.x <- vw0
  mad r10.zw, r3.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r10.z <- uw2; r10.w <- vw2
  mad r11.xy, -r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r11.xy, r11.xyxx, r10.yxyy
  add r11.zw, r3.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  div r3.xy, r3.xyxx, r10.zwzz
  ...
  add r11.xy, r3.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r11.x <- u2; r11.y <- v2
  mad r13.xyzw, r12.xwzw, cb1[27].zwzw, r9.xwxw

#line 207
  sample_c r3.x, r13.xyxx, t6.xxxx, s0, r3.z  // r3.x <- <SampleTextureAndCompare_id93 return value>
  sample_c r3.y, r13.zwzz, t6.xxxx, s0, r3.z  // r3.y <- <SampleTextureAndCompare_id93 return value>

#line 251
  mov r11.zw, r12.wwwy
  mad r13.xyzw, r11.xzxw, cb1[27].zwzw, r9.xwxw

#line 207
  sample_c r11.z, r13.xyxx, t6.xxxx, s0, r3.z  // r11.z <- <SampleTextureAndCompare_id93 return value>

#line 250
  mad r14.xyzw, r12.xyzy, cb1[27].zwzw, r9.xwxw

#line 207
  sample_c r11.w, r14.xyxx, t6.xxxx, s0, r3.z  // r11.w <- <SampleTextureAndCompare_id93 return value>
  sample_c r12.w, r14.zwzz, t6.xxxx, s0, r3.z  // r12.w <- <SampleTextureAndCompare_id93 return value>
  sample_c r13.x, r13.zwzz, t6.xxxx, s0, r3.z  // r13.x <- <SampleTextureAndCompare_id93 return value>
...
#line 207
  sample_c r12.x, r14.xyxx, t6.xxxx, s0, r3.z  // r12.x <- <SampleTextureAndCompare_id93 return value>
  sample_c r12.y, r14.zwzz, t6.xxxx, s0, r3.z  // r12.y <- <SampleTextureAndCompare_id93 return value>

#line 254
  mad r9.xw, r11.xxxy, cb1[27].zzzw, r9.xxxw

#line 207
  sample_c r3.z, r9.xwxx, t6.xxxx, s0, r3.z  // r3.z <- <SampleTextureAndCompare_id93 return value>
...
#line 246
      mul r7.w, r10.x, r10.y
      mul r3.y, r10.x, r3.y
      mul r3.y, r3.y, l(7.000000)
      mad r3.x, r7.w, r3.x, r3.y  // r3.x <- shadow

#line 252
      mul r9.xw, r10.xxxy, r10.zzzw

#line 248
      mad r3.x, r9.x, r11.z, r3.x
      mul r3.y, r10.y, r11.w
      mad r3.x, r3.y, l(7.000000), r3.x
      mad r3.x, r12.w, l(49.000000), r3.x
      mul r3.y, r10.z, r13.x
      mad r3.x, r3.y, l(7.000000), r3.x
      mad r3.x, r9.w, r12.x, r3.x
      mul r3.y, r10.w, r12.y
      mad r3.x, r3.y, l(7.000000), r3.x
      mul r3.y, r10.w, r10.z
      mad r3.x, r3.y, r3.z, r3.x
      mul r3.x, r3.x, l(0.006944)

#line 386
      mad r3.y, r9.y, l(0.006944), -r3.x
      mad r9.z, r6.w, r3.y, r3.x
    endif 
  endif   // r9.z <- shadow
