...
//
#line 714 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_3d74ea08b76891b1c8ac505859b97d43.hlsl"
...
@G    Pixel => 7db78d3a770edd47ad8ca048604bc50f
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 743 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_3d74ea08b76891b1c8ac505859b97d43.hlsl"
...
#line 394
  ld r6.xyzw, r1.wwww, t1.xyzw  // r6.x <- realLightIndex
  iadd r1.w, r1.w, l(1)  // r1.w <- streams.lightIndex_id84
  ishl r3.w, r6.x, l(2)
  ld r6.xyzw, r3.wwww, t3.xyzw  // r6.x <- spotLight1.x; r6.y <- spotLight1.y; r6.z <- spotLight1.z

#line 400
  iadd r7.xyz, r3.wwww, l(1, 2, 3, 0)
...
#line 295
  mul r3.w, r3.w, r4.w  // r3.w <- attenuation
  mul r7.xyz, r3.wwww, r7.xyzx  // r7.x <- streams.lightColor_id39.x; r7.y <- streams.lightColor_id39.y; r7.z <- streams.lightColor_id39.z

#line 486
  dp3 r3.w, r2.xyzx, r6.xyzx
  max r3.w, r3.w, l(0.000100)  // r3.w <- streams.NdotL_id43
  mul r6.xyz, r3.wwww, r7.xyzx  // r6.x <- streams.lightColorNdotL_id40.x; r6.y <- streams.lightColorNdotL_id40.y; r6.z <- streams.lightColorNdotL_id40.z
...
#line 195
  sample_c r7.w, r12.xyxx, t4.xxxx, s0, r8.z  // r7.w <- <SampleTextureAndCompare_id86 return value>

#line 237
  mul r12.xy, r9.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 195
  sample_c r8.w, r12.zwzz, t4.xxxx, s0, r8.z  // r8.w <- <SampleTextureAndCompare_id86 return value>
...
#line 195
  sample_c r7.w, r13.xyxx, t4.xxxx, s0, r8.z  // r7.w <- <SampleTextureAndCompare_id86 return value>
...
#line 195
  sample_c r8.x, r8.xyxx, t4.xxxx, s0, r8.z  // r8.x <- <SampleTextureAndCompare_id86 return value>
...
#line 195
  sample_c r1.x, r12.xyxx, t4.xxxx, s0, r1.z  // r1.x <- <SampleTextureAndCompare_id86 return value>
  sample_c r1.y, r12.zwzz, t4.xxxx, s0, r1.z  // r1.y <- <SampleTextureAndCompare_id86 return value>
...
#line 195
  sample_c r7.y, r12.xyxx, t4.xxxx, s0, r1.z  // r7.y <- <SampleTextureAndCompare_id86 return value>

#line 238
  mad r13.xyzw, r11.xyzy, cb1[27].zwzw, r8.xyxy

#line 195
  sample_c r9.z, r13.xyxx, t4.xxxx, s0, r1.z  // r9.z <- <SampleTextureAndCompare_id86 return value>
  sample_c r9.w, r13.zwzz, t4.xxxx, s0, r1.z  // r9.w <- <SampleTextureAndCompare_id86 return value>
  sample_c r10.z, r12.zwzz, t4.xxxx, s0, r1.z  // r10.z <- <SampleTextureAndCompare_id86 return value>
...
#line 195
  sample_c r10.w, r11.xyxx, t4.xxxx, s0, r1.z  // r10.w <- <SampleTextureAndCompare_id86 return value>
  sample_c r11.x, r11.zwzz, t4.xxxx, s0, r1.z  // r11.x <- <SampleTextureAndCompare_id86 return value>

#line 242
  mad r8.xy, r10.xyxx, cb1[27].zwzz, r8.xyxx

#line 195
  sample_c r1.z, r8.xyxx, t4.xxxx, s0, r1.z  // r1.z <- <SampleTextureAndCompare_id86 return value>
