...
@C    constantFloat_id192 => Material.MetalnessValue
...
//
#line 858 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_bf31bf050d0ccc9fe4b04e5d2ead24b2.hlsl"
...
@G    Pixel => 9bfc6c814c383feb3edc5981602da5d5
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float constantFloat_id189;         // Offset:   32 Size:     4
//   float constantFloat_id192;         // Offset:   36 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 887 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_bf31bf050d0ccc9fe4b04e5d2ead24b2.hlsl"
...
sample r2.xyzw, r2.xyxx, t0.xyzw, s2  // r2.x <- <Compute_id261 return value>.x; r2.y <- <Compute_id261 return value>.y; r2.z <- <Compute_id261 return value>.z; r2.w <- <Compute_id261 return value>.w
...
mul r1.w, r2.w, r0.w
mad r2.xyz, r1.wwww, r2.xyzx, r3.xyzx  // r2.x <- <BasicBlend_id443 return value>.x; r2.y <- <BasicBlend_id443 return value>.y; r2.z <- <BasicBlend_id443 return value>.z
...
#line 481
  ld r12.xyzw, r10.xxxx, t2.xyzw  // r12.x <- realLightIndex
  iadd r10.x, r10.x, l(1)  // r10.x <- streams.lightIndex_id84
  ishl r4.w, r12.x, l(1)
  ld r12.xyzw, r4.wwww, t3.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  iadd r4.w, r4.w, l(1)
  ld r13.xyzw, r4.wwww, t3.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 450
  ld r12.xyzw, r3.wwww, t2.xyzw  // r12.x <- realLightIndex
  iadd r3.w, r3.w, l(1)  // r3.w <- streams.lightIndex_id84
  ishl r5.w, r12.x, l(2)
  ld r12.xyzw, r5.wwww, t4.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z
...
#line 315
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r13.xyz, r5.wwww, r13.xyzx  // r13.x <- streams.lightColor_id39.x; r13.y <- streams.lightColor_id39.y; r13.z <- streams.lightColor_id39.z

#line 571
  dp3 r5.w, r5.xyzx, r12.xyzx
  max r5.w, r5.w, l(0.000100)  // r5.w <- streams.NdotL_id43
  mul r13.xyz, r5.wwww, r13.xyzx  // r13.x <- streams.lightColorNdotL_id40.x; r13.y <- streams.lightColorNdotL_id40.y; r13.z <- streams.lightColorNdotL_id40.z
...
#line 206
  sample_c r11.w, r17.xyxx, t5.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id102 return value>

#line 248
  mul r17.xy, r14.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 206
  sample_c r12.w, r17.zwzz, t5.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c r11.w, r18.xyxx, t5.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c r11.w, r19.xyxx, t5.xxxx, s1, r13.z

#line 248
  mad r11.y, r17.y, r11.w, r11.y

#line 206
  sample_c r11.w, r19.zwzz, t5.xxxx, s1, r13.z
...
#line 206
  sample_c r11.w, r18.zwzz, t5.xxxx, s1, r13.z
...
#line 206
  sample_c r11.w, r16.xyxx, t5.xxxx, s1, r13.z

#line 251
  mad r11.y, r14.y, r11.w, r11.y

#line 206
  sample_c r11.w, r16.zwzz, t5.xxxx, s1, r13.z
...
#line 206
  sample_c r12.w, r13.xyxx, t5.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c r4.x, r17.xyxx, t5.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id102 return value>
  sample_c r4.y, r17.zwzz, t5.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c r10.x, r17.xyxx, t5.xxxx, s1, r4.z  // r10.x <- <SampleTextureAndCompare_id102 return value>

#line 249
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 206
  sample_c r12.w, r18.xyxx, t5.xxxx, s1, r4.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.z, r18.zwzz, t5.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.w, r17.zwzz, t5.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c r15.z, r16.xyxx, t5.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r15.w, r16.zwzz, t5.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id102 return value>

#line 253
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 206
  sample_c r4.z, r13.xyxx, t5.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id102 return value>
...
mad r3.xyz, r3.xyzx, r0.wwww, r2.wwww  // r3.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id204 return value>.x; r3.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id204 return value>.y; r3.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id204 return value>.z

#line 537
mul r4.xyz, r3.xyzx, cb1[50].xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id408 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id408 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id408 return value>.z
...
sample_l r0.xyzw, r1.xyzx, t6.xyzw, s0, r0.x  // r0.x <- <Compute_id248 return value>.x; r0.y <- <Compute_id248 return value>.y; r0.z <- <Compute_id248 return value>.z
...
#line 910
ret 
// Approximately 458 instruction slots used
***************************
*************************/
...
{
    float4 backColor = Compute_id261(streams);
    float4 frontColor = Compute_id263();
...
{
    float4 colorBase = Compute_id266(streams);
