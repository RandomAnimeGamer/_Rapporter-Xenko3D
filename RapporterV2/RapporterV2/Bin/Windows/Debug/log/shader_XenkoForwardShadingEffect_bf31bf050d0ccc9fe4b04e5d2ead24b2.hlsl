...
@G    Pixel => cc96b862dbdf721bc6d9d4d3b58d682f
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
#line 315
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r13.xyz, r5.wwww, r15.xyzx  // r13.x <- streams.lightColor_id39.x; r13.y <- streams.lightColor_id39.y; r13.z <- streams.lightColor_id39.z
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r17.xyxx, t5.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id102 return value>

#line 248
  mul r17.xy, r14.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r17.zwzz, t5.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r18.xyxx, t5.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r13.xyxx, t5.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r17.xyxx, t5.xxxx, s1, r4.z  // r7.w <- <SampleTextureAndCompare_id102 return value>

#line 249
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r18.xyxx, t5.xxxx, s1, r4.z  // r8.w <- <SampleTextureAndCompare_id102 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t5.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id102 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r17.zwzz, t5.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id102 return value>
...
#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r16.xyxx, t5.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id102 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r16.zwzz, t5.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id102 return value>

#line 253
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 206
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.xyxx, t5.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id102 return value>
