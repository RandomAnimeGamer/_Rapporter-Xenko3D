...
#line 312
  mul r7.w, r7.w, r8.w  // r7.w <- attenuation
  mul r13.xyz, r7.wwww, r15.xyzx  // r13.x <- streams.lightColor_id39.x; r13.y <- streams.lightColor_id39.y; r13.z <- streams.lightColor_id39.z
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r18.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id112 return value>

#line 245
  mul r13.yw, r14.zzzw, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r18.zwzz, t4.xxxx, s1, r13.z  // r15.z <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.xyxx, t4.xxxx, s1, r13.z  // r14.z <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r19.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t4.xxxx, s1, r13.z  // r14.z <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r17.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r13.y, r13.ywyy, t4.xxxx, s1, r13.z  // r13.y <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id112 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r17.xyxx, t4.xxxx, s1, r4.z  // r9.w <- <SampleTextureAndCompare_id112 return value>

#line 246
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.zwzw

#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r10.x, r18.xyxx, t4.xxxx, s1, r4.z  // r10.x <- <SampleTextureAndCompare_id112 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r18.zwzz, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id112 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r17.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id112 return value>
...
#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r16.x, r16.xyxx, t4.xxxx, s1, r4.z  // r16.x <- <SampleTextureAndCompare_id112 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r16.y, r16.zwzz, t4.xxxx, s1, r4.z  // r16.y <- <SampleTextureAndCompare_id112 return value>

#line 250
  mad r13.zw, r15.xxxy, cb1[27].zzzw, r13.zzzw

#line 203
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.zwzz, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id112 return value>
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id293 return value>.x; r0.y <- <Compute_id293 return value>.y; r0.z <- <Compute_id293 return value>.z
