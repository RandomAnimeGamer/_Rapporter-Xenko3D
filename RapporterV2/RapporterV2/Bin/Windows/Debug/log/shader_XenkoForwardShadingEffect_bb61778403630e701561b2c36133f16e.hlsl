...
//
#line 465 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_bb61778403630e701561b2c36133f16e.hlsl"
...
@G    Pixel => 1cf4ad0c17e3e6000f2e521911e375a7
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 494 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_bb61778403630e701561b2c36133f16e.hlsl"
...
#line 305
and r0.w, r1.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id106 return value>
...
#line 145
  ...
  mul r1.w, r1.w, r1.w  // r1.w <- <SmoothDistanceAttenuation_id53 return value>
...
#line 275
ushr r0.w, r1.y, l(16)  // r0.w <- <GetMaxLightCount_id115 return value>
...
#line 202
  ld r7.xyzw, r2.wwww, t1.xyzw  // r7.x <- realLightIndex
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id84
  ishl r4.w, r7.x, l(2)
  ld r7.xyzw, r4.wwww, t3.xyzw  // r7.x <- spotLight1.x; r7.y <- spotLight1.y; r7.z <- spotLight1.z

#line 208
  iadd r6.yzw, r4.wwww, l(0, 1, 2, 3)
...
#line 172
  mov r2.x, r1.w
  add r6.yzw, -r2.xxyz, r7.xxyz  // r6.y <- lightVector.x; r6.z <- lightVector.y; r6.w <- lightVector.z
...
#line 139
  ...
  mul r2.x, r2.x, r2.x  // r2.x <- <SmoothDistanceAttenuation_id61 return value>
...
#line 181
  mul r2.x, r2.x, r4.w  // r2.x <- attenuation
  mul r6.yzw, r2.xxxx, r10.xxyz  // r6.y <- streams.lightColor_id39.x; r6.z <- streams.lightColor_id39.y; r6.w <- streams.lightColor_id39.z

#line 265
  dp3 r2.x, r1.xyzx, -r8.xyzx
  max r2.x, r2.x, l(0.000100)  // r2.x <- streams.NdotL_id43
  mul r6.yzw, r2.xxxx, r6.yyzw  // r6.y <- streams.lightColorNdotL_id40.x; r6.z <- streams.lightColorNdotL_id40.y; r6.w <- streams.lightColorNdotL_id40.z
...
#line 254
mul r0.xyz, cb0[0].xyzx, cb1[24].yzwy  // r0.x <- <ComputeEnvironmentLightContribution_id126 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id126 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id126 return value>.z
...
static const float PI_id98 = 3.14159265358979323846;
const static bool TIsEnergyConservative_id99 = false;
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id98 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
void Compute_id163(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id98 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id148(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id123();
