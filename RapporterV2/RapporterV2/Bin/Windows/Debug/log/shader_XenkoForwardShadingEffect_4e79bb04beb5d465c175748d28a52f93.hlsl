...
//
#line 717 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_4e79bb04beb5d465c175748d28a52f93.hlsl"
...
@G    Pixel => 8966a44b5821e0a4ca7b2822af84cf96
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 746 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_4e79bb04beb5d465c175748d28a52f93.hlsl"
...
sample r2.xyzw, r2.xyxx, t0.xyzw, s1  // r2.x <- <Compute_id253 return value>.x; r2.y <- <Compute_id253 return value>.y; r2.z <- <Compute_id253 return value>.z; r2.w <- <Compute_id253 return value>.w
...
#line 485
and r1.w, r4.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id215 return value>
...
#line 358
  ...
  ishl r7.w, r11.x, l(1)
  ld r11.xyzw, r7.wwww, t3.xyzw  // r11.x <- pointLight1.x; r11.y <- pointLight1.y; r11.z <- pointLight1.z; r11.w <- pointLight1.w
  iadd r7.w, r7.w, l(1)
  ld r12.xyzw, r7.wwww, t3.xyzw  // r12.x <- pointLight2.x; r12.y <- pointLight2.y; r12.z <- pointLight2.z
...
#line 185
  ...
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id77 return value>
...
#line 210
  ...
  mul r7.y, r7.y, r7.y
  mul r7.x, r7.y, r7.x
  mad r13.xyz, r13.xyzx, r7.xxxx, r9.xyzx  // r13.x <- <FresnelSchlick_id163 return value>.x; r13.y <- <FresnelSchlick_id163 return value>.y; r13.z <- <FresnelSchlick_id163 return value>.z

#line 206
  mad r7.x, r7.w, l(0.500000), l(0.500000)
  div r7.x, r7.w, r7.x  // r7.x <- <VisibilityhSchlickGGX_id181 return value>
  mad r7.y, r4.w, l(0.500000), l(0.500000)
  div r7.y, r4.w, r7.y  // r7.y <- <VisibilityhSchlickGGX_id181 return value>

#line 241
  mul r7.x, r7.y, r7.x
  mul r7.y, r4.w, r7.w
  div r7.x, r7.x, r7.y  // r7.x <- <VisibilitySmithSchlickGGX_id183 return value>
...
#line 557
  mad r10.xyz, r7.xywx, l(0.079577, 0.079577, 0.079577, 0.000000), r11.xyzx  // r10.x <- directLightingContribution.x; r10.y <- directLightingContribution.y; r10.z <- directLightingContribution.z
...
#line 446
ushr r1.w, r4.y, l(16)  // r1.w <- <GetMaxLightCount_id224 return value>
...
mov r9.xyz, r10.xyzx  // r9.x <- directLightingContribution.x; r9.y <- directLightingContribution.y; r9.z <- directLightingContribution.z
mov r6.w, l(0)  // r6.w <- i
loop 
  ige r7.w, r6.w, r1.w
  breakc_nz r7.w
...
#line 327
  ...
  ishl r7.w, r11.x, l(2)
  ld r11.xyzw, r7.wwww, t4.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z

#line 333
  iadd r12.xyz, r7.wwww, l(1, 2, 3, 0)
...
#line 179
  mul r7.w, r14.z, r7.w  // r7.w <- factor
  mad r7.w, -r7.w, r7.w, l(1.000000)
  max r7.w, r7.w, l(0.000000)  // r7.w <- smoothFactor
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id85 return value>

#line 200
  mul r7.w, r7.w, r8.w  // r7.w <- attenuation

#line 191
  dp3 r8.w, -r13.xyzx, r11.xyzx  // r8.w <- cd
  mad_sat r8.w, r8.w, r14.x, r14.y  // r8.w <- attenuation
  mul r8.w, r8.w, r8.w
...
#line 210
  ...
  mul r9.w, r9.w, r9.w
  mul r8.w, r8.w, r9.w
  mad r13.xyz, r13.xyzx, r8.wwww, r8.xyzx  // r13.x <- <FresnelSchlick_id163 return value>.x; r13.y <- <FresnelSchlick_id163 return value>.y; r13.z <- <FresnelSchlick_id163 return value>.z

#line 206
  mad r8.w, r7.w, l(0.500000), l(0.500000)
  div r8.w, r7.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id181 return value>
  mad r9.w, r3.w, l(0.500000), l(0.500000)
  div r9.w, r3.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id181 return value>

#line 241
  mul r8.w, r8.w, r9.w
  mul r7.w, r3.w, r7.w
  div r7.w, r8.w, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id183 return value>
...
#line 467
  add r11.xyz, r5.xyzx, -cb1[r4.w + 25].xyzx
  ...
  dp3 r4.w, -cb1[r4.w + 25].xyzx, r11.xyzx
...
#line 210
  ...
  mul r6.w, r6.w, r6.w
  mul r4.w, r4.w, r6.w
  mad r12.xyz, r12.xyzx, r4.wwww, r7.xyzx  // r12.x <- <FresnelSchlick_id163 return value>.x; r12.y <- <FresnelSchlick_id163 return value>.y; r12.z <- <FresnelSchlick_id163 return value>.z
...
#line 206
  ...
  div r6.w, r1.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id181 return value>

#line 241
  mul r4.w, r4.w, r6.w
  mul r5.w, r1.w, r5.w
  div r4.w, r4.w, r5.w  // r4.w <- <VisibilitySmithSchlickGGX_id183 return value>
...
#line 307
mad r4.xy, r0.wwww, l(-4.853000, -0.522800, 0.000000, 0.000000), l(0.990300, 0.604500, 0.000000, 0.000000)

#line 299
mul r1.w, r0.w, r0.w

#line 307
mad r4.xy, r1.wwww, l(0.193900, 8.404000, 0.000000, 0.000000), r4.yxyy

#line 299
mul r0.w, r0.w, r1.w
mad r0.w, r0.w, l(-5.069000), r4.y
min_sat r0.w, r0.w, l(0.000000)  // r0.w <- bias

#line 307
mov_sat r4.x, r4.x  // r4.x <- delta
add r1.w, -r0.w, r4.x  // r1.w <- scale
mul_sat r3.w, r3.y, l(50.000000)
mul r0.w, r0.w, r3.w
mad r3.xyz, r3.xyzx, r1.wwww, r0.wwww  // r3.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198 return value>.x; r3.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198 return value>.y; r3.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198 return value>.z
...
#line 262
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, cb1[50].w  // r0.x <- <Compute_id240 return value>.x; r0.y <- <Compute_id240 return value>.y; r0.z <- <Compute_id240 return value>.z
...
float NormalDistributionGGX_id197(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id181 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
float4 Compute_id253(inout PS_STREAMS streams)
{
...
{
    float4 colorBase = Compute_id253(streams);
