...
@G    Pixel => 0b02a227fd9c69d6b9b407b6e80fda45
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
#line 330
  mul r2.w, r2.w, r3.w  // r2.w <- attenuation
  mul r14.xyz, r2.wwww, r17.xyzx  // r14.x <- streams.lightColor_id43.x; r14.y <- streams.lightColor_id43.y; r14.z <- streams.lightColor_id43.z

#line 577
  dp3 r2.w, r10.xyzx, r12.yzwy
...
#line 608
  ...
  dp3 r4.w, r12.yzwy, r15.xyzx
  max r4.w, r4.w, l(0.000100)  // r4.w <- streams.LdotH_id74

#line 604
  mul r12.yzw, r7.xxyz, r14.xxyz
