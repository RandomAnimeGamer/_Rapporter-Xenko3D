...
//
#line 1237 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_75d789af84b8c6e243f6bc5e04e7661a.hlsl"
...
@G    Pixel => c10efe76101d08834616a6642abf0110
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 1218 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_75d789af84b8c6e243f6bc5e04e7661a.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xy, r2.xyxx, t0.xyzw, s2  // r2.x <- <Compute_id508 return value>.x; r2.y <- <Compute_id508 return value>.y
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r5.xyxx, t1.yzwx, s2  // r0.w <- <Compute_id516 return value>.x

#line 415
mad r5.xy, v4.xyxx, cb1[8].xyxx, cb1[8].zwzz
sample_indexable(texture2d)(float,float,float,float) r5.xy, r5.xyxx, t2.xyzw, s2  // r5.x <- <Compute_id583 return value>.x; r5.y <- <Compute_id583 return value>.y
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t3.yzwx, s2  // r1.w <- <Compute_id591 return value>.x

#line 379
mad r6.xy, v4.xyxx, cb1[13].zwzz, cb1[14].xyxx
sample_indexable(texture2d)(float,float,float,float) r2.w, r6.xyxx, t4.xyzw, s2  // r2.w <- <Compute_id601 return value>.x
...
mul r8.xyz, r3.wwww, r7.xyzx  // r8.x <- <BlendRNM_id871 return value>.x; r8.y <- <BlendRNM_id871 return value>.y; r8.z <- <BlendRNM_id871 return value>.z
...
#line 752
and r3.w, r2.z, l(0x0000ffff)  // r3.w <- <GetMaxLightCount_id466 return value>
...
#line 250
  ...
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id135 return value>
...
#line 313
  ...
  mul r7.z, r7.z, r7.z
  mul r7.y, r7.z, r7.y
  mad r15.xyz, r16.xyzx, r7.yyyy, r15.xyzx  // r15.x <- <FresnelSchlick_id414 return value>.x; r15.y <- <FresnelSchlick_id414 return value>.y; r15.z <- <FresnelSchlick_id414 return value>.z

#line 308
  mul r7.y, r9.y, l(0.500000)  // r7.y <- k
  mad r7.z, -r9.y, l(0.500000), l(1.000000)
  mad r9.z, r5.w, r7.z, r7.y
  div r9.z, r5.w, r9.z  // r9.z <- <VisibilityhSchlickGGX_id432 return value>
  mad r7.y, r11.z, r7.z, r7.y
  div r7.y, r11.z, r7.y  // r7.y <- <VisibilityhSchlickGGX_id432 return value>

#line 360
  mul r7.y, r7.y, r9.z
  mul r5.w, r11.z, r5.w
  div r5.w, r7.y, r5.w  // r5.w <- <VisibilitySmithSchlickGGX_id434 return value>
...
#line 355
  ...
  div r7.y, r7.y, r7.z  // r7.y <- <NormalDistributionGGX_id448 return value>
...
#line 713
ushr r2.y, r2.z, l(16)  // r2.y <- <GetMaxLightCount_id475 return value>
...
#line 349
  mul r5.w, r5.w, r7.w  // r5.w <- attenuation
  mul r14.xyz, r5.wwww, r16.xyzx  // r14.x <- streams.lightColor_id39.x; r14.y <- streams.lightColor_id39.y; r14.z <- streams.lightColor_id39.z

#line 703
  dp3 r5.w, r10.xyzx, r13.xyzx
  max r5.w, r5.w, l(0.000100)  // r5.w <- streams.NdotL_id43
  mul r14.xyz, r5.wwww, r14.xyzx
  mul r14.xyz, r2.zzzz, r14.xyzx  // r14.x <- streams.lightColorNdotL_id40.x; r14.y <- streams.lightColorNdotL_id40.y; r14.z <- streams.lightColorNdotL_id40.z
...
#line 313
  ...
  mul r9.y, r9.y, r9.y
  mul r8.w, r8.w, r9.y
  mad r15.xyz, r15.xyzx, r8.wwww, r8.xyzx  // r15.x <- <FresnelSchlick_id414 return value>.x; r15.y <- <FresnelSchlick_id414 return value>.y; r15.z <- <FresnelSchlick_id414 return value>.z

#line 308
  mul r8.w, r9.x, l(0.500000)  // r8.w <- k
  mad r9.y, -r9.x, l(0.500000), l(1.000000)
  mad r9.w, r5.w, r9.y, r8.w
  div r9.w, r5.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id432 return value>
  mad r8.w, r9.z, r9.y, r8.w
  div r8.w, r9.z, r8.w  // r8.w <- <VisibilityhSchlickGGX_id432 return value>

#line 360
  mul r8.w, r8.w, r9.w
  mul r5.w, r9.z, r5.w
  div r5.w, r8.w, r5.w  // r5.w <- <VisibilitySmithSchlickGGX_id434 return value>
...
#line 485
  ...
  lt r10.y, cb2[r10.y + 46].x, r7.w

#line 488
  movc r9.w, r10.y, l(2), r9.w

#line 485
  lt r10.y, cb2[r10.w + 46].x, r7.w
...
#line 331
  ...
  mul r10.w, r2.y, r10.w

#line 492
  mad r5.xyz, r10.wwww, r12.xyzx, r7.xyzx  // r5.x <- shadowPosition.x; r5.y <- shadowPosition.y; r5.z <- shadowPosition.z

#line 324
  bfi r10.w, l(30), l(2), r3.w, r9.w
  ishl r11.x, r9.w, l(2)
  bfi r11.x, l(30), l(4), r3.w, r11.x
  dp4 r14.x, r5.xyzw, cb2[r11.x + 28].xyzw  // r14.x <- shadowPosition.x
  dp4 r14.y, r5.xyzw, cb2[r11.x + 29].xyzw  // r14.y <- shadowPosition.y
  dp4 r12.w, r5.xyzw, cb2[r11.x + 30].xyzw  // r12.w <- shadowPosition.z
  dp4 r11.x, r5.xyzw, cb2[r11.x + 31].xyzw  // r11.x <- shadowPosition.w
  add r14.z, r12.w, -cb2[44].x  // r14.z <- shadowPosition.z
  div r14.xyz, r14.xyzx, r11.xxxx
...
#line 273
  ...
  mul r11.x, r15.z, r15.w
  mad r19.xyzw, r18.xwzw, cb2[27].zwzw, r15.xyxy

#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r19.xyxx, t9.xxxx, s1, r14.z  // r12.w <- <SampleTextureAndCompare_id159 return value>

#line 282
  mul r14.xy, r15.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r19.zwzz, t9.xxxx, s1, r14.z  // r13.w <- <SampleTextureAndCompare_id159 return value>

#line 280
  mul r13.w, r13.w, r14.x
  mad r11.x, r11.x, r12.w, r13.w  // r11.x <- shadow
...
#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r14.xyxx, t9.xxxx, s1, r14.z  // r13.w <- <SampleTextureAndCompare_id159 return value>

#line 287
  mad r11.x, r12.w, r13.w, r11.x
  mul r12.w, r11.x, l(0.006944)  // r12.w <- shadow

#line 497
  iadd r13.w, r10.w, l(-1)
  add r13.w, -cb2[r13.w + 46].x, cb2[r10.w + 46].x
  movc r13.w, r9.w, r13.w, cb2[r10.w + 46].x  // r13.w <- splitSize
  add r10.w, -r7.w, cb2[r10.w + 46].x
...
#line 324
  ...
  iadd r8.w, r8.w, l(4)
  dp4 r14.x, r5.xyzw, cb2[r8.w + 28].xyzw  // r14.x <- shadowPosition.x
  dp4 r14.y, r5.xyzw, cb2[r8.w + 29].xyzw  // r14.y <- shadowPosition.y
  dp4 r9.w, r5.xyzw, cb2[r8.w + 30].xyzw  // r9.w <- shadowPosition.z
  dp4 r5.x, r5.xyzw, cb2[r8.w + 31].xyzw  // r5.x <- shadowPosition.w
  add r14.z, r9.w, -cb2[44].x  // r14.z <- shadowPosition.z
...
#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r5.x, r18.xyxx, t9.xxxx, s1, r5.z  // r5.x <- <SampleTextureAndCompare_id159 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r5.y, r18.zwzz, t9.xxxx, s1, r5.z  // r5.y <- <SampleTextureAndCompare_id159 return value>
...
#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r18.xyxx, t9.xxxx, s1, r5.z  // r8.w <- <SampleTextureAndCompare_id159 return value>

#line 283
  mad r19.xyzw, r17.xyzy, cb2[27].zwzw, r14.xyxy

#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r19.xyxx, t9.xxxx, s1, r5.z  // r9.w <- <SampleTextureAndCompare_id159 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r19.zwzz, t9.xxxx, s1, r5.z  // r15.z <- <SampleTextureAndCompare_id159 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r18.zwzz, t9.xxxx, s1, r5.z  // r15.w <- <SampleTextureAndCompare_id159 return value>
...
#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r16.z, r17.xyxx, t9.xxxx, s1, r5.z  // r16.z <- <SampleTextureAndCompare_id159 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r16.w, r17.zwzz, t9.xxxx, s1, r5.z  // r16.w <- <SampleTextureAndCompare_id159 return value>

#line 287
  mad r14.xy, r16.xyxx, cb2[27].zwzz, r14.xyxx

#line 240
  sample_c_indexable(texture2d)(float,float,float,float) r5.z, r14.xyxx, t9.xxxx, s1, r5.z  // r5.z <- <SampleTextureAndCompare_id159 return value>
...
#line 502
    if_z r10.y
      mul_sat r10.y, r10.w, l(5.000000)
      mad r10.w, r10.y, l(-2.000000), l(3.000000)
      mul r10.y, r10.y, r10.y
      mul r10.y, r10.y, r10.w  // r10.y <- lerpAmt

#line 279
      mul r10.w, r14.z, r14.w
      mul r5.y, r14.z, r5.y
      mul r5.y, r5.y, l(7.000000)
      mad r5.x, r10.w, r5.x, r5.y  // r5.x <- shadow
...
#line 508
      mad r5.y, r11.x, l(0.006944), -r5.x
      mad r12.w, r10.y, r5.y, r5.x
    endif 
  endif   // r12.w <- shadow
...
#line 734
  add r14.xyz, r6.xyzx, -cb2[25].xyzx
...
#line 313
  ...
  mul r10.y, r10.y, r10.y
  mul r9.w, r9.w, r10.y
  mad r15.xyz, r15.xyzx, r9.wwww, r9.xyzx  // r15.x <- <FresnelSchlick_id414 return value>.x; r15.y <- <FresnelSchlick_id414 return value>.y; r15.z <- <FresnelSchlick_id414 return value>.z

#line 308
  mul r9.w, r10.x, l(0.500000)  // r9.w <- k
  mad r10.y, -r10.x, l(0.500000), l(1.000000)
  mad r10.w, r4.w, r10.y, r9.w
  div r10.w, r4.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id432 return value>
  mad r9.w, r10.z, r10.y, r9.w
  div r9.w, r10.z, r9.w  // r9.w <- <VisibilityhSchlickGGX_id432 return value>

#line 360
  mul r9.w, r9.w, r10.w
  mul r4.w, r10.z, r4.w
  div r4.w, r9.w, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id434 return value>

#line 355
  mul r9.w, r10.x, r10.x  // r9.w <- alphaR2
  mul r8.w, r8.w, r8.w
  ...
  div r8.w, r9.w, r8.w  // r8.w <- <NormalDistributionGGX_id448 return value>
...
mad r2.yzw, r3.xxyz, r1.wwww, r2.yyyy  // r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id449 return value>.x; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id449 return value>.y; r2.w <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id449 return value>.z

#line 669
mul r3.xyz, r5.xyzx, r2.yzwy  // r3.x <- <ComputeEnvironmentLightContribution_id798 return value>.x; r3.y <- <ComputeEnvironmentLightContribution_id798 return value>.y; r3.z <- <ComputeEnvironmentLightContribution_id798 return value>.z
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t10.xyzw, s0, r0.x  // r0.x <- <Compute_id493 return value>.x; r0.y <- <Compute_id493 return value>.y; r0.z <- <Compute_id493 return value>.z
