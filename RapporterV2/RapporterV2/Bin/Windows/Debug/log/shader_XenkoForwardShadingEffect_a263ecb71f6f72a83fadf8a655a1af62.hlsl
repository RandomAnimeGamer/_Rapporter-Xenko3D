...
@C    constantColor_id168 => Material.DiffuseValue
...
@R    CubeMap_id163 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (4-4)]
...
//
#line 687 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_a263ecb71f6f72a83fadf8a655a1af62.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
@G    Pixel => 41c6e8e9fce1d43514e19d7d29aff946
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
// {
//
//   float4 constantColor_id168;        // Offset:    0 Size:    16
...
// CubeMap_id163                     texture  float4        cube    4        1
...
//
#line 757 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_a263ecb71f6f72a83fadf8a655a1af62.hlsl"
...
#line 482
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id217 return value>
...
#line 184
  ...
  mul r3.z, r3.z, r3.z  // r3.z <- <SmoothDistanceAttenuation_id81 return value>
...
#line 204
  ...
  mul r3.w, r3.w, r3.w
  mul r3.z, r3.w, r3.z
  mad r10.xyz, r10.xyzx, r3.zzzz, r8.xyzx  // r10.x <- <FresnelSchlick_id167 return value>.x; r10.y <- <FresnelSchlick_id167 return value>.y; r10.z <- <FresnelSchlick_id167 return value>.z
...
#line 321
  ld r10.xyzw, r3.wwww, t1.xyzw  // r10.x <- realLightIndex
...
#line 204
  ...
  mul r5.w, r5.w, r5.w
  mul r4.w, r4.w, r5.w
  mad r12.xyz, r12.xyzx, r4.wwww, r7.xyzx  // r12.x <- <FresnelSchlick_id167 return value>.x; r12.y <- <FresnelSchlick_id167 return value>.y; r12.z <- <FresnelSchlick_id167 return value>.z
...
mov r4.xyz, r1.xyzx  // r4.x <- streams.viewWS_id65.x; r4.y <- streams.viewWS_id65.y; r4.z <- streams.viewWS_id65.z
...
#line 415
  ...
  mul r9.xyz, r3.wwww, cb1[r2.w + 26].xyzx  // r9.x <- streams.lightColorNdotL_id44.x; r9.y <- streams.lightColorNdotL_id44.y; r9.z <- streams.lightColorNdotL_id44.z

#line 464
  add r10.xyz, r4.xyzx, -cb1[r2.w + 25].xyzx
  dp3 r3.w, r10.xyzx, r10.xyzx
  rsq r3.w, r3.w
  mul r10.xyz, r3.wwww, r10.xyzx  // r10.x <- streams.H_id72.x; r10.y <- streams.H_id72.y; r10.z <- streams.H_id72.z
...
#line 204
  ...
  mul r3.w, r3.w, r3.w
  mul r2.w, r2.w, r3.w
  mad r11.xyz, r11.xyzx, r2.wwww, r6.xyzx  // r11.x <- <FresnelSchlick_id167 return value>.x; r11.y <- <FresnelSchlick_id167 return value>.y; r11.z <- <FresnelSchlick_id167 return value>.z
...
mul r0.w, r0.w, r2.w
mad r2.xyz, r2.xyzx, r1.wwww, r0.wwww  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id200 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id200 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id200 return value>.z

#line 399
mul r3.xyz, r2.xyzx, cb1[41].xyzx  // r3.x <- <ComputeEnvironmentLightContribution_id400 return value>.x; r3.y <- <ComputeEnvironmentLightContribution_id400 return value>.y; r3.z <- <ComputeEnvironmentLightContribution_id400 return value>.z
...
#line 390
mul r4.xyz, r4.xyzx, cb1[55].xxxx  // r4.x <- streams.envLightDiffuseColor_id45.x; r4.y <- streams.envLightDiffuseColor_id45.y; r4.z <- streams.envLightDiffuseColor_id45.z
...
#line 256
sample_l r0.xyzw, r1.xyzx, t4.xyzw, s0, cb1[50].w  // r0.x <- <Compute_id242 return value>.x; r0.y <- <Compute_id242 return value>.y; r0.z <- <Compute_id242 return value>.z
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id66;
    return diffuseColor / PI_id181 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id62.x;
}
...
void Compute_id430(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id70 += directLightingContribution * PI_id181 + environmentLightingContribution;
