...
//
#line 91 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ShadowMapCaster_7b6a91e26ff16bd85aa1d2bdef780e64.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
cbuffer PerMaterial 
{
    ...
    float4 constantColor_id143;
    float constantFloat_id145;
};
cbuffer PerView 
{
    float4x4 View_id22;
