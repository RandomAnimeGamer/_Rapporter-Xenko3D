...
//
#line 654 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_5dc509381eff493d97a3231008fa6b94.hlsl"
...
@G    Pixel => adc74fa6f3400315b41dbacff08086d6
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 683 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_5dc509381eff493d97a3231008fa6b94.hlsl"
...
#line 372
  ld r6.xyzw, r5.xxxx, t1.xyzw  // r6.x <- realLightIndex
  iadd r5.x, r5.x, l(1)  // r5.x <- streams.lightIndex_id84
  ishl r1.w, r6.x, l(1)
  ld r6.xyzw, r1.wwww, t2.xyzw  // r6.x <- pointLight1.x; r6.y <- pointLight1.y; r6.z <- pointLight1.z; r6.w <- pointLight1.w
  iadd r1.w, r1.w, l(1)
  ld r7.xyzw, r1.wwww, t2.xyzw  // r7.x <- pointLight2.x; r7.y <- pointLight2.y; r7.z <- pointLight2.z
...
mov r2.w, r5.x  // r2.w <- streams.lightIndex_id84
mov r3.w, l(0)  // r3.w <- i
loop 
  ige r4.w, r3.w, r0.w
  breakc_nz r4.w
...
#line 353
  ld r6.xyzw, r2.wwww, t1.xyzw  // r6.x <- realLightIndex
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id84
  ishl r4.w, r6.x, l(2)
  ld r6.xyzw, r4.wwww, t3.xyzw  // r6.x <- spotLight1.x; r6.y <- spotLight1.y; r6.z <- spotLight1.z

#line 359
  iadd r7.xyz, r4.wwww, l(1, 2, 3, 0)
  ld r8.xyzw, r7.xxxx, t3.xyzw  // r8.x <- spotLight2.x; r8.y <- spotLight2.y; r8.z <- spotLight2.z
  ld r9.xyzw, r7.yyyy, t3.xyzw  // r9.x <- spotLight3.x; r9.y <- spotLight3.y; r9.z <- spotLight3.z
  ld r7.xyzw, r7.zzzz, t3.xyzw  // r7.x <- spotLight4.x; r7.y <- spotLight4.y; r7.z <- spotLight4.z
...
#line 189
  mul r2.x, r9.z, r2.x  // r2.x <- factor
  mad r2.x, -r2.x, r2.x, l(1.000000)
  max r2.x, r2.x, l(0.000000)  // r2.x <- smoothFactor
  mul r2.x, r2.x, r2.x  // r2.x <- <SmoothDistanceAttenuation_id64 return value>
...
#line 285
  mul r2.x, r2.x, r4.w  // r2.x <- attenuation
  mul r7.xyz, r2.xxxx, r7.xyzx  // r7.x <- streams.lightColor_id39.x; r7.y <- streams.lightColor_id39.y; r7.z <- streams.lightColor_id39.z

#line 434
  dp3 r2.x, r1.xyzx, r6.xyzx
  max r2.x, r2.x, l(0.000100)  // r2.x <- streams.NdotL_id43
  mul r6.xyz, r2.xxxx, r7.xyzx  // r6.x <- streams.lightColorNdotL_id40.x; r6.y <- streams.lightColorNdotL_id40.y; r6.z <- streams.lightColorNdotL_id40.z
...
mov r2.xyz, r0.xyzx  // r2.x <- streams.normalWS_id16.x; r2.y <- streams.normalWS_id16.y; r2.z <- streams.normalWS_id16.z
mov r2.w, v0.x  // r2.w <- streams.PositionWS_id19.x
mov r3.xy, v0.yzyy  // r3.x <- streams.PositionWS_id19.y; r3.y <- streams.PositionWS_id19.z
mov r3.z, v2.x  // r3.z <- streams.DepthVS_id20
...
#line 310
  ...
  lt r7.x, cb1[r7.x + 46].x, r3.z

#line 313
  movc r6.w, r7.x, l(2), r6.w

#line 310
  lt r7.x, cb1[r7.y + 46].x, r3.z
...
#line 317
  mov r8.x, r2.w
  mov r8.yz, r3.xxyx
  mad r1.xyz, r7.yyyy, r2.xyzx, r8.xyzx  // r1.x <- shadowPosition.x; r1.y <- shadowPosition.y; r1.z <- shadowPosition.z

#line 260
  iadd r5.w, r5.w, r6.w
  ishl r7.y, r5.w, l(2)
  dp4 r8.x, r1.xyzw, cb1[r7.y + 28].xyzw  // r8.x <- shadowPosition.x
  dp4 r8.y, r1.xyzw, cb1[r7.y + 29].xyzw  // r8.y <- shadowPosition.y
  dp4 r7.z, r1.xyzw, cb1[r7.y + 30].xyzw  // r7.z <- shadowPosition.z
  dp4 r7.w, r1.xyzw, cb1[r7.y + 31].xyzw  // r7.w <- shadowPosition.w
  add r8.z, r7.z, -cb1[44].x  // r8.z <- shadowPosition.z
...
#line 185
  sample_c r7.w, r12.xyxx, t4.xxxx, s0, r8.z  // r7.w <- <SampleTextureAndCompare_id80 return value>

#line 227
  mul r12.xy, r9.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 185
  sample_c r8.w, r12.zwzz, t4.xxxx, s0, r8.z  // r8.w <- <SampleTextureAndCompare_id80 return value>
...
#line 185
  sample_c r7.w, r13.xyxx, t4.xxxx, s0, r8.z  // r7.w <- <SampleTextureAndCompare_id80 return value>
...
#line 185
  sample_c r7.w, r14.xyxx, t4.xxxx, s0, r8.z

#line 227
  mad r7.z, r12.y, r7.w, r7.z

#line 185
  sample_c r7.w, r14.zwzz, t4.xxxx, s0, r8.z
...
#line 185
  sample_c r7.w, r13.zwzz, t4.xxxx, s0, r8.z
...
#line 185
  sample_c r7.w, r11.xyxx, t4.xxxx, s0, r8.z

#line 230
  mad r7.z, r9.y, r7.w, r7.z

#line 185
  sample_c r7.w, r11.zwzz, t4.xxxx, s0, r8.z
...
#line 185
  sample_c r8.x, r8.xyxx, t4.xxxx, s0, r8.z  // r8.x <- <SampleTextureAndCompare_id80 return value>
...
#line 322
  iadd r8.x, r5.w, l(-1)
  add r8.x, -cb1[r8.x + 46].x, cb1[r5.w + 46].x
  movc r6.w, r6.w, r8.x, cb1[r5.w + 46].x  // r6.w <- splitSize
  add r5.w, -r3.z, cb1[r5.w + 46].x
...
#line 260
  ...
  dp4 r8.x, r1.xyzw, cb1[r7.y + 28].xyzw  // r8.x <- shadowPosition.x
  dp4 r8.y, r1.xyzw, cb1[r7.y + 29].xyzw  // r8.y <- shadowPosition.y
  dp4 r8.w, r1.xyzw, cb1[r7.y + 30].xyzw  // r8.w <- shadowPosition.z
  dp4 r1.x, r1.xyzw, cb1[r7.y + 31].xyzw  // r1.x <- shadowPosition.w
  add r8.z, r8.w, -cb1[44].x  // r8.z <- shadowPosition.z
  div r1.xyz, r8.xyzx, r1.xxxx  // r1.x <- shadowPosition.x; r1.y <- shadowPosition.y; r1.z <- shadowPosition.z

#line 205
  mad r1.xy, r1.xyxx, cb1[27].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r8.xy, r1.xyxx  // r8.x <- base_uv.x; r8.y <- base_uv.y
  add r1.xy, r1.xyxx, -r8.xyxx  // r1.x <- s; r1.y <- t
  add r8.xy, r8.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  mul r8.xy, r8.xyxx, cb1[27].zwzz

#line 218
  mad r8.zw, -r1.yyyx, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r8.w <- uw0; r8.z <- vw0
  mad r9.xy, r1.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r9.x <- uw2; r9.y <- vw2
  mad r9.zw, -r1.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r9.zw, r9.zzzw, r8.wwwz
  add r10.xy, r1.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)
  div r1.xy, r1.xyxx, r9.xyxx
  add r11.xw, r9.zzzw, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r11.x <- u0; r11.w <- v0
  mul r11.yz, r10.yyxy, l(0.000000, 0.142857, 0.142857, 0.000000)  // r11.z <- u1; r11.y <- v1
  add r10.xy, r1.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r10.x <- u2; r10.y <- v2
  mad r12.xyzw, r11.xwzw, cb1[27].zwzw, r8.xyxy

#line 185
  sample_c r1.x, r12.xyxx, t4.xxxx, s0, r1.z  // r1.x <- <SampleTextureAndCompare_id80 return value>
  sample_c r1.y, r12.zwzz, t4.xxxx, s0, r1.z  // r1.y <- <SampleTextureAndCompare_id80 return value>

#line 229
  mov r10.zw, r11.wwwy
  mad r12.xyzw, r10.xzxw, cb1[27].zwzw, r8.xyxy

#line 185
  sample_c r7.y, r12.xyxx, t4.xxxx, s0, r1.z  // r7.y <- <SampleTextureAndCompare_id80 return value>

#line 228
  mad r13.xyzw, r11.xyzy, cb1[27].zwzw, r8.xyxy

#line 185
  sample_c r9.z, r13.xyxx, t4.xxxx, s0, r1.z  // r9.z <- <SampleTextureAndCompare_id80 return value>
  sample_c r9.w, r13.zwzz, t4.xxxx, s0, r1.z  // r9.w <- <SampleTextureAndCompare_id80 return value>
  sample_c r10.z, r12.zwzz, t4.xxxx, s0, r1.z  // r10.z <- <SampleTextureAndCompare_id80 return value>
...
#line 185
  sample_c r10.w, r11.xyxx, t4.xxxx, s0, r1.z  // r10.w <- <SampleTextureAndCompare_id80 return value>
  sample_c r11.x, r11.zwzz, t4.xxxx, s0, r1.z  // r11.x <- <SampleTextureAndCompare_id80 return value>

#line 232
  mad r8.xy, r10.xyxx, cb1[27].zwzz, r8.xyxx

#line 185
  sample_c r1.z, r8.xyxx, t4.xxxx, s0, r1.z  // r1.z <- <SampleTextureAndCompare_id80 return value>
...
#line 224
      ...
      mad r1.x, r6.w, r1.x, r1.y  // r1.x <- shadow

#line 230
      mul r8.xy, r8.zwzz, r9.xyxx

#line 226
      mad r1.x, r8.x, r7.y, r1.x
      mul r1.y, r8.w, r9.z
      mad r1.x, r1.y, l(7.000000), r1.x
      mad r1.x, r9.w, l(49.000000), r1.x
      mul r1.y, r9.x, r10.z
      mad r1.x, r1.y, l(7.000000), r1.x
