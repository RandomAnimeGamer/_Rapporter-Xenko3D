...
@C    constantColor_id169 => Material.SpecularValue
@C    constantFloat_id171 => Material.SpecularIntensityValue
...
@R    CubeMap_id159 => RoughnessCubeMapEnvironmentColor.CubeMap.lightSpecularColor.environmentLights[1] [Stage: Pixel, Slot: (4-4)]
...
//
#line 710 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_a00dc92f2c7235db47593790a8cae7cb.hlsl"
...
@G    Pixel => 915552dae5797ae0114483afa07f8972
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
// CubeMap_id159                     texture  float4        cube    4        1
...
//
#line 739 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_a00dc92f2c7235db47593790a8cae7cb.hlsl"
...
#line 478
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id215 return value>
...
#line 178
  ...
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id77 return value>
...
#line 203
  ...
  mul r6.y, r6.y, r6.y
  mul r6.x, r6.y, r6.x
  mad r12.xyz, r12.xyzx, r6.xxxx, r8.xyzx  // r12.x <- <FresnelSchlick_id163 return value>.x; r12.y <- <FresnelSchlick_id163 return value>.y; r12.z <- <FresnelSchlick_id163 return value>.z

#line 199
  mad r6.x, r6.w, l(0.500000), l(0.500000)
  div r6.x, r6.w, r6.x  // r6.x <- <VisibilityhSchlickGGX_id181 return value>
  mad r6.y, r3.w, l(0.500000), l(0.500000)
  div r6.y, r3.w, r6.y  // r6.y <- <VisibilityhSchlickGGX_id181 return value>

#line 234
  mul r6.x, r6.y, r6.x
  mul r6.y, r3.w, r6.w
  div r6.x, r6.x, r6.y  // r6.x <- <VisibilitySmithSchlickGGX_id183 return value>
...
#line 439
ushr r1.w, r3.y, l(16)  // r1.w <- <GetMaxLightCount_id224 return value>

#line 560
mov r4.xyz, v0.xyzx  // r4.x <- streams.PositionWS_id19.x; r4.y <- streams.PositionWS_id19.y; r4.z <- streams.PositionWS_id19.z
mov r4.w, r3.z  // r4.w <- streams.lightIndex_id84
mov r3.xyw, r0.xyxz  // r3.x <- streams.normalWS_id16.x; r3.y <- streams.normalWS_id16.y; r3.w <- streams.normalWS_id16.z
...
#line 172
  ...
  mad r6.w, -r6.w, r6.w, l(1.000000)
  max r6.w, r6.w, l(0.000000)  // r6.w <- smoothFactor
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id85 return value>
...
#line 203
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r12.xyz, r12.xyzx, r7.wwww, r7.xyzx  // r12.x <- <FresnelSchlick_id163 return value>.x; r12.y <- <FresnelSchlick_id163 return value>.y; r12.z <- <FresnelSchlick_id163 return value>.z

#line 199
  mad r7.w, r6.w, l(0.500000), l(0.500000)
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id181 return value>
  mad r8.w, r2.w, l(0.500000), l(0.500000)
  div r8.w, r2.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id181 return value>

#line 234
  mul r7.w, r7.w, r8.w
  mul r6.w, r2.w, r6.w
  div r6.w, r7.w, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id183 return value>
...
#line 584
mov r3.xyz, r0.xyzx  // r3.z <- streams.normalWS_id16.z
...
#line 203
  ...
  mul r5.w, r5.w, r5.w
  mul r3.w, r3.w, r5.w
  mad r11.xyz, r11.xyzx, r3.wwww, r6.xyzx  // r11.x <- <FresnelSchlick_id163 return value>.x; r11.y <- <FresnelSchlick_id163 return value>.y; r11.z <- <FresnelSchlick_id163 return value>.z

#line 199
  mad r3.w, r4.w, l(0.500000), l(0.500000)
  div r3.w, r4.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id181 return value>
...
#line 234
  mul r3.w, r3.w, r5.w
  mul r4.w, r1.w, r4.w
  div r3.w, r3.w, r4.w  // r3.w <- <VisibilitySmithSchlickGGX_id183 return value>
...
#line 300
mad r3.xy, r0.wwww, l(-4.853000, -0.522800, 0.000000, 0.000000), l(0.990300, 0.604500, 0.000000, 0.000000)

#line 292
mul r1.w, r0.w, r0.w

#line 300
mad r3.xy, r1.wwww, l(0.193900, 8.404000, 0.000000, 0.000000), r3.yxyy

#line 292
mul r0.w, r0.w, r1.w
mad r0.w, r0.w, l(-5.069000), r3.y
min_sat r0.w, r0.w, l(0.000000)  // r0.w <- bias

#line 300
mov_sat r3.x, r3.x  // r3.x <- delta
add r1.w, -r0.w, r3.x  // r1.w <- scale
mul_sat r2.w, r2.y, l(50.000000)
mul r0.w, r0.w, r2.w
mad r2.xyz, r2.xyzx, r1.wwww, r0.wwww  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198 return value>.z

#line 395
mul r3.xyz, r2.xyzx, cb1[41].xyzx  // r3.x <- <ComputeEnvironmentLightContribution_id396 return value>.x; r3.y <- <ComputeEnvironmentLightContribution_id396 return value>.y; r3.z <- <ComputeEnvironmentLightContribution_id396 return value>.z

#line 612
mad r3.xyz, cb0[0].xyzx, cb1[41].xyzx, r3.xyzx  // r3.x <- environmentLightingContribution.x; r3.y <- environmentLightingContribution.y; r3.z <- environmentLightingContribution.z

#line 384
dp3 r0.w, r0.xyzx, cb1[51].xyzx  // r0.w <- sampleDirection.x
dp3 r1.w, r0.xyzx, cb1[52].xyzx  // r1.w <- sampleDirection.y
dp3 r2.w, r0.xyzx, cb1[53].xyzx  // r2.w <- sampleDirection.z
...
#line 268
mad r4.yzw, cb1[43].xxyz, r1.wwww, cb1[42].xxyz  // r4.y <- color.x; r4.z <- color.y; r4.w <- color.z
mad r4.yzw, cb1[44].xxyz, -r2.wwww, r4.yyzw
mad r4.yzw, cb1[45].xxyz, r0.wwww, r4.yyzw

#line 273
mul r5.xyz, r1.wwww, cb1[46].xyzx
mad r4.yzw, r5.xxyz, r0.wwww, r4.yyzw
mul r5.xyz, r1.wwww, cb1[47].xyzx
mad r4.yzw, r5.xxyz, -r2.wwww, r4.yyzw
mad r1.w, r4.x, l(3.000000), l(-1.000000)
mad r4.xyz, cb1[48].xyzx, r1.wwww, r4.yzwy  // r4.x <- color.x; r4.y <- color.y; r4.z <- color.z
mul r5.xyz, r0.wwww, cb1[49].xyzx
mad r4.xyz, r5.xyzx, -r2.wwww, r4.xyzx
mad r0.w, r0.w, r0.w, -r3.w
mad r4.xyz, cb1[50].xyzx, r0.wwww, r4.xyzx

#line 386
mul r4.xyz, r4.xyzx, cb1[55].xxxx  // r4.x <- streams.envLightDiffuseColor_id41.x; r4.y <- streams.envLightDiffuseColor_id41.y; r4.z <- streams.envLightDiffuseColor_id41.z
...
#line 255
sample_l r0.xyzw, r1.xyzx, t4.xyzw, s0, cb1[50].w  // r0.x <- <Compute_id240 return value>.x; r0.y <- <Compute_id240 return value>.y; r0.z <- <Compute_id240 return value>.z
...
float NormalDistributionGGX_id197(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id177 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionGGX_id197(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id288(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id183(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
...
void PrepareEnvironmentLight_id252(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id235(sampleDirection).rgb * Intensity_id161 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id240(streams, sampleDirection).rgb * Intensity_id161 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeEnvironmentLightContribution_id396(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id198(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
...
{
    streams.matSpecularIntensity_id50 = Compute_id257().r;
}
void Compute_id406(inout PS_STREAMS streams)
{
    streams.matSpecular_id49 = Compute_id255().rgb;
}
void Compute_id401(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id253();
