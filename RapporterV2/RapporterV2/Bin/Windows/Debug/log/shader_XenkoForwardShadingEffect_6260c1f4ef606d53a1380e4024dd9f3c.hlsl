...
@G    Pixel => 7aa73cc5f5686b54dafaac8544244e66
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
#line 318
  mul r7.w, r7.w, r8.w  // r7.w <- attenuation
  mul r13.xyz, r7.wwww, r15.xyzx  // r13.x <- streams.lightColor_id43.x; r13.y <- streams.lightColor_id43.y; r13.z <- streams.lightColor_id43.z
...
#line 293
  bfi r11.w, l(30), l(2), r7.w, r10.x
  ishl r12.w, r10.x, l(2)
  bfi r12.w, l(30), l(4), r7.w, r12.w
  dp4 r13.x, r4.xyzw, cb1[r12.w + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r12.w + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r13.w, r4.xyzw, cb1[r12.w + 30].xyzw  // r13.w <- shadowPosition.z
  dp4 r12.w, r4.xyzw, cb1[r12.w + 31].xyzw  // r12.w <- shadowPosition.w
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r18.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id116 return value>

#line 251
  mul r13.yw, r14.zzzw, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r18.zwzz, t4.xxxx, s1, r13.z  // r15.z <- <SampleTextureAndCompare_id116 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.xyxx, t4.xxxx, s1, r13.z  // r14.z <- <SampleTextureAndCompare_id116 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r19.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id116 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t4.xxxx, s1, r13.z  // r14.z <- <SampleTextureAndCompare_id116 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r17.xyxx, t4.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id116 return value>
...
#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r13.y, r13.ywyy, t4.xxxx, s1, r13.z  // r13.y <- <SampleTextureAndCompare_id116 return value>
...
#line 422
  ...
  add r13.y, -cb1[r13.y + 46].x, cb1[r11.w + 46].x
  movc r13.y, r10.x, r13.y, cb1[r11.w + 46].x  // r13.y <- splitSize
  add r11.w, -r5.w, cb1[r11.w + 46].x
  div r11.w, r11.w, r13.y  // r11.w <- splitDist
  lt r13.y, r11.w, l(0.200000)

#line 293
  ishl r9.w, r9.w, l(2)
  imad r9.w, r10.x, l(4), r9.w
  iadd r9.w, r9.w, l(4)
  dp4 r14.x, r4.xyzw, cb1[r9.w + 28].xyzw  // r14.x <- shadowPosition.x
  dp4 r14.y, r4.xyzw, cb1[r9.w + 29].xyzw  // r14.y <- shadowPosition.y
  dp4 r10.x, r4.xyzw, cb1[r9.w + 30].xyzw  // r10.x <- shadowPosition.z
  dp4 r4.x, r4.xyzw, cb1[r9.w + 31].xyzw  // r4.x <- shadowPosition.w
  add r14.z, r10.x, -cb1[44].x  // r14.z <- shadowPosition.z
...
#line 229
  ...
  mul r13.zw, r13.zzzw, cb1[27].zzzw
...
#line 242
  ...
  mad r17.xyzw, r16.xwzw, cb1[27].zwzw, r13.zwzw

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id116 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id116 return value>

#line 253
  mov r15.zw, r16.wwwy
  mad r17.xyzw, r15.xzxw, cb1[27].zwzw, r13.zwzw

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r17.xyxx, t4.xxxx, s1, r4.z  // r9.w <- <SampleTextureAndCompare_id116 return value>

#line 252
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.zwzw

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r10.x, r18.xyxx, t4.xxxx, s1, r4.z  // r10.x <- <SampleTextureAndCompare_id116 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r18.zwzz, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id116 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r17.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id116 return value>

#line 254
  mov r16.y, r15.y
  mad r16.xyzw, r16.xyzy, cb1[27].zwzw, r13.zwzw

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r16.x, r16.xyxx, t4.xxxx, s1, r4.z  // r16.x <- <SampleTextureAndCompare_id116 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r16.y, r16.zwzz, t4.xxxx, s1, r4.z  // r16.y <- <SampleTextureAndCompare_id116 return value>

#line 256
  mad r13.zw, r15.xxxy, cb1[27].zzzw, r13.zzzw

#line 209
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.zwzz, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id116 return value>
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id297 return value>.x; r0.y <- <Compute_id297 return value>.y; r0.z <- <Compute_id297 return value>.z
