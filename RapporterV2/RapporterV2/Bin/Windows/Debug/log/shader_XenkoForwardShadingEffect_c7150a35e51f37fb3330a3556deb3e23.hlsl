...
//
#line 831 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_c7150a35e51f37fb3330a3556deb3e23.hlsl"
...
@G    Pixel => 05a0147837324a496a3903f6444a29ee
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 860 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_c7150a35e51f37fb3330a3556deb3e23.hlsl"
...
#line 599
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id225 return value>
...
#line 270
  ...
  mul r5.x, r5.x, r5.x
  mul r3.w, r3.w, r5.x
  mad r13.xyz, r13.xyzx, r3.wwww, r8.yzwy  // r13.x <- <FresnelSchlick_id173 return value>.x; r13.y <- <FresnelSchlick_id173 return value>.y; r13.z <- <FresnelSchlick_id173 return value>.z

#line 266
  mad r3.w, r3.z, l(0.500000), l(0.500000)
  div r3.w, r3.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id191 return value>
  mad r5.x, r9.z, l(0.500000), l(0.500000)
  div r5.x, r9.z, r5.x  // r5.x <- <VisibilityhSchlickGGX_id191 return value>

#line 317
  mul r3.w, r3.w, r5.x
  mul r3.z, r9.z, r3.z
  div r3.z, r3.w, r3.z  // r3.z <- <VisibilitySmithSchlickGGX_id193 return value>
...
#line 560
ushr r1.w, r3.y, l(16)  // r1.w <- <GetMaxLightCount_id234 return value>
...
#line 306
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r11.xyz, r5.wwww, r13.xyzx  // r11.x <- streams.lightColor_id39.x; r11.y <- streams.lightColor_id39.y; r11.z <- streams.lightColor_id39.z

#line 550
  dp3 r5.w, r4.xyzx, r9.yzwy
...
#line 270
  ...
  mul r7.w, r7.w, r7.w
  mul r6.w, r6.w, r7.w
  mad r12.xyz, r12.xyzx, r6.wwww, r7.xyzx  // r12.x <- <FresnelSchlick_id173 return value>.x; r12.y <- <FresnelSchlick_id173 return value>.y; r12.z <- <FresnelSchlick_id173 return value>.z

#line 266
  mad r6.w, r5.w, l(0.500000), l(0.500000)
  div r6.w, r5.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id191 return value>
  mad r7.w, r2.w, l(0.500000), l(0.500000)
  div r7.w, r2.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id191 return value>

#line 317
  mul r6.w, r6.w, r7.w
  mul r5.w, r2.w, r5.w
  div r5.w, r6.w, r5.w  // r5.w <- <VisibilitySmithSchlickGGX_id193 return value>
...
#line 398
  ...
  lt r9.w, cb1[r11.x + 46].x, r4.w

#line 401
  movc r8.w, r9.w, l(2), r8.w

#line 398
  lt r9.w, cb1[r11.y + 46].x, r4.w
...
#line 281
  ...
  dp4 r11.x, r3.xyzw, cb1[r11.x + 31].xyzw  // r11.x <- shadowPosition.w
...
#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r11.y, r16.xyxx, t4.xxxx, s1, r11.z  // r11.y <- <SampleTextureAndCompare_id102 return value>

#line 239
  mul r13.zw, r12.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r16.zwzz, t4.xxxx, s1, r11.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r11.y, r17.xyxx, t4.xxxx, s1, r11.z  // r11.y <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r11.z, r12.xyxx, t4.xxxx, s1, r11.z  // r11.z <- <SampleTextureAndCompare_id102 return value>
...
#line 410
  ...
  add r11.z, -cb1[r11.z + 46].x, cb1[r10.w + 46].x
  movc r11.z, r8.w, r11.z, cb1[r10.w + 46].x  // r11.z <- splitSize
  add r10.w, -r4.w, cb1[r10.w + 46].x
...
#line 281
  ...
  iadd r7.w, r7.w, l(4)
  dp4 r12.x, r3.xyzw, cb1[r7.w + 28].xyzw  // r12.x <- shadowPosition.x
  dp4 r12.y, r3.xyzw, cb1[r7.w + 29].xyzw  // r12.y <- shadowPosition.y
  dp4 r8.w, r3.xyzw, cb1[r7.w + 30].xyzw  // r8.w <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb1[r7.w + 31].xyzw  // r3.x <- shadowPosition.w
  add r12.z, r8.w, -cb1[44].x  // r12.z <- shadowPosition.z
...
#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r3.x, r16.xyxx, t4.xxxx, s1, r3.z  // r3.x <- <SampleTextureAndCompare_id102 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r3.y, r16.zwzz, t4.xxxx, s1, r3.z  // r3.y <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t4.xxxx, s1, r3.z  // r8.w <- <SampleTextureAndCompare_id102 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r17.zwzz, t4.xxxx, s1, r3.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r15.xyxx, t4.xxxx, s1, r3.z  // r13.w <- <SampleTextureAndCompare_id102 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r15.zwzz, t4.xxxx, s1, r3.z  // r14.z <- <SampleTextureAndCompare_id102 return value>

#line 244
  mad r12.xy, r14.xyxx, cb1[27].zwzz, r12.xyxx

#line 197
  sample_c_indexable(texture2d)(float,float,float,float) r3.z, r12.xyxx, t4.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id102 return value>
...
#line 270
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r12.xyz, r12.xyzx, r7.wwww, r9.xyzx  // r12.x <- <FresnelSchlick_id173 return value>.x; r12.y <- <FresnelSchlick_id173 return value>.y; r12.z <- <FresnelSchlick_id173 return value>.z

#line 266
  mad r7.w, r6.w, l(0.500000), l(0.500000)
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id191 return value>
  mad r8.w, r2.w, l(0.500000), l(0.500000)
  div r8.w, r2.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id191 return value>

#line 317
  mul r7.w, r7.w, r8.w
  mul r6.w, r2.w, r6.w
  div r6.w, r7.w, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id193 return value>
...
#line 386
mul r2.xyz, r0.wwww, r2.xyzx  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id208 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id208 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id208 return value>.z
...
#line 338
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, cb1[59].w  // r0.x <- <Compute_id252 return value>.x; r0.y <- <Compute_id252 return value>.y; r0.z <- <Compute_id252 return value>.z
...
float NormalDistributionGGX_id207(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id193 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    return NormalDistributionGGX_id207(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id300(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id193(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
...
void PrepareEnvironmentLight_id264(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id247(sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id252(streams, sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeEnvironmentLightContribution_id408(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id208(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
