...
@G    Pixel => 05f24de84f5507b7e76b6626b06cda21
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
#line 441
  ld r11.xyzw, r3.wwww, t1.xyzw  // r11.x <- realLightIndex
  iadd r3.w, r3.w, l(1)  // r3.w <- streams.lightIndex_id84
  ishl r5.w, r11.x, l(2)
  ld r11.xyzw, r5.wwww, t3.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z

#line 447
  iadd r9.yzw, r5.wwww, l(0, 1, 2, 3)
...
#line 297
  add r9.yzw, -r3.xxyz, r11.xxyz  // r9.y <- lightVector.x; r9.z <- lightVector.y; r9.w <- lightVector.z
...
#line 201
  mul r5.w, r13.z, r5.w  // r5.w <- factor
...
#line 197
  sample_c r11.y, r16.xyxx, t4.xxxx, s1, r11.z  // r11.y <- <SampleTextureAndCompare_id102 return value>

#line 239
  mul r13.zw, r12.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 197
  sample_c r11.w, r16.zwzz, t4.xxxx, s1, r11.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r12.z, r16.xyxx, t4.xxxx, s1, r11.z  // r12.z <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r11.y, r17.xyxx, t4.xxxx, s1, r11.z  // r11.y <- <SampleTextureAndCompare_id102 return value>

#line 239
  mad r11.x, r13.w, r11.y, r11.x

#line 197
  sample_c r11.y, r17.zwzz, t4.xxxx, s1, r11.z
...
#line 197
  sample_c r11.y, r16.zwzz, t4.xxxx, s1, r11.z
...
#line 197
  sample_c r11.y, r15.xyxx, t4.xxxx, s1, r11.z

#line 242
  mad r11.x, r11.w, r11.y, r11.x

#line 197
  sample_c r11.y, r15.zwzz, t4.xxxx, s1, r11.z
...
#line 197
  sample_c r11.z, r12.xyxx, t4.xxxx, s1, r11.z  // r11.z <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r3.x, r15.xyxx, t4.xxxx, s1, r3.z  // r3.x <- <SampleTextureAndCompare_id102 return value>
  sample_c r3.y, r15.zwzz, t4.xxxx, s1, r3.z  // r3.y <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r10.w, r15.xyxx, t4.xxxx, s1, r3.z  // r10.w <- <SampleTextureAndCompare_id102 return value>

#line 240
  mad r16.xyzw, r14.xyzy, cb1[27].zwzw, r11.zwzw

#line 197
  sample_c r13.z, r16.xyxx, t4.xxxx, s1, r3.z  // r13.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r13.w, r16.zwzz, t4.xxxx, s1, r3.z  // r13.w <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.w, r15.zwzz, t4.xxxx, s1, r3.z  // r14.w <- <SampleTextureAndCompare_id102 return value>
...
#line 197
  sample_c r14.x, r15.xyxx, t4.xxxx, s1, r3.z  // r14.x <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.y, r15.zwzz, t4.xxxx, s1, r3.z  // r14.y <- <SampleTextureAndCompare_id102 return value>

#line 244
  mad r11.zw, r13.xxxy, cb1[27].zzzw, r11.zzzw

#line 197
  sample_c r3.z, r11.zwzz, t4.xxxx, s1, r3.z  // r3.z <- <SampleTextureAndCompare_id102 return value>
...
#line 338
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, cb1[59].w  // r0.x <- <Compute_id252 return value>.x; r0.y <- <Compute_id252 return value>.y; r0.z <- <Compute_id252 return value>.z
