...
//
#line 767 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_046aa5bc0b4c0c0ad8b7e024ad35e248.hlsl"
...
@G    Pixel => 7ab6cb5eb23f7b31565f6fc64fd7c89f
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 796 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_046aa5bc0b4c0c0ad8b7e024ad35e248.hlsl"
...
#line 547
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id207 return value>
...
#line 431
  ld r11.xyzw, r9.xxxx, t1.xyzw  // r11.x <- realLightIndex
  iadd r9.x, r9.x, l(1)  // r9.x <- streams.lightIndex_id84
  ishl r3.z, r11.x, l(1)
  ld r11.xyzw, r3.zzzz, t2.xyzw  // r11.x <- pointLight1.x; r11.y <- pointLight1.y; r11.z <- pointLight1.z; r11.w <- pointLight1.w
  iadd r3.z, r3.z, l(1)
  ld r12.xyzw, r3.zzzz, t2.xyzw  // r12.x <- pointLight2.x; r12.y <- pointLight2.y; r12.z <- pointLight2.z
...
#line 260
  ...
  mul r5.x, r5.x, r5.x
  mul r3.w, r3.w, r5.x
  mad r13.xyz, r13.xyzx, r3.wwww, r8.yzwy  // r13.x <- <FresnelSchlick_id155 return value>.x; r13.y <- <FresnelSchlick_id155 return value>.y; r13.z <- <FresnelSchlick_id155 return value>.z

#line 256
  mad r3.w, r3.z, l(0.500000), l(0.500000)
  div r3.w, r3.z, r3.w  // r3.w <- <VisibilityhSchlickGGX_id173 return value>
  mad r5.x, r9.z, l(0.500000), l(0.500000)
  div r5.x, r9.z, r5.x  // r5.x <- <VisibilityhSchlickGGX_id173 return value>

#line 307
  mul r3.w, r3.w, r5.x
  mul r3.z, r9.z, r3.z
  div r3.z, r3.w, r3.z  // r3.z <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 508
ushr r1.w, r3.y, l(16)  // r1.w <- <GetMaxLightCount_id216 return value>
...
mov r5.w, r9.x  // r5.w <- streams.lightIndex_id84
mov r6.w, l(0)  // r6.w <- i
loop 
  ige r7.w, r6.w, r1.w
  breakc_nz r7.w
...
#line 400
  ld r11.xyzw, r5.wwww, t1.xyzw  // r11.x <- realLightIndex
  iadd r5.w, r5.w, l(1)  // r5.w <- streams.lightIndex_id84
  ishl r7.w, r11.x, l(2)
  ld r11.xyzw, r7.wwww, t3.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z

#line 406
  iadd r9.yzw, r7.wwww, l(0, 1, 2, 3)
  ld r12.xyzw, r9.yyyy, t3.xyzw  // r12.x <- spotLight2.x; r12.y <- spotLight2.y; r12.z <- spotLight2.z
  ld r13.xyzw, r9.zzzz, t3.xyzw  // r13.x <- spotLight3.x; r13.y <- spotLight3.y; r13.z <- spotLight3.z
  ld r14.xyzw, r9.wwww, t3.xyzw  // r14.x <- spotLight4.x; r14.y <- spotLight4.y; r14.z <- spotLight4.z

#line 287
  mov r4.x, r3.w
  add r9.yzw, -r4.xxyz, r11.xxyz  // r9.y <- lightVector.x; r9.z <- lightVector.y; r9.w <- lightVector.z
  dp3 r4.x, r9.yzwy, r9.yzwy
  sqrt r7.w, r4.x  // r7.w <- lightVectorLength
  div r9.yzw, r9.yyzw, r7.wwww  // r9.y <- lightVectorNorm.x; r9.z <- lightVectorNorm.y; r9.w <- lightVectorNorm.z
...
#line 241
  dp3 r7.w, -r12.xyzx, r9.yzwy  // r7.w <- cd
  mad_sat r7.w, r7.w, r13.x, r13.y  // r7.w <- attenuation
  mul r7.w, r7.w, r7.w

#line 296
  mul r4.x, r4.x, r7.w  // r4.x <- attenuation
  mul r11.xyz, r4.xxxx, r14.xyzx  // r11.x <- streams.lightColor_id39.x; r11.y <- streams.lightColor_id39.y; r11.z <- streams.lightColor_id39.z

#line 498
  dp3 r4.x, r3.xyzx, r9.yzwy
...
#line 529
  ...
  dp3 r5.x, r9.yzwy, r12.xyzx
  max r5.x, r5.x, l(0.000100)  // r5.x <- streams.LdotH_id70

#line 525
  mul r9.yzw, r6.xxyz, r11.xxyz

#line 639
  mad r9.yzw, r9.yyzw, l(0.000000, 0.318310, 0.318310, 0.318310), r8.xxyz  // r9.y <- directLightingContribution.x; r9.z <- directLightingContribution.y; r9.w <- directLightingContribution.z
...
#line 260
  ...
  mul r7.w, r7.w, r7.w
  mul r5.x, r5.x, r7.w
  mad r12.xyz, r12.xyzx, r5.xxxx, r7.xyzx  // r12.x <- <FresnelSchlick_id155 return value>.x; r12.y <- <FresnelSchlick_id155 return value>.y; r12.z <- <FresnelSchlick_id155 return value>.z

#line 256
  mad r5.x, r4.x, l(0.500000), l(0.500000)
  div r5.x, r4.x, r5.x  // r5.x <- <VisibilityhSchlickGGX_id173 return value>
  mad r7.w, r2.w, l(0.500000), l(0.500000)
  div r7.w, r2.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id173 return value>

#line 307
  mul r5.x, r5.x, r7.w
  mul r4.x, r2.w, r4.x
  div r4.x, r5.x, r4.x  // r4.x <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 643
  mad r8.xyz, r11.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000), r9.yzwy  // r8.x <- directLightingContribution.x; r8.y <- directLightingContribution.y; r8.z <- directLightingContribution.z
...
#line 357
  lt r9.w, cb1[r8.w + 46].x, r5.z

#line 360
  and r9.w, r9.w, l(1)  // r9.w <- cascadeIndex

#line 357
  iadd r11.xy, r8.wwww, l(1, 2, 0, 0)
  lt r10.w, cb1[r11.x + 46].x, r5.z

#line 360
  movc r9.w, r10.w, l(2), r9.w

#line 357
  lt r10.w, cb1[r11.y + 46].x, r5.z
...
#line 278
  ...
  max r11.x, r11.x, l(0.000000)  // r11.x <- normalOffsetScale
  mul r11.x, r1.w, r11.x

#line 364
  mov r12.x, r4.w
  mov r12.yz, r5.xxyx
  mad r3.xyz, r11.xxxx, r4.xyzx, r12.xyzx  // r3.x <- shadowPosition.x; r3.y <- shadowPosition.y; r3.z <- shadowPosition.z

#line 271
  iadd r8.w, r8.w, r9.w
  ishl r11.x, r8.w, l(2)
  dp4 r12.x, r3.xyzw, cb1[r11.x + 28].xyzw  // r12.x <- shadowPosition.x
  dp4 r12.y, r3.xyzw, cb1[r11.x + 29].xyzw  // r12.y <- shadowPosition.y
  dp4 r11.y, r3.xyzw, cb1[r11.x + 30].xyzw  // r11.y <- shadowPosition.z
  dp4 r11.z, r3.xyzw, cb1[r11.x + 31].xyzw  // r11.z <- shadowPosition.w
  add r12.z, r11.y, -cb1[44].x  // r12.z <- shadowPosition.z
  div r11.yzw, r12.xxyz, r11.zzzz  // r11.y <- shadowPosition.x; r11.z <- shadowPosition.y; r11.w <- shadowPosition.z

#line 207
  mad r11.yz, r11.yyzy, cb1[27].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
  round_ni r12.xy, r11.yzyy  // r12.x <- base_uv.x; r12.y <- base_uv.y
  add r11.yz, r11.yyzy, -r12.xxyx  // r11.y <- s; r11.z <- t
  add r12.xy, r12.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  mul r12.xy, r12.xyxx, cb1[27].zwzz

#line 220
  mad r12.zw, -r11.zzzy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r12.w <- uw0; r12.z <- vw0
  mad r13.xy, r11.yzyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r13.x <- uw2; r13.y <- vw2
  mad r13.zw, -r11.yyyz, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r13.zw, r13.zzzw, r12.wwwz
  add r14.xy, r11.yzyy, l(3.000000, 3.000000, 0.000000, 0.000000)
  div r11.yz, r11.yyzy, r13.xxyx
  ...
  add r14.xy, r11.yzyy, l(2.000000, 2.000000, 0.000000, 0.000000)  // r14.x <- u2; r14.y <- v2
  mul r11.y, r12.z, r12.w
  mad r16.xyzw, r15.xwzw, cb1[27].zwzw, r12.xyxy

#line 187
  sample_c r11.z, r16.xyxx, t4.xxxx, s0, r11.w  // r11.z <- <SampleTextureAndCompare_id96 return value>

#line 229
  mul r13.zw, r12.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 187
  sample_c r16.x, r16.zwzz, t4.xxxx, s0, r11.w  // r16.x <- <SampleTextureAndCompare_id96 return value>

#line 227
  mul r13.z, r13.z, r16.x
  mad r11.y, r11.y, r11.z, r13.z  // r11.y <- shadow

#line 232
  mul r12.zw, r12.zzzw, r13.xxxy
  mov r14.zw, r15.wwwy
...
#line 228
  mad r11.y, r12.z, r11.z, r11.y
  mad r17.xyzw, r15.xyzy, cb1[27].zwzw, r12.xyxy

#line 187
  sample_c r11.z, r17.xyxx, t4.xxxx, s0, r11.w

#line 229
  mad r11.y, r13.w, r11.z, r11.y

#line 187
  sample_c r11.z, r17.zwzz, t4.xxxx, s0, r11.w

#line 230
  mad r11.y, r11.z, l(49.000000), r11.y

#line 233
  mul r13.zw, r13.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 187
  sample_c r11.z, r16.zwzz, t4.xxxx, s0, r11.w

#line 231
  mad r11.y, r13.z, r11.z, r11.y
  mov r15.y, r14.y
  mad r15.xyzw, r15.xyzy, cb1[27].zwzw, r12.xyxy

#line 187
  sample_c r11.z, r15.xyxx, t4.xxxx, s0, r11.w

#line 232
  mad r11.y, r12.w, r11.z, r11.y

#line 187
  sample_c r11.z, r15.zwzz, t4.xxxx, s0, r11.w
...
#line 187
  sample_c r11.w, r12.xyxx, t4.xxxx, s0, r11.w  // r11.w <- <SampleTextureAndCompare_id96 return value>

#line 234
  mad r11.y, r11.z, r11.w, r11.y
  mul r11.z, r11.y, l(0.006944)  // r11.z <- shadow

#line 369
  iadd r11.w, r8.w, l(-1)
  add r11.w, -cb1[r11.w + 46].x, cb1[r8.w + 46].x
  movc r9.w, r9.w, r11.w, cb1[r8.w + 46].x  // r9.w <- splitSize
  add r8.w, -r5.z, cb1[r8.w + 46].x
  div r8.w, r8.w, r9.w  // r8.w <- splitDist
  lt r9.w, r8.w, l(0.200000)

#line 271
  iadd r11.x, r11.x, l(4)
  dp4 r12.x, r3.xyzw, cb1[r11.x + 28].xyzw  // r12.x <- shadowPosition.x
  dp4 r12.y, r3.xyzw, cb1[r11.x + 29].xyzw  // r12.y <- shadowPosition.y
  dp4 r11.w, r3.xyzw, cb1[r11.x + 30].xyzw  // r11.w <- shadowPosition.z
  dp4 r3.x, r3.xyzw, cb1[r11.x + 31].xyzw  // r3.x <- shadowPosition.w
  add r12.z, r11.w, -cb1[44].x  // r12.z <- shadowPosition.z
...
#line 207
  ...
  round_ni r11.xw, r3.xxxy  // r11.x <- base_uv.x; r11.w <- base_uv.y
  add r3.xy, r3.xyxx, -r11.xwxx  // r3.x <- s; r3.y <- t
  add r11.xw, r11.xxxw, l(-0.500000, 0.000000, 0.000000, -0.500000)
  mul r11.xw, r11.xxxw, cb1[27].zzzw
...
#line 220
  ...
  mad r15.xyzw, r14.xwzw, cb1[27].zwzw, r11.xwxw
...
#line 231
  mov r13.zw, r14.wwwy
  mad r15.xyzw, r13.xzxw, cb1[27].zwzw, r11.xwxw

#line 187
  sample_c r13.z, r15.xyxx, t4.xxxx, s0, r3.z  // r13.z <- <SampleTextureAndCompare_id96 return value>

#line 230
  mad r16.xyzw, r14.xyzy, cb1[27].zwzw, r11.xwxw

#line 187
  sample_c r13.w, r16.xyxx, t4.xxxx, s0, r3.z  // r13.w <- <SampleTextureAndCompare_id96 return value>
  sample_c r14.w, r16.zwzz, t4.xxxx, s0, r3.z  // r14.w <- <SampleTextureAndCompare_id96 return value>
  sample_c r15.x, r15.zwzz, t4.xxxx, s0, r3.z  // r15.x <- <SampleTextureAndCompare_id96 return value>
...
#line 187
  sample_c r14.x, r16.xyxx, t4.xxxx, s0, r3.z  // r14.x <- <SampleTextureAndCompare_id96 return value>
  sample_c r14.y, r16.zwzz, t4.xxxx, s0, r3.z  // r14.y <- <SampleTextureAndCompare_id96 return value>

#line 234
  mad r11.xw, r13.xxxy, cb1[27].zzzw, r11.xxxw

#line 187
  sample_c r3.z, r11.xwxx, t4.xxxx, s0, r3.z  // r3.z <- <SampleTextureAndCompare_id96 return value>
...
#line 232
      mul r11.xw, r12.xxxy, r12.zzzw

#line 228
      mad r3.x, r11.x, r13.z, r3.x
      mul r3.y, r12.y, r13.w
      mad r3.x, r3.y, l(7.000000), r3.x
      mad r3.x, r14.w, l(49.000000), r3.x
      mul r3.y, r12.z, r15.x
      mad r3.x, r3.y, l(7.000000), r3.x
...
#line 380
      mad r3.y, r11.y, l(0.006944), -r3.x
      mad r11.z, r8.w, r3.y, r3.x
    endif 
  endif   // r11.z <- shadow

#line 482
  mul r3.xyz, r11.zzzz, cb1[26].xyzx
  mul r3.xyz, r7.wwww, r3.xyzx  // r3.x <- streams.lightColorNdotL_id40.x; r3.y <- streams.lightColorNdotL_id40.y; r3.z <- streams.lightColorNdotL_id40.z
...
#line 256
  mad r6.x, r7.w, l(0.500000), l(0.500000)
  div r6.x, r7.w, r6.x  // r6.x <- <VisibilityhSchlickGGX_id173 return value>
  mad r8.w, r2.w, l(0.500000), l(0.500000)
  div r8.w, r2.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id173 return value>

#line 307
  mul r6.x, r6.x, r8.w
  mul r7.w, r2.w, r7.w
  div r6.x, r6.x, r7.w  // r6.x <- <VisibilitySmithSchlickGGX_id175 return value>
...
#line 345
mul r0.xyz, r0.xxxx, r2.xyzx  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190 return value>.z
...
float VisibilityhSchlickGGX_id173(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
...
float NormalDistributionGGX_id189(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id185 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
float VisibilitySmithSchlickGGX_id175(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id173(alphaR, nDotL) * VisibilityhSchlickGGX_id173(alphaR, nDotV) / (nDotL * nDotV);
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionGGX_id189(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id269(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id175(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
float3 Compute_id240(inout PS_STREAMS streams, float3 f0)
{
...
float3 ComputeEnvironmentLightContribution_id377(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id190(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
...
int GetLightCount_id224()
{
    return LightCount_id94;
}
int GetMaxLightCount_id225()
{
...
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id240(streams, specularColor);
    float geometricShadowing = Compute_id269(streams);
    float normalDistribution = Compute_id298(streams);
...
void PrepareMaterialForLightingAndShading_id192(inout PS_STREAMS streams)
{
...
void ResetLightStream_id191(inout PS_STREAMS streams)
{
...
void Compute_id407(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id191(streams);
    PrepareMaterialForLightingAndShading_id192(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id225();
        int count = GetLightCount_id224();
...
{
    streams.matSpecularIntensity_id50 = Compute_id238().r;
}
void Compute_id387(inout PS_STREAMS streams)
{
    streams.matSpecular_id49 = Compute_id236().rgb;
}
void Compute_id382(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id234();
