...
//
#line 741 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_bf1f09140b8a14c6c2ba8a91022ac106.hlsl"
...
@G    Pixel => 947e20f859585a20436f58f114ff8ed0
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 770 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_bf1f09140b8a14c6c2ba8a91022ac106.hlsl"
...
#line 333
  ld r8.xyzw, r2.wwww, t1.xyzw  // r8.x <- realLightIndex
  iadd r2.w, r2.w, l(1)  // r2.w <- streams.lightIndex_id84
  ishl r3.w, r8.x, l(2)
  ld r8.xyzw, r3.wwww, t3.xyzw  // r8.x <- spotLight1.x; r8.y <- spotLight1.y; r8.z <- spotLight1.z

#line 339
  iadd r9.xyz, r3.wwww, l(1, 2, 3, 0)
...
#line 187
  ...
  mad_sat r4.w, r4.w, r11.x, r11.y  // r4.w <- attenuation
  mul r4.w, r4.w, r4.w
