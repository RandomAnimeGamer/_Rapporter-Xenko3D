...
//
#line 794 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_84dea59bee69651c61947bbf7c646551.hlsl"
...
@G    Pixel => 205edc60ca95823fceadc674765cbbc9
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 852 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_84dea59bee69651c61947bbf7c646551.hlsl"
...
max r0.z, r0.z, l(0.000100)  // r0.z <- streams.NdotV_id66

#line 608
mov r0.w, r0.z  // r0.w <- streams.NdotV_id66
...
#line 540
  dp3 r3.w, r4.xyzx, -cb1[r2.w + 26].xyzx
  max r3.w, r3.w, l(0.000100)  // r3.w <- streams.NdotL_id44
  mul r9.xyz, r3.wwww, cb1[r2.w + 27].xyzx  // r9.x <- streams.lightColorNdotL_id41.x; r9.y <- streams.lightColorNdotL_id41.y; r9.z <- streams.lightColorNdotL_id41.z

#line 532
  add r10.xyz, r5.xyzx, -cb1[r2.w + 26].xyzx
  dp3 r4.w, r10.xyzx, r10.xyzx
  rsq r4.w, r4.w
  mul r10.xyz, r4.wwww, r10.xyzx  // r10.x <- streams.H_id69.x; r10.y <- streams.H_id69.y; r10.z <- streams.H_id69.z
  dp3 r2.w, -cb1[r2.w + 26].xyzx, r10.xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.LdotH_id71
...
#line 286
  ...
  mul r4.w, r4.w, r4.w
  mul r2.w, r2.w, r4.w
  mad r11.xyz, r11.xyzx, r2.wwww, r7.xyzx  // r11.x <- <FresnelSchlick_id162 return value>.x; r11.y <- <FresnelSchlick_id162 return value>.y; r11.z <- <FresnelSchlick_id162 return value>.z

#line 282
  mad r2.w, r3.w, l(0.500000), l(0.500000)
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilityhSchlickGGX_id180 return value>
  mad r4.w, r0.w, l(0.500000), l(0.500000)
  div r4.w, r0.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id180 return value>
...
#line 510
and r0.x, r4.y, l(0x0000ffff)  // r0.x <- <GetMaxLightCount_id222 return value>
...
mov r0.w, r0.z  // r0.w <- streams.NdotV_id66
mov r0.y, r4.x  // r0.y <- streams.lightIndex_id88
...
#line 394
  ld r12.xyzw, r0.yyyy, t1.xyzw  // r12.x <- realLightIndex
  iadd r0.y, r0.y, l(1)  // r0.y <- streams.lightIndex_id88
  ishl r2.w, r12.x, l(1)
  ld r12.xyzw, r2.wwww, t2.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  iadd r2.w, r2.w, l(1)
  ld r13.xyzw, r2.wwww, t2.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 254
  mul r2.w, r12.w, r2.w  // r2.w <- factor
...
#line 312
  mul r13.xyz, r2.wwww, r13.xyzx  // r13.x <- streams.lightColor_id40.x; r13.y <- streams.lightColor_id40.y; r13.z <- streams.lightColor_id40.z

#line 500
  dp3 r2.w, r5.xyzx, r12.xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.NdotL_id44
  mul r13.xyz, r2.wwww, r13.xyzx  // r13.x <- streams.lightColorNdotL_id41.x; r13.y <- streams.lightColorNdotL_id41.y; r13.z <- streams.lightColorNdotL_id41.z
...
#line 532
  ...
  rsq r3.w, r3.w
  mul r7.xyw, r3.wwww, r7.xyxw  // r7.x <- streams.H_id69.x; r7.y <- streams.H_id69.y; r7.w <- streams.H_id69.z
  dp3 r3.w, r12.xyzx, r7.xywx
  max r3.w, r3.w, l(0.000100)  // r3.w <- streams.LdotH_id71

#line 528
  mul r7.xyw, r9.xyxz, r13.xyxz

#line 642
  mad r7.xyw, r7.xyxw, l(0.318310, 0.318310, 0.000000, 0.318310), r11.xyxz  // r7.x <- directLightingContribution.x; r7.y <- directLightingContribution.y; r7.w <- directLightingContribution.z
...
#line 286
  ...
  mul r4.z, r4.z, r4.z
  mul r3.w, r3.w, r4.z
  mad r12.xyz, r12.xyzx, r3.wwww, r10.xyzx  // r12.x <- <FresnelSchlick_id162 return value>.x; r12.y <- <FresnelSchlick_id162 return value>.y; r12.z <- <FresnelSchlick_id162 return value>.z

#line 282
  mad r3.w, r2.w, l(0.500000), l(0.500000)
  div r3.w, r2.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id180 return value>
  mad r4.z, r0.w, l(0.500000), l(0.500000)
  div r4.z, r0.w, r4.z  // r4.z <- <VisibilityhSchlickGGX_id180 return value>

#line 322
  mul r3.w, r3.w, r4.z
  mul r2.w, r0.w, r2.w
  div r2.w, r3.w, r2.w  // r2.w <- <VisibilitySmithSchlickGGX_id182 return value>
...
#line 646
  mad r11.xyz, r12.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000), r7.xywx  // r11.x <- directLightingContribution.x; r11.y <- directLightingContribution.y; r11.z <- directLightingContribution.z

#line 632
  iadd r1.w, r1.w, l(1)

#line 648
endloop   // r0.y <- streams.lightIndex_id88

#line 492
ushr r0.x, r4.y, l(16)  // r0.x <- <GetMaxLightCount_id231 return value>
...
mov r6.z, r0.y  // r6.z <- streams.lightIndex_id88
...
#line 375
  ...
  ishl r2.w, r10.x, l(2)
  ld r10.xyzw, r2.wwww, t3.xyzw  // r10.x <- spotLight1.x; r10.y <- spotLight1.y; r10.z <- spotLight1.z

#line 381
  iadd r12.xyz, r2.wwww, l(1, 2, 3, 0)
...
#line 248
  mul r2.w, r14.z, r2.w  // r2.w <- factor
  mad r2.w, -r2.w, r2.w, l(1.000000)
  max r2.w, r2.w, l(0.000000)  // r2.w <- smoothFactor
...
#line 260
  dp3 r3.w, -r13.xyzx, r10.xyzx  // r3.w <- cd
  mad_sat r3.w, r3.w, r14.x, r14.y  // r3.w <- attenuation
  mul r3.w, r3.w, r3.w

#line 299
  mul r2.w, r2.w, r3.w  // r2.w <- attenuation
  mul r12.xyz, r2.wwww, r12.xyzx  // r12.x <- streams.lightColor_id40.x; r12.y <- streams.lightColor_id40.y; r12.z <- streams.lightColor_id40.z

#line 482
  dp3 r2.w, r4.xyzx, r10.xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.NdotL_id44
  mul r12.xyz, r2.wwww, r12.xyzx  // r12.x <- streams.lightColorNdotL_id41.x; r12.y <- streams.lightColorNdotL_id41.y; r12.z <- streams.lightColorNdotL_id41.z
...
#line 532
  ...
  rsq r3.w, r3.w
  mul r13.xyz, r3.wwww, r13.xyzx  // r13.x <- streams.H_id69.x; r13.y <- streams.H_id69.y; r13.z <- streams.H_id69.z
...
#line 286
  ...
  mul r6.y, r6.y, r6.y
  mul r3.w, r3.w, r6.y
  mad r13.xyz, r13.xyzx, r3.wwww, r8.xyzx  // r13.x <- <FresnelSchlick_id162 return value>.x; r13.y <- <FresnelSchlick_id162 return value>.y; r13.z <- <FresnelSchlick_id162 return value>.z

#line 282
  mad r3.w, r2.w, l(0.500000), l(0.500000)
  div r3.w, r2.w, r3.w  // r3.w <- <VisibilityhSchlickGGX_id180 return value>
  mad r6.y, r0.w, l(0.500000), l(0.500000)
  div r6.y, r0.w, r6.y  // r6.y <- <VisibilityhSchlickGGX_id180 return value>
...
#line 362
mul r0.xyz, r0.xxxx, r3.xyzx  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id197 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id197 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id197 return value>.z
...
float NormalDistributionGGX_id196(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    return alphaR2 / (PI_id172 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
float4 Compute_id234(float3 direction)
{
    return 0;
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id197(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionGGX_id196(streams.alphaRoughness_id64, streams.NdotH_id70);
}
float Compute_id283(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id182(streams.alphaRoughness_id64, streams.NdotL_id44, streams.NdotV_id66);
}
float3 Compute_id254(inout PS_STREAMS streams, float3 f0)
{
...
void PrepareEnvironmentLight_id244(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id42 = Compute_id233(sampleDirection).rgb * Intensity_id98 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id59.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id43 = Compute_id234(sampleDirection).rgb * Intensity_id98 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id59.y;
}
float3 ComputeEnvironmentLightContribution_id391(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id197(specularColor, streams.alphaRoughness_id64, streams.NdotV_id66) * streams.envLightSpecularColor_id43;
}
...
{
    float3 specularColor = streams.matSpecularVisible_id65;
    float3 fresnel = Compute_id254(streams, specularColor);
    float geometricShadowing = Compute_id283(streams);
    float normalDistribution = Compute_id312(streams);
...
{
    streams.matSpecularIntensity_id51 = Compute_id252().r;
}
void Compute_id401(inout PS_STREAMS streams)
{
    streams.matSpecular_id50 = Compute_id250().rgb;
}
void Compute_id396(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id248();
