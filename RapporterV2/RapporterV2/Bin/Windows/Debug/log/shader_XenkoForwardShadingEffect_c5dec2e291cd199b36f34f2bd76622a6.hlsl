...
//
#line 527 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_c5dec2e291cd199b36f34f2bd76622a6.hlsl"
...
@G    Pixel => b27694055c82415d0c3606ede3a6b130
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 556 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_c5dec2e291cd199b36f34f2bd76622a6.hlsl"
...
sample r1.xyzw, r1.xyxx, t0.xyzw, s0  // r1.x <- <Compute_id137 return value>.x; r1.y <- <Compute_id137 return value>.y; r1.z <- <Compute_id137 return value>.z; r1.w <- <Compute_id137 return value>.w
...
#line 347
and r0.w, r2.y, l(0x0000ffff)  // r0.w <- <GetMaxLightCount_id112 return value>
...
#line 160
  ...
  mul r2.w, r2.w, r2.w  // r2.w <- <SmoothDistanceAttenuation_id55 return value>
...
#line 317
ushr r0.w, r2.y, l(16)  // r0.w <- <GetMaxLightCount_id121 return value>
...
#line 154
  ...
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id63 return value>
...
#line 278
mul r0.xyz, r1.xyzx, cb1[41].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id140 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id140 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id140 return value>.z
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id105 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
float4 Compute_id137(inout PS_STREAMS streams)
{
...
void Compute_id177(inout PS_STREAMS streams)
{
    ...
    streams.shadingColor_id66 += directLightingContribution * PI_id105 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id162(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id137(streams);
