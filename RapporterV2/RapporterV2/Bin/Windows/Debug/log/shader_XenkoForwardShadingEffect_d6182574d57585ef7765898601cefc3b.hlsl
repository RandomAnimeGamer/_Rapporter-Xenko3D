...
//
#line 623 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d6182574d57585ef7765898601cefc3b.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
@G    Pixel => c1abcf382b38ad4c1f0d4fcdb7e00785
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 693 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d6182574d57585ef7765898601cefc3b.hlsl"
...
#line 430
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id199 return value>
...
#line 174
  ...
  mul r3.z, r3.z, r3.z  // r3.z <- <SmoothDistanceAttenuation_id75 return value>
...
#line 194
  ...
  mul r3.w, r3.w, r3.w
  mul r3.z, r3.w, r3.z
  mad r10.xyz, r10.xyzx, r3.zzzz, r8.xyzx  // r10.x <- <FresnelSchlick_id149 return value>.x; r10.y <- <FresnelSchlick_id149 return value>.y; r10.z <- <FresnelSchlick_id149 return value>.z
...
#line 280
  ld r10.xyzw, r4.wwww, t1.xyzw  // r10.x <- realLightIndex
  iadd r4.w, r4.w, l(1)  // r4.w <- streams.lightIndex_id88
  ishl r5.w, r10.x, l(2)
  ld r10.xyzw, r5.wwww, t3.xyzw  // r10.x <- spotLight1.x; r10.y <- spotLight1.y; r10.z <- spotLight1.z

#line 286
  iadd r11.xyz, r5.wwww, l(1, 2, 3, 0)
...
#line 214
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r11.xyz, r5.wwww, r11.xyzx  // r11.x <- streams.lightColor_id43.x; r11.y <- streams.lightColor_id43.y; r11.z <- streams.lightColor_id43.z

#line 381
  dp3 r5.w, r3.xyzx, r10.xyzx
  max r5.w, r5.w, l(0.000100)  // r5.w <- streams.NdotL_id47
  mul r11.xyz, r5.wwww, r11.xyzx  // r11.x <- streams.lightColorNdotL_id44.x; r11.y <- streams.lightColorNdotL_id44.y; r11.z <- streams.lightColorNdotL_id44.z
...
#line 194
  ...
  mul r5.w, r5.w, r5.w
  mul r5.x, r5.w, r5.x
  mad r12.xyz, r12.xyzx, r5.xxxx, r7.xyzx  // r12.x <- <FresnelSchlick_id149 return value>.x; r12.y <- <FresnelSchlick_id149 return value>.y; r12.z <- <FresnelSchlick_id149 return value>.z
...
mov r3.xyz, r0.xyzx
mov r3.w, r1.x
mov r4.yz, r1.yyzy  // r4.y <- streams.viewWS_id65.y; r4.z <- streams.viewWS_id65.z
mov r5.xyz, cb0[0].xyzx  // r5.x <- streams.matDiffuseVisible_id66.x; r5.y <- streams.matDiffuseVisible_id66.y; r5.z <- streams.matDiffuseVisible_id66.z
mov r6.xyz, r2.xyzx  // r6.x <- streams.matSpecularVisible_id68.x; r6.y <- streams.matSpecularVisible_id68.y; r6.z <- streams.matSpecularVisible_id68.z
...
#line 363
  ...
  mul r9.xyz, r4.wwww, cb1[r2.w + 26].xyzx  // r9.x <- streams.lightColorNdotL_id44.x; r9.y <- streams.lightColorNdotL_id44.y; r9.z <- streams.lightColorNdotL_id44.z
...
#line 412
  ...
  rsq r4.x, r4.x
  mul r10.xyz, r4.xxxx, r10.xyzx  // r10.x <- streams.H_id72.x; r10.y <- streams.H_id72.y; r10.z <- streams.H_id72.z
  dp3 r2.w, -cb1[r2.w + 25].xyzx, r10.xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.LdotH_id74
...
#line 194
  ...
  mul r4.x, r4.x, r4.x
  mul r2.w, r2.w, r4.x
  mad r11.xyz, r11.xyzx, r2.wwww, r6.xyzx  // r11.x <- <FresnelSchlick_id149 return value>.x; r11.y <- <FresnelSchlick_id149 return value>.y; r11.z <- <FresnelSchlick_id149 return value>.z
...
mul r0.y, r0.z, r0.y
mad r0.xyz, r2.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id182 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id182 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id182 return value>.z

#line 347
mul r0.xyz, r0.xyzx, cb1[41].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id369 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id369 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id369 return value>.z
...
float NormalDistributionBlinnPhong_id181(float alphaR, float nDotH)
{
    float alphaR2 = max(alphaR * alphaR, 0.1);
    return pow(nDotH, 2 / alphaR2 - 2) / (PI_id173 * alphaR2);
}
float VisibilityImplicit_id168(float nDotL, float nDotV)
{
    return 1.0f;
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id182(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionBlinnPhong_id181(streams.alphaRoughness_id67, streams.NdotH_id73);
}
float Compute_id259(inout PS_STREAMS streams)
{
    return VisibilityImplicit_id168(streams.NdotL_id47, streams.NdotV_id69);
}
float3 Compute_id230(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id155(f0, streams.LdotH_id74);
}
...
float3 ComputeEnvironmentLightContribution_id369(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id68;
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id182(specularColor, streams.alphaRoughness_id67, streams.NdotV_id69) * streams.envLightSpecularColor_id46;
}
...
void PrepareDirectLight_id215(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id216()
{
    return LightCount_id98;
}
int GetMaxLightCount_id217()
{
    return TMaxLightCount_id99;
}
void PrepareDirectLights_id213()
{
}
...
float3 ComputeDirectLightContribution_id368(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id68;
    float3 fresnel = Compute_id230(streams, specularColor);
    float geometricShadowing = Compute_id259(streams);
    float normalDistribution = Compute_id289(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id66;
    return diffuseColor / PI_id173 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id62.x;
}
...
void PrepareDirectLight_id196(inout PS_STREAMS streams, int lightIndex)
{
...
int GetLightCount_id200(inout PS_STREAMS streams)
{
    return streams.lightData_id87.y & 0xFFFF;
}
int GetMaxLightCount_id199(inout PS_STREAMS streams)
{
    return streams.lightData_id87.y & 0xFFFF;
}
void PrepareDirectLights_id198(inout PS_STREAMS streams)
{
...
void PrepareMaterialForLightingAndShading_id184(inout PS_STREAMS streams)
{
    ...
    float roughnessAdjust = GetFilterSquareRoughnessAdjustment_id121(streams, streams.matNormal_id49);
...
void Compute_id399(inout PS_STREAMS streams)
{
    ...
    {
        PrepareDirectLights_id198(streams);
        const int maxLightCount = GetMaxLightCount_id199(streams);
        int count = GetLightCount_id200(streams);
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id196(streams, i);
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id368(streams);
            }
        }
    }
    ...
    {
        PrepareDirectLights_id213();
        const int maxLightCount = GetMaxLightCount_id217();
        int count = GetLightCount_id216();
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            PrepareDirectLight_id215(streams, i);
            PrepareMaterialPerDirectLight_id31(streams);
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id369(streams);
        }
    }
    streams.shadingColor_id70 += directLightingContribution * PI_id173 + environmentLightingContribution;
    streams.shadingColorAlpha_id71 = streams.matDiffuse_id51.a;
}
void Compute_id384(inout PS_STREAMS streams)
{
    streams.matSpecularIntensity_id54 = Compute_id228().r;
}
void Compute_id379(inout PS_STREAMS streams)
{
    streams.matSpecular_id53 = Compute_id226().rgb;
}
void Compute_id374(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id224();
