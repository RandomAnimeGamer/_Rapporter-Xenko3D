...
//
#line 705 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_087c6bfe50b5cc14407470f68598a1d3.hlsl"
...
//
#line 734 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_087c6bfe50b5cc14407470f68598a1d3.hlsl"
...
#line 473
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id213 return value>
...
#line 178
  ...
  mul r3.z, r3.z, r3.z  // r3.z <- <SmoothDistanceAttenuation_id77 return value>
...
#line 198
  ...
  mul r3.w, r3.w, r3.w
  mul r3.z, r3.w, r3.z
  mad r10.xyz, r10.xyzx, r3.zzzz, r8.xyzx  // r10.x <- <FresnelSchlick_id163 return value>.x; r10.y <- <FresnelSchlick_id163 return value>.y; r10.z <- <FresnelSchlick_id163 return value>.z
...
#line 434
ushr r1.w, r3.y, l(16)  // r1.w <- <GetMaxLightCount_id222 return value>
...
#line 218
  mul r4.w, r4.w, r5.w  // r4.w <- attenuation
  mul r11.xyz, r4.wwww, r11.xyzx  // r11.x <- streams.lightColor_id39.x; r11.y <- streams.lightColor_id39.y; r11.z <- streams.lightColor_id39.z
...
#line 406
  ...
  mul r9.xyz, r3.wwww, cb1[r2.w + 26].xyzx  // r9.x <- streams.lightColorNdotL_id40.x; r9.y <- streams.lightColorNdotL_id40.y; r9.z <- streams.lightColorNdotL_id40.z

#line 455
  add r10.xyz, r4.xyzx, -cb1[r2.w + 25].xyzx
  dp3 r3.w, r10.xyzx, r10.xyzx
  rsq r3.w, r3.w
  mul r10.xyz, r3.wwww, r10.xyzx  // r10.x <- streams.H_id68.x; r10.y <- streams.H_id68.y; r10.z <- streams.H_id68.z
...
#line 198
  ...
  mul r3.w, r3.w, r3.w
  mul r2.w, r2.w, r3.w
  mad r11.xyz, r11.xyzx, r2.wwww, r6.xyzx  // r11.x <- <FresnelSchlick_id163 return value>.x; r11.y <- <FresnelSchlick_id163 return value>.y; r11.z <- <FresnelSchlick_id163 return value>.z
...
mul r0.w, r0.w, r2.w
mad r2.xyz, r2.xyzx, r1.wwww, r0.wwww  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id196 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id196 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id196 return value>.z
...
#line 250
sample_l r0.xyzw, r1.xyzx, t4.xyzw, s0, cb1[50].w  // r0.x <- <Compute_id238 return value>.x; r0.y <- <Compute_id238 return value>.y; r0.z <- <Compute_id238 return value>.z
...
float NormalDistributionBlinnPhong_id195(float alphaR, float nDotH)
{
    ...
    return pow(nDotH, 2 / alphaR2 - 2) / (PI_id177 * alphaR2);
}
...
{
    float4 colorBase = Compute_id251();
