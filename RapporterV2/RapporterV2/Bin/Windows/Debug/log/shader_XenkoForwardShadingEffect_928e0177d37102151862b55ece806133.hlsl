...
//
#line 817 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_928e0177d37102151862b55ece806133.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
@G    Pixel => 9f8d8d20adb12604bf35ac73dc274554
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 887 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_928e0177d37102151862b55ece806133.hlsl"
...
#line 313
  mul r5.w, r5.w, r6.w  // r5.w <- attenuation
  mul r13.xyz, r5.wwww, r15.xyzx  // r13.x <- streams.lightColor_id43.x; r13.y <- streams.lightColor_id43.y; r13.z <- streams.lightColor_id43.z
...
#line 591
  ...
  rsq r6.w, r6.w
  mul r14.xyz, r6.wwww, r14.xyzx  // r14.x <- streams.H_id72.x; r14.y <- streams.H_id72.y; r14.z <- streams.H_id72.z
...
#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r17.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id106 return value>

#line 246
  mul r17.xy, r14.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r17.zwzz, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id106 return value>
...
#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r18.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id106 return value>
...
#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r13.xyxx, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id106 return value>
...
#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id106 return value>
...
#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r17.xyxx, t4.xxxx, s1, r4.z  // r7.w <- <SampleTextureAndCompare_id106 return value>

#line 247
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r18.xyxx, t4.xxxx, s1, r4.z  // r8.w <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r17.zwzz, t4.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id106 return value>
...
#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r16.xyxx, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id106 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r16.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id106 return value>

#line 251
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 204
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.xyxx, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id106 return value>
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id252 return value>.x; r0.y <- <Compute_id252 return value>.y; r0.z <- <Compute_id252 return value>.z
