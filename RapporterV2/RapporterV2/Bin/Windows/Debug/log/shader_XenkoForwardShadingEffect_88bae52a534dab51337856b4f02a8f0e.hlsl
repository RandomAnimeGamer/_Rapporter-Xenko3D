...
//
#line 582 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_88bae52a534dab51337856b4f02a8f0e.hlsl"
...
//
#line 611 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_88bae52a534dab51337856b4f02a8f0e.hlsl"
...
#line 386
and r1.w, r3.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id189 return value>
...
#line 180
  ...
  mul r3.w, r3.w, r3.w
  mul r3.z, r3.w, r3.z
  mad r10.xyz, r10.xyzx, r3.zzzz, r8.xyzx  // r10.x <- <FresnelSchlick_id139 return value>.x; r10.y <- <FresnelSchlick_id139 return value>.y; r10.z <- <FresnelSchlick_id139 return value>.z
...
#line 347
ushr r1.w, r3.y, l(16)  // r1.w <- <GetMaxLightCount_id198 return value>
...
#line 200
  mul r6.w, r6.w, r7.w  // r6.w <- attenuation
  mul r10.xyz, r6.wwww, r11.xyzx  // r10.x <- streams.lightColor_id39.x; r10.y <- streams.lightColor_id39.y; r10.z <- streams.lightColor_id39.z

#line 337
  dp3 r6.w, r3.xyzx, -r12.xyzx
  max r6.w, r6.w, l(0.000100)  // r6.w <- streams.NdotL_id43
  mul r10.xyz, r6.wwww, r10.xyzx  // r10.x <- streams.lightColorNdotL_id40.x; r10.y <- streams.lightColorNdotL_id40.y; r10.z <- streams.lightColorNdotL_id40.z
...
#line 180
  ...
  mul r5.y, r5.y, r5.y
  mul r5.x, r5.y, r5.x
  mad r12.xyz, r12.xyzx, r5.xxxx, r7.xyzx  // r12.x <- <FresnelSchlick_id139 return value>.x; r12.y <- <FresnelSchlick_id139 return value>.y; r12.z <- <FresnelSchlick_id139 return value>.z
...
#line 249
mul r0.xyz, r0.xxxx, r2.xyzx  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id172 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id172 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id172 return value>.z
...
float NormalDistributionBlinnPhong_id171(float alphaR, float nDotH)
{
    float alphaR2 = max(alphaR * alphaR, 0.1);
    return pow(nDotH, 2 / alphaR2 - 2) / (PI_id166 * alphaR2);
}
float VisibilityImplicit_id158(float nDotL, float nDotV)
{
    return 1.0f;
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id172(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionBlinnPhong_id171(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id241(inout PS_STREAMS streams)
{
    return VisibilityImplicit_id158(streams.NdotL_id43, streams.NdotV_id65);
}
float3 Compute_id212(inout PS_STREAMS streams, float3 f0)
{
...
float3 ComputeEnvironmentLightContribution_id351(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id172(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
...
void PrepareEnvironmentLight_id205(inout PS_STREAMS streams)
{
...
void PrepareDirectLights_id194()
{
}
float3 ComputeDirectLightContribution_id350(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id212(streams, specularColor);
    float geometricShadowing = Compute_id241(streams);
    float normalDistribution = Compute_id271(streams);
...
void Compute_id381(inout PS_STREAMS streams)
{
    ...
    {
        PrepareEnvironmentLight_id205(streams);
...
{
    streams.matSpecularIntensity_id50 = Compute_id210().r;
}
void Compute_id361(inout PS_STREAMS streams)
{
    streams.matSpecular_id49 = Compute_id208().rgb;
}
void Compute_id356(inout PS_STREAMS streams)
{
    float4 colorBase = Compute_id206();
