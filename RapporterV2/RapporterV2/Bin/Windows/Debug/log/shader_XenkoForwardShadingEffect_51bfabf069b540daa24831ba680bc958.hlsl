...
//
#line 646 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_51bfabf069b540daa24831ba680bc958.hlsl"
...
@G    Pixel => 82dffd30ab4e66d243fdc13e8ebaa706
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 675 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_51bfabf069b540daa24831ba680bc958.hlsl"
...
#line 168
  ...
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id71 return value>
...
#line 193
  ...
  mul r6.y, r6.y, r6.y
  mul r6.x, r6.y, r6.x
  mad r12.xyz, r12.xyzx, r6.xxxx, r8.xyzx  // r12.x <- <FresnelSchlick_id145 return value>.x; r12.y <- <FresnelSchlick_id145 return value>.y; r12.z <- <FresnelSchlick_id145 return value>.z

#line 189
  mad r6.x, r6.w, l(0.500000), l(0.500000)
  div r6.x, r6.w, r6.x  // r6.x <- <VisibilityhSchlickGGX_id163 return value>
  mad r6.y, r3.w, l(0.500000), l(0.500000)
  div r6.y, r3.w, r6.y  // r6.y <- <VisibilityhSchlickGGX_id163 return value>

#line 224
  mul r6.x, r6.y, r6.x
  mul r6.y, r3.w, r6.w
  div r6.x, r6.x, r6.y  // r6.x <- <VisibilitySmithSchlickGGX_id165 return value>
...
mov r5.w, r3.z  // r5.w <- streams.lightIndex_id84
mov r6.yz, r1.yyzy  // r6.y <- streams.viewWS_id61.y
...
#line 279
  ld r10.xyzw, r5.wwww, t1.xyzw  // r10.x <- realLightIndex
  iadd r5.w, r5.w, l(1)  // r5.w <- streams.lightIndex_id84
  ishl r7.w, r10.x, l(2)
  ld r10.xyzw, r7.wwww, t3.xyzw  // r10.x <- spotLight1.x; r10.y <- spotLight1.y; r10.z <- spotLight1.z

#line 285
  iadd r11.xyz, r7.wwww, l(1, 2, 3, 0)
...
#line 204
  ...
  div r10.xyz, r10.xyzx, r8.wwww  // r10.x <- lightVectorNorm.x; r10.y <- lightVectorNorm.y; r10.z <- lightVectorNorm.z
...
#line 162
  mul r7.w, r13.z, r7.w  // r7.w <- factor
...
#line 174
  dp3 r8.w, -r12.xyzx, r10.xyzx  // r8.w <- cd
  mad_sat r8.w, r8.w, r13.x, r13.y  // r8.w <- attenuation
  mul r8.w, r8.w, r8.w

#line 213
  mul r7.w, r7.w, r8.w  // r7.w <- attenuation
  mul r11.xyz, r7.wwww, r11.xyzx  // r11.x <- streams.lightColor_id39.x; r11.y <- streams.lightColor_id39.y; r11.z <- streams.lightColor_id39.z

#line 377
  dp3 r7.w, r4.xyzx, r10.xyzx
  max r7.w, r7.w, l(0.000100)  // r7.w <- streams.NdotL_id43
  mul r11.xyz, r7.wwww, r11.xyzx  // r11.x <- streams.lightColorNdotL_id40.x; r11.y <- streams.lightColorNdotL_id40.y; r11.z <- streams.lightColorNdotL_id40.z
...
#line 193
  ...
  mul r8.w, r8.w, r8.w
  mul r6.x, r6.x, r8.w
  mad r12.xyz, r12.xyzx, r6.xxxx, r7.xyzx  // r12.x <- <FresnelSchlick_id145 return value>.x; r12.y <- <FresnelSchlick_id145 return value>.y; r12.z <- <FresnelSchlick_id145 return value>.z

#line 189
  mad r6.x, r7.w, l(0.500000), l(0.500000)
  div r6.x, r7.w, r6.x  // r6.x <- <VisibilityhSchlickGGX_id163 return value>
  mad r8.w, r2.w, l(0.500000), l(0.500000)
  div r8.w, r2.w, r8.w  // r8.w <- <VisibilityhSchlickGGX_id163 return value>

#line 224
  mul r6.x, r6.x, r8.w
  mul r7.w, r2.w, r7.w
  div r6.x, r6.x, r7.w  // r6.x <- <VisibilitySmithSchlickGGX_id165 return value>
...
#line 359
  dp3 r5.w, r3.xyzx, -cb1[r4.w + 25].xyzx
  max r5.w, r5.w, l(0.000100)  // r5.w <- streams.NdotL_id43
  mul r9.xyz, r5.wwww, cb1[r4.w + 26].xyzx  // r9.x <- streams.lightColorNdotL_id40.x; r9.y <- streams.lightColorNdotL_id40.y; r9.z <- streams.lightColorNdotL_id40.z

#line 408
  mov r4.x, r3.w
  add r10.xyz, r4.xyzx, -cb1[r4.w + 25].xyzx
  ...
  dp3 r4.x, -cb1[r4.w + 25].xyzx, r10.xyzx
...
#line 193
  ...
  mul r4.w, r4.w, r4.w
  mul r4.x, r4.w, r4.x
  mad r11.xyz, r11.xyzx, r4.xxxx, r6.xyzx  // r11.x <- <FresnelSchlick_id145 return value>.x; r11.y <- <FresnelSchlick_id145 return value>.y; r11.z <- <FresnelSchlick_id145 return value>.z

#line 189
  mad r4.x, r5.w, l(0.500000), l(0.500000)
  div r4.x, r5.w, r4.x  // r4.x <- <VisibilityhSchlickGGX_id163 return value>
  mad r4.w, r1.w, l(0.500000), l(0.500000)
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id163 return value>

#line 224
  mul r4.x, r4.w, r4.x
  mul r4.w, r1.w, r5.w
  div r4.x, r4.x, r4.w  // r4.x <- <VisibilitySmithSchlickGGX_id165 return value>
...
#line 262
mul r0.xyz, r0.xxxx, r2.xyzx  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id180 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id180 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id180 return value>.z
...
float NormalDistributionGGX_id179(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id169 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    return NormalDistributionGGX_id179(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id257(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id165(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
