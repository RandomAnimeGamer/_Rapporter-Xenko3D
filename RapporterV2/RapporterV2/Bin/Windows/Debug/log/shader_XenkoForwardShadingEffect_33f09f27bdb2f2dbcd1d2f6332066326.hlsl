...
@C    constantColor_id190 => Material.EmissiveValue
@C    constantFloat_id192 => Material.EmissiveIntensity
...
//
#line 870 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_33f09f27bdb2f2dbcd1d2f6332066326.hlsl"
...
@G    Pixel => 244aa32889caee576a8d162a82795595
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float4 constantColor_id190;        // Offset:   32 Size:    16
//   float constantFloat_id192;         // Offset:   48 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 899 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_33f09f27bdb2f2dbcd1d2f6332066326.hlsl"
...
#line 603
and r2.w, r4.y, l(0x0000ffff)  // r2.w <- <GetMaxLightCount_id248 return value>
...
#line 211
  ...
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id85 return value>
...
#line 274
  ...
  mul r7.w, r7.w, r7.w
  mul r7.x, r7.w, r7.x
  mad r14.xyz, r14.xyzx, r7.xxxx, r9.yzwy  // r14.x <- <FresnelSchlick_id190 return value>.x; r14.y <- <FresnelSchlick_id190 return value>.y; r14.z <- <FresnelSchlick_id190 return value>.z

#line 269
  mul r7.x, r3.w, l(0.500000)  // r7.x <- k
  mad r7.w, -r3.w, l(0.500000), l(1.000000)
  mad r8.z, r4.w, r7.w, r7.x
  div r8.z, r4.w, r8.z  // r8.z <- <VisibilityhSchlickGGX_id208 return value>
  mad r7.x, r10.z, r7.w, r7.x
  div r7.x, r10.z, r7.x  // r7.x <- <VisibilityhSchlickGGX_id208 return value>

#line 321
  mul r7.x, r7.x, r8.z
  mul r4.w, r10.z, r4.w
  div r4.w, r7.x, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 316
  ...
  div r6.x, r7.x, r6.x  // r6.x <- <NormalDistributionGGX_id224 return value>
...
#line 564
ushr r2.w, r4.y, l(16)  // r2.w <- <GetMaxLightCount_id257 return value>
...
#line 205
  ...
  mul r5.x, r5.x, r5.x  // r5.x <- <SmoothDistanceAttenuation_id93 return value>
...
#line 310
  ...
  mul r13.xyz, r5.xxxx, r15.xyzx  // r13.x <- streams.lightColor_id39.x; r13.y <- streams.lightColor_id39.y; r13.z <- streams.lightColor_id39.z
...
#line 585
  ...
  rsq r5.z, r5.z
  mul r14.xyz, r5.zzzz, r14.xyzx  // r14.x <- streams.H_id68.x; r14.y <- streams.H_id68.y; r14.z <- streams.H_id68.z
  dp3 r5.z, r6.xyzx, r14.xyzx
...
#line 274
  ...
  mul r7.w, r7.w, r7.w
  mul r6.w, r6.w, r7.w
  mad r14.xyz, r14.xyzx, r6.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id190 return value>.x; r14.y <- <FresnelSchlick_id190 return value>.y; r14.z <- <FresnelSchlick_id190 return value>.z

#line 269
  mul r6.w, r5.y, l(0.500000)  // r6.w <- k
  mad r7.w, -r5.y, l(0.500000), l(1.000000)
  mad r8.w, r5.x, r7.w, r6.w
  div r8.w, r5.x, r8.w  // r8.w <- <VisibilityhSchlickGGX_id208 return value>
  mad r6.w, r5.w, r7.w, r6.w
  div r6.w, r5.w, r6.w  // r6.w <- <VisibilityhSchlickGGX_id208 return value>

#line 321
  mul r6.w, r6.w, r8.w
  mul r5.x, r5.w, r5.x
  div r5.x, r6.w, r5.x  // r5.x <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 316
  ...
  div r5.z, r6.w, r5.z  // r5.z <- <NormalDistributionGGX_id224 return value>
...
mov r9.xyz, r3.xyzx  // r9.x <- streams.matDiffuseVisible_id62.x; r9.y <- streams.matDiffuseVisible_id62.y; r9.z <- streams.matDiffuseVisible_id62.z
...
loop 
  ige r6.x, r3.w, l(1)
  breakc_nz r6.x
  ige r6.x, r3.w, cb1[24].y
  if_nz r6.x
    break 
  endif 

#line 536
  dp3 r6.x, r7.xyzx, -cb1[25].xyzx
...
#line 402
  ...
  lt r8.w, cb1[r13.x + 46].x, r5.w

#line 405
  movc r7.w, r8.w, l(2), r7.w

#line 402
  lt r8.w, cb1[r13.y + 46].x, r5.w
...
#line 285
  ...
  ishl r10.x, r7.w, l(2)
  bfi r10.x, l(30), l(4), r3.w, r10.x
  dp4 r13.x, r4.xyzw, cb1[r10.x + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r10.x + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r11.w, r4.xyzw, cb1[r10.x + 30].xyzw  // r11.w <- shadowPosition.z
  dp4 r10.x, r4.xyzw, cb1[r10.x + 31].xyzw  // r10.x <- shadowPosition.w
  add r13.z, r11.w, -cb1[44].x  // r13.z <- shadowPosition.z
  div r13.xyz, r13.xyzx, r10.xxxx
...
#line 234
  ...
  mul r10.x, r14.z, r14.w
  mad r18.xyzw, r17.xwzw, cb1[27].zwzw, r14.xyxy

#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r18.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id109 return value>

#line 243
  mul r13.xy, r14.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r18.zwzz, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id109 return value>

#line 241
  mul r12.w, r12.w, r13.x
  mad r10.x, r10.x, r11.w, r12.w  // r10.x <- shadow
...
#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r13.xyxx, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id109 return value>

#line 248
  mad r10.x, r11.w, r12.w, r10.x
  mul r11.w, r10.x, l(0.006944)  // r11.w <- shadow

#line 414
  iadd r12.w, r9.w, l(-1)
  add r12.w, -cb1[r12.w + 46].x, cb1[r9.w + 46].x
  movc r12.w, r7.w, r12.w, cb1[r9.w + 46].x  // r12.w <- splitSize
...
#line 285
  ...
  iadd r6.z, r6.z, l(4)
  dp4 r13.x, r4.xyzw, cb1[r6.z + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r6.z + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r7.w, r4.xyzw, cb1[r6.z + 30].xyzw  // r7.w <- shadowPosition.z
  dp4 r4.x, r4.xyzw, cb1[r6.z + 31].xyzw  // r4.x <- shadowPosition.w
  add r13.z, r7.w, -cb1[44].x  // r13.z <- shadowPosition.z
...
#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id109 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id109 return value>
...
#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t4.xxxx, s1, r4.z  // r6.z <- <SampleTextureAndCompare_id109 return value>

#line 244
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r18.xyxx, t4.xxxx, s1, r4.z  // r7.w <- <SampleTextureAndCompare_id109 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id109 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r17.zwzz, t4.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id109 return value>
...
#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r16.xyxx, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id109 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r16.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id109 return value>

#line 248
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 201
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.xyxx, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id109 return value>
...
#line 425
      mad r4.y, r10.x, l(0.006944), -r4.x
...
#line 585
  add r13.xyz, r8.xyzx, -cb1[25].xyzx
  ...
  dp3 r7.w, -cb1[25].xyzx, r13.xyzx
  max r7.w, r7.w, l(0.000100)  // r7.w <- streams.LdotH_id70

#line 581
  mul r13.xyz, r4.xyzx, r9.xyzx
...
#line 274
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r14.xyz, r14.xyzx, r7.wwww, r11.xyzx  // r14.x <- <FresnelSchlick_id190 return value>.x; r14.y <- <FresnelSchlick_id190 return value>.y; r14.z <- <FresnelSchlick_id190 return value>.z

#line 269
  mul r7.w, r6.y, l(0.500000)  // r7.w <- k
  mad r8.w, -r6.y, l(0.500000), l(1.000000)
  mad r9.w, r6.x, r8.w, r7.w
  div r9.w, r6.x, r9.w  // r9.w <- <VisibilityhSchlickGGX_id208 return value>
  mad r7.w, r6.w, r8.w, r7.w
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id208 return value>

#line 321
  mul r7.w, r7.w, r9.w
  mul r6.x, r6.w, r6.x
  div r6.x, r7.w, r6.x  // r6.x <- <VisibilitySmithSchlickGGX_id210 return value>
...
#line 316
  ...
  div r6.z, r7.w, r6.z  // r6.z <- <NormalDistributionGGX_id224 return value>
...
mad r2.xyz, r2.xyzx, r0.wwww, r2.wwww  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id225 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id225 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id225 return value>.z

#line 520
mul r4.xyz, r2.xyzx, cb1[50].xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id435 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id435 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id435 return value>.z
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id275 return value>.x; r0.y <- <Compute_id275 return value>.y; r0.z <- <Compute_id275 return value>.z
...
const static bool TUseAlphaFromEmissive_id205 = false;
...
float VisibilityhSchlickGGX_id208(float alphaR, float nDotX)
{
    float k = alphaR * 0.5f;
    return nDotX / (nDotX * (1.0f - k) + k);
}
float3 FresnelSchlick_id190(float3 f0, float3 f90, float lOrVDotH)
{
...
float VisibilitySmithSchlickGGX_id210(float alphaR, float nDotL, float nDotV)
{
    return VisibilityhSchlickGGX_id208(alphaR, nDotL) * VisibilityhSchlickGGX_id208(alphaR, nDotV) / (nDotL * nDotV);
}
float3 FresnelSchlick_id196(float3 f0, float lOrVDotH)
{
    return FresnelSchlick_id190(f0, 1.0f, lOrVDotH);
}
...
float4 Compute_id275(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id270(float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id225(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionGGX_id224(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id327(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id210(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
float3 Compute_id298(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id196(f0, streams.LdotH_id70);
}
...
float GetFilterSquareRoughnessAdjustment_id162(inout PS_STREAMS streams, float3 averageNormal)
{
...
void PrepareEnvironmentLight_id287(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id270(sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id275(streams, sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeEnvironmentLightContribution_id435(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id64;
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id225(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
float3 ComputeEnvironmentLightContribution_id386(inout PS_STREAMS streams)
{
...
int GetLightCount_id265()
{
    return LightCount_id94;
}
int GetMaxLightCount_id266()
{
...
float3 ComputeDirectLightContribution_id434(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id298(streams, specularColor);
    float geometricShadowing = Compute_id327(streams);
    float normalDistribution = Compute_id356(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeDirectLightContribution_id385(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
...
void PrepareMaterialForLightingAndShading_id227(inout PS_STREAMS streams)
{
    ...
    float roughnessAdjust = GetFilterSquareRoughnessAdjustment_id162(streams, streams.matNormal_id45);
    streams.alphaRoughness_id63 = max(roughness * roughness + roughnessAdjust, 0.001);
}
void ResetLightStream_id226(inout PS_STREAMS streams)
{
...
void Compute_id475(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id226(streams);
    PrepareMaterialForLightingAndShading_id227(streams);
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id385(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id434(streams);
            }
        }
    }
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id266();
        int count = GetLightCount_id265();
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id386(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id435(streams);
        }
    }
...
{
    streams.matEmissiveIntensity_id57 = Compute_id296().r;
}
void Compute_id455(inout PS_STREAMS streams)
{
    streams.matEmissive_id56 = Compute_id294().rgba;
}
void Compute_id450(inout PS_STREAMS streams)
{
    float metalness = Compute_id292().r;
