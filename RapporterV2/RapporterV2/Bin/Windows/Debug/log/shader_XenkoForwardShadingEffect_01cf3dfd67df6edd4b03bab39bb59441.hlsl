...
//
#line 1409 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_01cf3dfd67df6edd4b03bab39bb59441.hlsl"
...
@G    Pixel => ccc408dda19b68a7b13223b00d566d1d
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 1390 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_01cf3dfd67df6edd4b03bab39bb59441.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xy, r2.xyxx, t0.xyzw, s2  // r2.x <- <Compute_id542 return value>.x; r2.y <- <Compute_id542 return value>.y
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r5.xyxx, t1.yzwx, s2  // r0.w <- <Compute_id550 return value>.x
...
#line 662
and r3.w, r2.z, l(0x0000ffff)  // r3.w <- <GetMaxLightCount_id500 return value>
...
#line 256
  ...
  mul r5.w, r5.w, r5.w  // r5.w <- <SmoothDistanceAttenuation_id140 return value>
...
#line 563
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r17.xyz, r18.xyzx, r7.wwww, r17.xyzx  // r17.x <- <FresnelSchlick_id280 return value>.x; r17.y <- <FresnelSchlick_id280 return value>.y; r17.z <- <FresnelSchlick_id280 return value>.z

#line 558
  mul r7.w, r11.z, l(0.500000)  // r7.w <- k
  mad r8.w, -r11.z, l(0.500000), l(1.000000)
  mad r9.w, r5.w, r8.w, r7.w
  div r9.w, r5.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id298 return value>
  mad r7.w, r13.z, r8.w, r7.w
  div r7.w, r13.z, r7.w  // r7.w <- <VisibilityhSchlickGGX_id298 return value>

#line 750
  mul r7.w, r7.w, r9.w
  mul r5.w, r13.z, r5.w
  div r5.w, r7.w, r5.w  // r5.w <- <VisibilitySmithSchlickGGX_id300 return value>
...
#line 745
  ...
  div r6.y, r7.w, r6.y  // r6.y <- <NormalDistributionGGX_id314 return value>
...
#line 623
ushr r2.z, r2.z, l(16)  // r2.z <- <GetMaxLightCount_id509 return value>
...
#line 250
  ...
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id148 return value>
...
#line 355
  mul r7.w, r7.w, r8.w  // r7.w <- attenuation
  mul r17.xyz, r7.wwww, r19.xyzx  // r17.x <- streams.lightColor_id39.x; r17.y <- streams.lightColor_id39.y; r17.z <- streams.lightColor_id39.z

#line 613
  dp3 r7.w, r13.yzwy, r16.xyzx
  max r7.w, r7.w, l(0.000100)  // r7.w <- streams.NdotL_id43
  mul r17.xyz, r7.wwww, r17.xyzx
  mul r17.xyz, r4.wwww, r17.xyzx  // r17.x <- streams.lightColorNdotL_id40.x; r17.y <- streams.lightColorNdotL_id40.y; r17.z <- streams.lightColorNdotL_id40.z

#line 644
  add r18.xyz, r10.xyzx, r16.xyzx
  dp3 r8.w, r18.xyzx, r18.xyzx
  rsq r8.w, r8.w
  mul r18.xyz, r8.wwww, r18.xyzx  // r18.x <- streams.H_id68.x; r18.y <- streams.H_id68.y; r18.z <- streams.H_id68.z
  dp3 r8.w, r13.yzwy, r18.xyzx
  max r8.w, r8.w, l(0.000100)  // r8.w <- streams.NdotH_id69
  dp3 r9.x, r16.xyzx, r18.xyzx
...
#line 558
  ...
  div r10.w, r7.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id298 return value>
...
#line 750
  mul r9.x, r9.x, r10.w
  mul r7.w, r9.w, r7.w
  div r7.w, r9.x, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id300 return value>
...
#line 745
  ...
  div r8.w, r9.x, r8.w  // r8.w <- <NormalDistributionGGX_id314 return value>
...
#line 338
dp2 r4.w, cb2[45].xxxx, cb2[27].zzzz
...
mov r14.xyz, r5.xyzx  // r14.x <- streams.normalWS_id16.x; r14.y <- streams.normalWS_id16.y; r14.z <- streams.normalWS_id16.z
mov r16.xyz, r15.xyzx  // r16.x <- directLightingContribution.x; r16.y <- directLightingContribution.y; r16.z <- directLightingContribution.z
mov r5.w, r1.w  // r5.w <- streams.lightDirectAmbientOcclusion_id44
mov r6.y, l(0)  // r6.y <- i
loop 
  ige r7.w, r6.y, l(1)
  breakc_nz r7.w
  ige r7.w, r6.y, cb2[24].y
  if_nz r7.w
    break 
  endif 

#line 595
  dp3 r7.w, r14.xyzx, -cb2[25].xyzx
  max r7.w, r7.w, l(0.000100)  // r7.w <- streams.NdotL_id43
...
#line 447
  ...
  lt r11.w, cb2[r17.x + 46].x, r9.w

#line 450
  movc r10.z, r11.w, l(2), r10.z

#line 447
  lt r11.w, cb2[r17.y + 46].x, r9.w
...
#line 454
  mad r8.xyz, r12.wwww, r14.xyzx, r9.xyzx  // r8.x <- shadowPosition.x; r8.y <- shadowPosition.y; r8.z <- shadowPosition.z

#line 330
  bfi r12.w, l(30), l(2), r6.y, r10.z
  ishl r13.w, r10.z, l(2)
  bfi r13.w, l(30), l(4), r6.y, r13.w
  dp4 r17.x, r8.xyzw, cb2[r13.w + 28].xyzw  // r17.x <- shadowPosition.x
  dp4 r17.y, r8.xyzw, cb2[r13.w + 29].xyzw  // r17.y <- shadowPosition.y
  dp4 r14.w, r8.xyzw, cb2[r13.w + 30].xyzw  // r14.w <- shadowPosition.z
  dp4 r13.w, r8.xyzw, cb2[r13.w + 31].xyzw  // r13.w <- shadowPosition.w
  add r17.z, r14.w, -cb2[44].x  // r17.z <- shadowPosition.z
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r22.xyxx, t10.xxxx, s1, r17.z  // r14.w <- <SampleTextureAndCompare_id164 return value>

#line 288
  mul r17.xy, r18.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r22.zwzz, t10.xxxx, s1, r17.z  // r15.w <- <SampleTextureAndCompare_id164 return value>
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r17.xyxx, t10.xxxx, s1, r17.z  // r15.w <- <SampleTextureAndCompare_id164 return value>
...
#line 459
  ...
  add r15.w, -cb2[r15.w + 46].x, cb2[r12.w + 46].x
  movc r15.w, r10.z, r15.w, cb2[r12.w + 46].x  // r15.w <- splitSize
  add r12.w, -r9.w, cb2[r12.w + 46].x
...
#line 330
  ...
  dp4 r17.x, r8.xyzw, cb2[r10.x + 28].xyzw  // r17.x <- shadowPosition.x
  dp4 r17.y, r8.xyzw, cb2[r10.x + 29].xyzw  // r17.y <- shadowPosition.y
  dp4 r10.z, r8.xyzw, cb2[r10.x + 30].xyzw  // r10.z <- shadowPosition.z
  dp4 r8.x, r8.xyzw, cb2[r10.x + 31].xyzw  // r8.x <- shadowPosition.w
  add r17.z, r10.z, -cb2[44].x  // r17.z <- shadowPosition.z
...
#line 266
  ...
  mul r10.xz, r10.xxzx, cb2[27].zzwz
...
#line 279
  ...
  mad r20.xyzw, r19.xwzw, cb2[27].zwzw, r10.xzxz

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r8.x, r20.xyxx, t10.xxxx, s1, r8.z  // r8.x <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r8.y, r20.zwzz, t10.xxxx, s1, r8.z  // r8.y <- <SampleTextureAndCompare_id164 return value>

#line 290
  mov r18.zw, r19.wwwy
  mad r20.xyzw, r18.xzxw, cb2[27].zwzw, r10.xzxz

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r16.w, r20.xyxx, t10.xxxx, s1, r8.z  // r16.w <- <SampleTextureAndCompare_id164 return value>

#line 289
  mad r21.xyzw, r19.xyzy, cb2[27].zwzw, r10.xzxz

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r18.z, r21.xyxx, t10.xxxx, s1, r8.z  // r18.z <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r18.w, r21.zwzz, t10.xxxx, s1, r8.z  // r18.w <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r19.w, r20.zwzz, t10.xxxx, s1, r8.z  // r19.w <- <SampleTextureAndCompare_id164 return value>

#line 291
  mov r19.y, r18.y
  mad r20.xyzw, r19.xyzy, cb2[27].zwzw, r10.xzxz

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r19.x, r20.xyxx, t10.xxxx, s1, r8.z  // r19.x <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r19.y, r20.zwzz, t10.xxxx, s1, r8.z  // r19.y <- <SampleTextureAndCompare_id164 return value>

#line 293
  mad r10.xz, r18.xxyx, cb2[27].zzwz, r10.xxzx

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r8.z, r10.xzxx, t10.xxxx, s1, r8.z  // r8.z <- <SampleTextureAndCompare_id164 return value>
...
#line 597
  mul r8.xyz, r14.wwww, cb2[26].xyzx
...
#line 644
  ...
  dp3 r10.x, r14.xyzx, r17.xyzx
  dp3 r10.z, -cb2[25].xyzx, r17.xyzx
...
#line 563
  ...
  mad r18.xyz, r18.xyzx, r10.zzzz, r13.xyzx  // r18.x <- <FresnelSchlick_id280 return value>.x; r18.y <- <FresnelSchlick_id280 return value>.y; r18.z <- <FresnelSchlick_id280 return value>.z

#line 558
  mul r10.z, r10.y, l(0.500000)  // r10.z <- k
  mad r11.w, -r10.y, l(0.500000), l(1.000000)
  mad r12.w, r7.w, r11.w, r10.z
  div r12.w, r7.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id298 return value>
  mad r10.z, r10.w, r11.w, r10.z
  div r10.z, r10.w, r10.z  // r10.z <- <VisibilityhSchlickGGX_id298 return value>

#line 750
  mul r10.z, r10.z, r12.w
  mul r7.w, r10.w, r7.w
  div r7.w, r10.z, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id300 return value>
...
#line 745
  ...
  div r10.x, r10.z, r10.x  // r10.x <- <NormalDistributionGGX_id314 return value>
...
#line 588
mul r8.xyz, r0.wwww, cb2[50].xyzx  // r8.x <- lightColor.x; r8.y <- lightColor.y; r8.z <- lightColor.z
...
mad r7.xyz, r7.xyzx, r1.wwww, r2.wwww  // r7.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id315 return value>.x; r7.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id315 return value>.y; r7.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id315 return value>.z

#line 1038
mul r9.xyz, r8.xyzx, r7.xyzx  // r9.x <- <ComputeEnvironmentLightContribution_id697 return value>.x; r9.y <- <ComputeEnvironmentLightContribution_id697 return value>.y; r9.z <- <ComputeEnvironmentLightContribution_id697 return value>.z
...
#line 568
dp3 r1.w, r5.xyzx, cb2[60].xyzx  // r1.w <- sampleDirection.x
dp3 r2.w, r5.xyzx, cb2[61].xyzx  // r2.w <- sampleDirection.y
dp3 r5.w, r5.xyzx, cb2[62].xyzx  // r5.w <- sampleDirection.z
...
#line 400
mad r9.xyz, cb2[52].xyzx, r2.wwww, cb2[51].xyzx  // r9.x <- color.x; r9.y <- color.y; r9.z <- color.z
mad r9.xyz, cb2[53].xyzx, -r5.wwww, r9.xyzx
mad r9.xyz, cb2[54].xyzx, r1.wwww, r9.xyzx

#line 405
mul r10.xyz, r2.wwww, cb2[55].xyzx
mad r9.xyz, r10.xyzx, r1.wwww, r9.xyzx
mul r10.xyz, r2.wwww, cb2[56].xyzx
mad r9.xyz, r10.xyzx, -r5.wwww, r9.xyzx
mad r2.w, r7.w, l(3.000000), l(-1.000000)
mad r9.xyz, cb2[57].xyzx, r2.wwww, r9.xyzx
mul r10.xyz, r1.wwww, cb2[58].xyzx
mad r9.xyz, r10.xyzx, -r5.wwww, r9.xyzx
mad r1.w, r1.w, r1.w, -r6.y
mad r9.xyz, cb2[59].xyzx, r1.wwww, r9.xyzx
...
dp3 r10.x, r5.xyzx, cb2[60].xyzx  // r10.x <- sampleDirection.x
dp3 r10.y, r5.xyzx, cb2[61].xyzx  // r10.y <- sampleDirection.y
dp3 r1.w, r5.xyzx, cb2[62].xyzx  // r1.w <- sampleDirection.z
mov r10.z, -r1.w  // r10.z <- sampleDirection.z

#line 386
sqrt r1.w, r2.x
mul r1.w, r1.w, cb2[59].w  // r1.w <- mipLevel
sample_l_indexable(texturecube)(float,float,float,float) r5.xyz, r10.xyzx, t11.xyzw, s0, r1.w  // r5.x <- <Compute_id527 return value>.x; r5.y <- <Compute_id527 return value>.y; r5.z <- <Compute_id527 return value>.z
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r2.xwxx, t2.xyzw, s2  // r0.w <- <Compute_id698 return value>.x

#line 737
mad r2.xw, v4.xxxy, cb1[9].xxxy, cb1[9].zzzw
sample_indexable(texture2d)(float,float,float,float) r2.xw, r2.xwxx, t3.xzwy, s2  // r2.x <- <Compute_id702 return value>.x; r2.w <- <Compute_id702 return value>.y
...
sample_indexable(texture2d)(float,float,float,float) r1.w, r2.xwxx, t4.yzwx, s2  // r1.w <- <Compute_id710 return value>.x

#line 554
mad r2.xw, v4.xxxy, cb1[14].zzzw, cb1[15].xxxy
sample_indexable(texture2d)(float,float,float,float) r7.xyz, r2.xwxx, t5.xyzw, s2  // r7.x <- <Compute_id720 return value>.x; r7.y <- <Compute_id720 return value>.y; r7.z <- <Compute_id720 return value>.z
...
#line 256
  ...
  mad r7.w, -r7.w, r7.w, l(1.000000)
  max r7.w, r7.w, l(0.000000)  // r7.w <- smoothFactor
  mul r7.w, r7.w, r7.w  // r7.w <- <SmoothDistanceAttenuation_id140 return value>
...
#line 314
  ...
  div r12.w, r7.w, r12.w  // r12.w <- <VisibilityhSchlickGGX_id454 return value>
...
#line 366
  ...
  mul r7.w, r13.z, r7.w
  div r7.w, r11.z, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id456 return value>
...
#line 361
  ...
  mul r8.w, r8.w, r8.w
  mul r8.w, r8.w, l(3.141593)
  div r8.w, r11.z, r8.w  // r8.w <- <NormalDistributionGGX_id470 return value>
...
#line 355
  mul r7.w, r7.w, r8.x  // r7.w <- attenuation
  mul r16.xyz, r7.wwww, r18.xyzx  // r16.x <- streams.lightColor_id39.x; r16.y <- streams.lightColor_id39.y; r16.z <- streams.lightColor_id39.z

#line 613
  dp3 r7.w, r12.xyzx, r15.xyzx
  max r7.w, r7.w, l(0.000100)  // r7.w <- streams.NdotL_id43
  mul r16.xyz, r7.wwww, r16.xyzx
  mul r16.xyz, r2.yyyy, r16.xyzx  // r16.x <- streams.lightColorNdotL_id40.x; r16.y <- streams.lightColorNdotL_id40.y; r16.z <- streams.lightColorNdotL_id40.z

#line 644
  add r17.xyz, r9.xyzx, r15.xyzx
  dp3 r8.x, r17.xyzx, r17.xyzx
  rsq r8.x, r8.x
  mul r17.xyz, r8.xxxx, r17.xyzx  // r17.x <- streams.H_id68.x; r17.y <- streams.H_id68.y; r17.z <- streams.H_id68.z
  dp3 r8.x, r12.xyzx, r17.xyzx
  dp3 r8.z, r15.xyzx, r17.xyzx
...
#line 806
  mad r15.xyz, r15.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000), r13.yzwy  // r15.x <- directLightingContribution.x; r15.y <- directLightingContribution.y; r15.z <- directLightingContribution.z
...
#line 314
  ...
  div r10.w, r7.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id454 return value>
...
#line 366
  mul r8.z, r8.z, r10.w
  mul r7.w, r8.w, r7.w
  div r7.w, r8.z, r7.w  // r7.w <- <VisibilitySmithSchlickGGX_id456 return value>
...
#line 810
  mad r13.yzw, r16.xxyz, l(0.000000, 0.250000, 0.250000, 0.250000), r15.xxyz  // r13.y <- directLightingContribution.x; r13.z <- directLightingContribution.y; r13.w <- directLightingContribution.z
...
mov r12.xyz, r3.xyzx  // r12.x <- streams.matSpecularVisible_id64.x; r12.y <- streams.matSpecularVisible_id64.y; r12.z <- streams.matSpecularVisible_id64.z
...
#line 447
  ...
  lt r9.z, cb2[r16.x + 46].x, r8.w

#line 450
  movc r9.x, r9.z, l(2), r9.x

#line 447
  lt r9.z, cb2[r16.y + 46].x, r8.w
...
#line 330
  ...
  dp4 r16.x, r6.xyzw, cb2[r11.w + 28].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r6.xyzw, cb2[r11.w + 29].xyzw  // r16.y <- shadowPosition.y
  dp4 r12.w, r6.xyzw, cb2[r11.w + 30].xyzw  // r12.w <- shadowPosition.z
  dp4 r11.w, r6.xyzw, cb2[r11.w + 31].xyzw  // r11.w <- shadowPosition.w
  add r16.z, r12.w, -cb2[44].x  // r16.z <- shadowPosition.z
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r21.xyxx, t10.xxxx, s1, r16.z  // r12.w <- <SampleTextureAndCompare_id164 return value>

#line 288
  mul r16.xy, r17.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r21.zwzz, t10.xxxx, s1, r16.z  // r13.x <- <SampleTextureAndCompare_id164 return value>
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r16.xyxx, t10.xxxx, s1, r16.z  // r13.x <- <SampleTextureAndCompare_id164 return value>
...
#line 459
  iadd r13.x, r10.w, l(-1)
  add r13.x, -cb2[r13.x + 46].x, cb2[r10.w + 46].x
  movc r13.x, r9.x, r13.x, cb2[r10.w + 46].x  // r13.x <- splitSize
  add r10.w, -r8.w, cb2[r10.w + 46].x
  div r10.w, r10.w, r13.x  // r10.w <- splitDist
  lt r13.x, r10.w, l(0.200000)

#line 330
  ishl r7.w, r7.w, l(2)
  imad r7.w, r9.x, l(4), r7.w
  iadd r7.w, r7.w, l(4)
  dp4 r16.x, r6.xyzw, cb2[r7.w + 28].xyzw  // r16.x <- shadowPosition.x
  dp4 r16.y, r6.xyzw, cb2[r7.w + 29].xyzw  // r16.y <- shadowPosition.y
  dp4 r9.x, r6.xyzw, cb2[r7.w + 30].xyzw  // r9.x <- shadowPosition.z
  dp4 r6.x, r6.xyzw, cb2[r7.w + 31].xyzw  // r6.x <- shadowPosition.w
  add r16.z, r9.x, -cb2[44].x  // r16.z <- shadowPosition.z
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r6.x, r20.xyxx, t10.xxxx, s1, r6.z  // r6.x <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r6.y, r20.zwzz, t10.xxxx, s1, r6.z  // r6.y <- <SampleTextureAndCompare_id164 return value>
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r20.xyxx, t10.xxxx, s1, r6.z  // r7.w <- <SampleTextureAndCompare_id164 return value>

#line 289
  mad r21.xyzw, r19.xyzy, cb2[27].zwzw, r16.xyxy

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r9.x, r21.xyxx, t10.xxxx, s1, r6.z  // r9.x <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r21.zwzz, t10.xxxx, s1, r6.z  // r14.w <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r20.zwzz, t10.xxxx, s1, r6.z  // r15.w <- <SampleTextureAndCompare_id164 return value>
...
#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r17.z, r19.xyxx, t10.xxxx, s1, r6.z  // r17.z <- <SampleTextureAndCompare_id164 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r17.w, r19.zwzz, t10.xxxx, s1, r6.z  // r17.w <- <SampleTextureAndCompare_id164 return value>

#line 293
  mad r16.xy, r18.xyxx, cb2[27].zwzz, r16.xyxx

#line 246
  sample_c_indexable(texture2d)(float,float,float,float) r6.z, r16.xyxx, t10.xxxx, s1, r6.z  // r6.z <- <SampleTextureAndCompare_id164 return value>
...
#line 597
  mul r6.xyz, r12.wwww, cb2[26].xyzx
...
#line 644
  add r16.xyz, r10.xyzx, -cb2[25].xyzx
  dp3 r7.w, r16.xyzx, r16.xyzx
  rsq r7.w, r7.w
...
#line 319
  ...
  mul r9.z, r9.z, r9.z
  mul r9.x, r9.z, r9.x
  mad r17.xyz, r17.xyzx, r9.xxxx, r12.xyzx  // r17.x <- <FresnelSchlick_id436 return value>.x; r17.y <- <FresnelSchlick_id436 return value>.y; r17.z <- <FresnelSchlick_id436 return value>.z

#line 314
  mul r9.x, r9.y, l(0.500000)  // r9.x <- k
  mad r9.z, -r9.y, l(0.500000), l(1.000000)
  mad r10.w, r3.w, r9.z, r9.x
  div r10.w, r3.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id454 return value>
  mad r9.x, r9.w, r9.z, r9.x
  div r9.x, r9.w, r9.x  // r9.x <- <VisibilityhSchlickGGX_id454 return value>

#line 366
  mul r9.x, r9.x, r10.w
  mul r3.w, r9.w, r3.w
  div r3.w, r9.x, r3.w  // r3.w <- <VisibilitySmithSchlickGGX_id456 return value>
...
#line 361
  ...
  div r7.w, r9.x, r7.w  // r7.w <- <NormalDistributionGGX_id470 return value>
...
#line 588
mul r2.xyz, r1.wwww, cb2[50].xyzx  // r2.x <- lightColor.x; r2.y <- lightColor.y; r2.z <- lightColor.z
...
mad r3.xyz, r3.xyzx, r2.wwww, r3.wwww  // r3.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id471 return value>.x; r3.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id471 return value>.y; r3.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id471 return value>.z

#line 579
mul r6.xyz, r2.xyzx, r3.xyzx  // r6.x <- <ComputeEnvironmentLightContribution_id865 return value>.x; r6.y <- <ComputeEnvironmentLightContribution_id865 return value>.y; r6.z <- <ComputeEnvironmentLightContribution_id865 return value>.z
...
#line 568
dp3 r2.w, r1.xyzx, cb2[60].xyzx  // r2.w <- sampleDirection.x
...
#line 400
mad r8.xyz, cb2[52].xyzx, r3.wwww, cb2[51].xyzx  // r8.x <- color.x; r8.y <- color.y; r8.z <- color.z
mad r8.xyz, cb2[53].xyzx, -r4.wwww, r8.xyzx
mad r8.xyz, cb2[54].xyzx, r2.wwww, r8.xyzx

#line 405
mul r9.xyz, r3.wwww, cb2[55].xyzx
mad r8.xyz, r9.xyzx, r2.wwww, r8.xyzx
mul r9.xyz, r3.wwww, cb2[56].xyzx
mad r8.xyz, r9.xyzx, -r4.wwww, r8.xyzx
mad r3.w, r6.y, l(3.000000), l(-1.000000)
mad r6.yzw, cb2[57].xxyz, r3.wwww, r8.xxyz  // r6.y <- color.x; r6.z <- color.y; r6.w <- color.z
mul r8.xyz, r2.wwww, cb2[58].xyzx
mad r6.yzw, r8.xxyz, -r4.wwww, r6.yyzw
mad r2.w, r2.w, r2.w, -r6.x
mad r6.xyz, cb2[59].xyzx, r2.wwww, r6.yzwy  // r6.x <- color.x; r6.y <- color.y; r6.z <- color.z
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t11.xyzw, s0, r0.x  // r0.x <- <Compute_id527 return value>.x; r0.y <- <Compute_id527 return value>.y; r0.z <- <Compute_id527 return value>.z
...
mov o0.w, cb1[8].w
ret 
// Approximately 962 instruction slots used
***************************
*************************/
