...
@G    Pixel => 604f4cbc3cac9488e775597d43df6d9d
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
#line 355
  mul r6.y, r6.y, r7.w  // r6.y <- attenuation
  mul r17.xyz, r6.yyyy, r17.xyzx  // r17.x <- streams.lightColor_id39.x; r17.y <- streams.lightColor_id39.y; r17.z <- streams.lightColor_id39.z

#line 613
  dp3 r6.y, r13.xyzx, r16.xyzx
  max r6.y, r6.y, l(0.000100)  // r6.y <- streams.NdotL_id43
  mul r17.xyz, r6.yyyy, r17.xyzx
  mul r17.xyz, r2.wwww, r17.xyzx  // r17.x <- streams.lightColorNdotL_id40.x; r17.y <- streams.lightColorNdotL_id40.y; r17.z <- streams.lightColorNdotL_id40.z

#line 644
  add r18.xyz, r10.xyzx, r16.xyzx
  dp3 r7.w, r18.xyzx, r18.xyzx
  rsq r7.w, r7.w
  mul r18.xyz, r7.wwww, r18.xyzx  // r18.x <- streams.H_id68.x; r18.y <- streams.H_id68.y; r18.z <- streams.H_id68.z
...
#line 1182
  mad r16.xyz, r16.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000), r14.yzwy  // r16.x <- directLightingContribution.x; r16.y <- directLightingContribution.y; r16.z <- directLightingContribution.z
...
#line 1186
  mad r14.yzw, r17.xxyz, l(0.000000, 0.250000, 0.250000, 0.250000), r16.xxyz  // r14.y <- directLightingContribution.x; r14.z <- directLightingContribution.y; r14.w <- directLightingContribution.z
