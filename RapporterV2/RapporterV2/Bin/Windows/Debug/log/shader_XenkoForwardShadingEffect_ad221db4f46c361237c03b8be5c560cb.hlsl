...
@C    constantColor_id194 => Material.EmissiveValue
@C    constantFloat_id196 => Material.EmissiveIntensity
...
*****     Stages      *****
***************************
@G    Vertex => d285e39c503888d0728ee80a5d4665c4
//
...
//
#line 840 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ad221db4f46c361237c03b8be5c560cb.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
//   float4 constantColor_id194;        // Offset:   32 Size:    16
//   float constantFloat_id196;         // Offset:   48 Size:     4
//
// }
//
// cbuffer PerView
...
//
#line 922 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ad221db4f46c361237c03b8be5c560cb.hlsl"
...
#line 612
and r2.w, r4.y, l(0x0000ffff)  // r2.w <- <GetMaxLightCount_id252 return value>
...
#line 217
  ...
  mul r4.w, r4.w, r4.w  // r4.w <- <SmoothDistanceAttenuation_id89 return value>
...
#line 280
  ...
  mul r7.w, r7.w, r7.w
  mul r7.x, r7.w, r7.x
  mad r14.xyz, r14.xyzx, r7.xxxx, r9.yzwy  // r14.x <- <FresnelSchlick_id194 return value>.x; r14.y <- <FresnelSchlick_id194 return value>.y; r14.z <- <FresnelSchlick_id194 return value>.z

#line 275
  mul r7.x, r3.w, l(0.500000)  // r7.x <- k
  mad r7.w, -r3.w, l(0.500000), l(1.000000)
  mad r8.z, r4.w, r7.w, r7.x
  div r8.z, r4.w, r8.z  // r8.z <- <VisibilityhSchlickGGX_id212 return value>
  mad r7.x, r10.z, r7.w, r7.x
  div r7.x, r10.z, r7.x  // r7.x <- <VisibilityhSchlickGGX_id212 return value>

#line 327
  mul r7.x, r7.x, r8.z
  mul r4.w, r10.z, r4.w
  div r4.w, r7.x, r4.w  // r4.w <- <VisibilitySmithSchlickGGX_id214 return value>
...
#line 322
  ...
  div r6.x, r7.x, r6.x  // r6.x <- <NormalDistributionGGX_id228 return value>
...
#line 573
ushr r2.w, r4.y, l(16)  // r2.w <- <GetMaxLightCount_id261 return value>

#line 715
mov r4.xyz, v0.xyzx  // r4.x <- streams.PositionWS_id19.x; r4.y <- streams.PositionWS_id19.y; r4.z <- streams.PositionWS_id19.z
mov r5.y, r1.w  // r5.y <- streams.alphaRoughness_id67
mov r5.w, r0.w  // r5.w <- streams.NdotV_id69
mov r6.xyz, r0.xyzx  // r6.x <- streams.normalWS_id16.x; r6.y <- streams.normalWS_id16.y; r6.z <- streams.normalWS_id16.z
mov r7.xyz, r1.xyzx  // r7.x <- streams.viewWS_id65.x
mov r8.xyz, r3.xyzx  // r8.z <- streams.matDiffuseVisible_id66.z
...
#line 211
  ...
  mul r5.x, r5.x, r5.x  // r5.x <- <SmoothDistanceAttenuation_id97 return value>
...
#line 316
  ...
  mul r13.xyz, r5.xxxx, r15.xyzx  // r13.x <- streams.lightColor_id43.x; r13.y <- streams.lightColor_id43.y; r13.z <- streams.lightColor_id43.z

#line 563
  dp3 r5.x, r6.xyzx, r12.xyzx
  max r5.x, r5.x, l(0.000100)  // r5.x <- streams.NdotL_id47
  mul r13.xyz, r5.xxxx, r13.xyzx  // r13.x <- streams.lightColorNdotL_id44.x; r13.y <- streams.lightColorNdotL_id44.y; r13.z <- streams.lightColorNdotL_id44.z

#line 594
  add r14.xyz, r7.xyzx, r12.xyzx
  dp3 r5.z, r14.xyzx, r14.xyzx
  rsq r5.z, r5.z
  mul r14.xyz, r5.zzzz, r14.xyzx  // r14.x <- streams.H_id72.x; r14.y <- streams.H_id72.y; r14.z <- streams.H_id72.z
  dp3 r5.z, r6.xyzx, r14.xyzx
  max r5.z, r5.z, l(0.000100)  // r5.z <- streams.NdotH_id73
  dp3 r6.w, r12.xyzx, r14.xyzx
  max r6.w, r6.w, l(0.000100)  // r6.w <- streams.LdotH_id74
...
#line 280
  ...
  mul r7.w, r7.w, r7.w
  mul r6.w, r6.w, r7.w
  mad r14.xyz, r14.xyzx, r6.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id194 return value>.x; r14.y <- <FresnelSchlick_id194 return value>.y; r14.z <- <FresnelSchlick_id194 return value>.z

#line 275
  mul r6.w, r5.y, l(0.500000)  // r6.w <- k
  mad r7.w, -r5.y, l(0.500000), l(1.000000)
  mad r8.w, r5.x, r7.w, r6.w
  div r8.w, r5.x, r8.w  // r8.w <- <VisibilityhSchlickGGX_id212 return value>
...
#line 327
  mul r6.w, r6.w, r8.w
  mul r5.x, r5.w, r5.x
  div r5.x, r6.w, r5.x  // r5.x <- <VisibilitySmithSchlickGGX_id214 return value>
...
#line 322
  ...
  div r5.z, r6.w, r5.z  // r5.z <- <NormalDistributionGGX_id228 return value>
...
mov r8.xyz, r1.xyzx  // r8.x <- streams.viewWS_id65.x; r8.y <- streams.viewWS_id65.y; r8.z <- streams.viewWS_id65.z
mov r9.xyz, r3.xyzx  // r9.x <- streams.matDiffuseVisible_id66.x; r9.y <- streams.matDiffuseVisible_id66.y; r9.z <- streams.matDiffuseVisible_id66.z
mov r11.xyz, r2.xyzx  // r11.x <- streams.matSpecularVisible_id68.x; r11.y <- streams.matSpecularVisible_id68.y; r11.z <- streams.matSpecularVisible_id68.z
...
#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r11.w, r18.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id113 return value>

#line 249
  mul r13.xy, r14.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r18.zwzz, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r13.xyxx, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id113 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r6.z, r17.xyxx, t4.xxxx, s1, r4.z  // r6.z <- <SampleTextureAndCompare_id113 return value>

#line 250
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r7.w, r18.xyxx, t4.xxxx, s1, r4.z  // r7.w <- <SampleTextureAndCompare_id113 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.z, r18.zwzz, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id113 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r14.w, r17.zwzz, t4.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r16.xyxx, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id113 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r16.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id113 return value>

#line 254
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 207
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.xyxx, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id113 return value>
...
#line 547
  ...
  mul r4.xyz, r6.xxxx, r4.xyzx  // r4.x <- streams.lightColorNdotL_id44.x; r4.y <- streams.lightColorNdotL_id44.y; r4.z <- streams.lightColorNdotL_id44.z

#line 594
  add r13.xyz, r8.xyzx, -cb1[25].xyzx
  dp3 r6.z, r13.xyzx, r13.xyzx
  rsq r6.z, r6.z
  mul r13.xyz, r6.zzzz, r13.xyzx  // r13.x <- streams.H_id72.x; r13.y <- streams.H_id72.y; r13.z <- streams.H_id72.z
  dp3 r6.z, r7.xyzx, r13.xyzx
  max r6.z, r6.z, l(0.000100)  // r6.z <- streams.NdotH_id73
...
#line 280
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r14.xyz, r14.xyzx, r7.wwww, r11.xyzx  // r14.x <- <FresnelSchlick_id194 return value>.x; r14.y <- <FresnelSchlick_id194 return value>.y; r14.z <- <FresnelSchlick_id194 return value>.z

#line 275
  mul r7.w, r6.y, l(0.500000)  // r7.w <- k
  mad r8.w, -r6.y, l(0.500000), l(1.000000)
  mad r9.w, r6.x, r8.w, r7.w
  div r9.w, r6.x, r9.w  // r9.w <- <VisibilityhSchlickGGX_id212 return value>
  mad r7.w, r6.w, r8.w, r7.w
  div r7.w, r6.w, r7.w  // r7.w <- <VisibilityhSchlickGGX_id212 return value>

#line 327
  mul r7.w, r7.w, r9.w
  mul r6.x, r6.w, r6.x
  div r6.x, r7.w, r6.x  // r6.x <- <VisibilitySmithSchlickGGX_id214 return value>
...
#line 322
  ...
  div r6.z, r7.w, r6.z  // r6.z <- <NormalDistributionGGX_id228 return value>
...
mad r2.xyz, r2.xyzx, r0.wwww, r2.wwww  // r2.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id229 return value>.x; r2.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id229 return value>.y; r2.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id229 return value>.z

#line 529
mul r4.xyz, r2.xyzx, cb1[50].xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id439 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id439 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id439 return value>.z
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id279 return value>.x; r0.y <- <Compute_id279 return value>.y; r0.z <- <Compute_id279 return value>.z
...
#line 782
mad r0.xyz, r12.xyzx, l(3.141593, 3.141593, 3.141593, 0.000000), r0.xyzx  // r0.x <- streams.shadingColor_id70.x; r0.y <- streams.shadingColor_id70.y; r0.z <- streams.shadingColor_id70.z
...
const static bool TIsEnergyConservative_id200 = false;
static const float PI_id202 = 3.14159265358979323846;
const static bool TUseAlphaFromEmissive_id209 = false;
...
float FilterShadow_id109(float2 position, float positionDepth)
{
...

    {
        ...
        float v1 = (3 + t) / vw1;
        float v2 = t / vw2 + 2;
        shadow += uw0 * vw0 * SampleTextureAndCompare_id113(base_uv + float2(u0, v0) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw1 * vw0 * SampleTextureAndCompare_id113(base_uv + float2(u1, v0) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw2 * vw0 * SampleTextureAndCompare_id113(base_uv + float2(u2, v0) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw0 * vw1 * SampleTextureAndCompare_id113(base_uv + float2(u0, v1) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw1 * vw1 * SampleTextureAndCompare_id113(base_uv + float2(u1, v1) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw2 * vw1 * SampleTextureAndCompare_id113(base_uv + float2(u2, v1) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw0 * vw2 * SampleTextureAndCompare_id113(base_uv + float2(u0, v2) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw1 * vw2 * SampleTextureAndCompare_id113(base_uv + float2(u1, v2) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow += uw2 * vw2 * SampleTextureAndCompare_id113(base_uv + float2(u2, v2) * ShadowMapTextureTexelSize_id103, positionDepth);
        shadow /= 144.0f;
    }
    return shadow;
}
...
float NormalDistributionGGX_id228(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id202 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
float4 Compute_id279(inout PS_STREAMS streams, float3 direction)
{
...
float4 Compute_id274(float3 direction)
{
    float x = direction.x;
    float y = direction.y;
    float z = direction.z;
...
void ComputeShadow_id104(inout PS_STREAMS streams, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id111(OffsetScales_id166[lightIndex], streams.NdotL_id47, streams.normalWS_id16);
...
{
    return NormalDistributionGGX_id228(streams.alphaRoughness_id67, streams.NdotH_id73);
}
float Compute_id331(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id214(streams.alphaRoughness_id67, streams.NdotL_id47, streams.NdotV_id69);
}
float3 Compute_id302(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id200(f0, streams.LdotH_id74);
}
...
void ResetStream_id238()
{
}
void PreTransformPosition_id4()
{
}
void PrepareEnvironmentLight_id291(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id45 = Compute_id274(sampleDirection).rgb * Intensity_id181 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id62.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id46 = Compute_id279(streams, sampleDirection).rgb * Intensity_id181 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id62.y;
}
float3 ComputeEnvironmentLightContribution_id439(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id229(specularColor, streams.alphaRoughness_id67, streams.NdotV_id69) * streams.envLightSpecularColor_id46;
}
...
int GetLightCount_id269()
{
    return LightCount_id98;
}
int GetMaxLightCount_id270()
{
...
int GetLightCount_id262(inout PS_STREAMS streams)
{
    return streams.lightData_id87.y >> 16;
}
int GetMaxLightCount_id261(inout PS_STREAMS streams)
{
    return streams.lightData_id87.y >> 16;
}
...
{
    float3 specularColor = streams.matSpecularVisible_id68;
    float3 fresnel = Compute_id302(streams, specularColor);
    float geometricShadowing = Compute_id331(streams);
    float normalDistribution = Compute_id360(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id66;
    return diffuseColor / PI_id202 * streams.lightColorNdotL_id44 * streams.matDiffuseSpecularAlphaBlend_id62.x;
}
...
int GetLightCount_id253(inout PS_STREAMS streams)
{
    return streams.lightData_id87.y & 0xFFFF;
}
int GetMaxLightCount_id252(inout PS_STREAMS streams)
{
    return streams.lightData_id87.y & 0xFFFF;
}
void PrepareDirectLights_id251(inout PS_STREAMS streams)
{
...
void PrepareMaterialForLightingAndShading_id231(inout PS_STREAMS streams)
{
    ...
    float roughnessAdjust = GetFilterSquareRoughnessAdjustment_id166(streams, streams.matNormal_id49);
...
void Compute_id479(inout PS_STREAMS streams)
{
    ...
    {
        PrepareDirectLights_id251(streams);
        const int maxLightCount = GetMaxLightCount_id252(streams);
        int count = GetLightCount_id253(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id261(streams);
        int count = GetLightCount_id262(streams);
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id270();
        int count = GetLightCount_id269();
    ...
    {
        PrepareEnvironmentLight_id291(streams);
    ...
    streams.shadingColor_id70 += directLightingContribution * PI_id202 + environmentLightingContribution;
    streams.shadingColorAlpha_id71 = streams.matDiffuse_id51.a;
}
void Compute_id464(inout PS_STREAMS streams)
{
    streams.matEmissiveIntensity_id61 = Compute_id300().r;
}
void Compute_id459(inout PS_STREAMS streams)
{
    streams.matEmissive_id60 = Compute_id298().rgba;
}
void Compute_id454(inout PS_STREAMS streams)
{
    float metalness = Compute_id296().r;
