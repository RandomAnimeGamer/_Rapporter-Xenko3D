...
//
#line 835 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_8e5e13e14d4c5faeeb9262ec989e39a8.hlsl"
...
@G    Pixel => 511bbebf97a566aa11a5417a0b102887
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 864 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_8e5e13e14d4c5faeeb9262ec989e39a8.hlsl"
...
#line 198
  sample_c r11.w, r17.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id102 return value>

#line 240
  mul r17.xy, r14.xyxx, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 198
  sample_c r12.w, r17.zwzz, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
...
#line 198
  sample_c r11.w, r18.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id102 return value>
...
#line 198
  sample_c r12.w, r13.xyxx, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
...
#line 198
  sample_c r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id102 return value>
  sample_c r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id102 return value>
...
#line 198
  sample_c r10.x, r17.xyxx, t4.xxxx, s1, r4.z  // r10.x <- <SampleTextureAndCompare_id102 return value>

#line 241
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 198
  sample_c r12.w, r18.xyxx, t4.xxxx, s1, r4.z  // r12.w <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.z, r18.zwzz, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.w, r17.zwzz, t4.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id102 return value>
...
#line 198
  sample_c r15.z, r16.xyxx, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r15.w, r16.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id102 return value>

#line 245
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 198
  sample_c r4.z, r13.xyxx, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id102 return value>
...
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id248 return value>.x; r0.y <- <Compute_id248 return value>.y; r0.z <- <Compute_id248 return value>.z
