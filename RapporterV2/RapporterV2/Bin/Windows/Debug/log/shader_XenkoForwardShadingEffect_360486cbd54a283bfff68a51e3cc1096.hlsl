...
@C    constantFloat_id189 => Material.DiffuseSpecularAlphaBlendValue
@C    constantColor_id191 => Material.AlphaBlendColorValue
...
//
#line 860 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_360486cbd54a283bfff68a51e3cc1096.hlsl"
...
@G    Pixel => 6b13e1570760c659cb81de451a48e843
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float constantFloat_id189;         // Offset:   36 Size:     4
//   float4 constantColor_id191;        // Offset:   48 Size:    16
//
// }
//
// cbuffer PerView
...
//
#line 889 "C:\_Rapporter-Xenko3D\RapporterV2\RapporterV2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_360486cbd54a283bfff68a51e3cc1096.hlsl"
...
#line 596
and r1.w, r4.y, l(0x0000ffff)  // r1.w <- <GetMaxLightCount_id250 return value>
...
#line 322
  mov r6.x, r5.w
  add r11.xyz, -r6.xyzx, r11.xyzx  // r11.x <- lightVector.x; r11.y <- lightVector.y; r11.z <- lightVector.z
  dp3 r3.w, r11.xyzx, r11.xyzx
  sqrt r6.x, r3.w  // r6.x <- lightVectorLength
  div r11.xyz, r11.xyzx, r6.xxxx  // r11.x <- lightVectorNorm.x; r11.y <- lightVectorNorm.y; r11.z <- lightVectorNorm.z

#line 272
  max r6.x, r3.w, l(0.000100)
...
#line 273
  mul r3.w, r3.w, r6.x  // r3.w <- attenuation
...
#line 574
  mov r8.z, r9.x
  mul r11.xyz, r12.xyzx, r8.xyzx
  mul r11.xyz, r4.zzzz, r11.xyzx

#line 676
  mad r11.xyz, r11.xyzx, l(0.318310, 0.318310, 0.318310, 0.000000), r10.yzwy  // r11.x <- directLightingContribution.x; r11.y <- directLightingContribution.y; r11.z <- directLightingContribution.z

#line 267
  add r13.xyz, -r9.yzwy, l(1.000000, 1.000000, 1.000000, 0.000000)
  add r3.w, -r3.w, l(1.000000)
  mul r6.x, r3.w, r3.w
  mul r6.x, r6.x, r6.x
  mul r3.w, r3.w, r6.x
  mad r13.xyz, r13.xyzx, r3.wwww, r9.yzwy  // r13.x <- <FresnelSchlick_id194 return value>.x; r13.y <- <FresnelSchlick_id194 return value>.y; r13.z <- <FresnelSchlick_id194 return value>.z
...
#line 680
  mad r10.yzw, r12.xxyz, l(0.000000, 0.079577, 0.079577, 0.079577), r11.xxyz  // r10.y <- directLightingContribution.x; r10.z <- directLightingContribution.y; r10.w <- directLightingContribution.z
...
#line 557
ushr r1.w, r4.y, l(16)  // r1.w <- <GetMaxLightCount_id259 return value>
...
mov r3.w, cb0[2].y  // r3.w <- streams.matDiffuseSpecularAlphaBlend_id58.y
...
#line 438
  ld r11.xyzw, r4.wwww, t1.xyzw  // r11.x <- realLightIndex
  iadd r4.w, r4.w, l(1)  // r4.w <- streams.lightIndex_id84
  ishl r6.w, r11.x, l(2)
  ld r11.xyzw, r6.wwww, t3.xyzw  // r11.x <- spotLight1.x; r11.y <- spotLight1.y; r11.z <- spotLight1.z
...
#line 203
  ...
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id93 return value>
...
#line 303
  mul r6.w, r6.w, r7.w  // r6.w <- attenuation
  mul r11.xyz, r6.wwww, r12.xyzx  // r11.x <- streams.lightColor_id39.x; r11.y <- streams.lightColor_id39.y; r11.z <- streams.lightColor_id39.z
...
#line 267
  ...
  mul r7.w, r7.w, r7.w
  mul r6.w, r6.w, r7.w
  mad r13.xyz, r13.xyzx, r6.wwww, r8.xyzx  // r13.x <- <FresnelSchlick_id194 return value>.x; r13.y <- <FresnelSchlick_id194 return value>.y; r13.z <- <FresnelSchlick_id194 return value>.z
...
mov r11.xyz, r9.xyzx  // r11.x <- directLightingContribution.x; r11.y <- directLightingContribution.y; r11.z <- directLightingContribution.z
mov r3.w, cb0[2].y
mov r6.w, l(0)  // r6.w <- i
loop 
  ige r7.w, r6.w, l(1)
...
#line 395
  iadd r12.xy, r8.wwww, l(1, 2, 0, 0)
  lt r10.w, cb1[r12.x + 46].x, r5.w

#line 398
  movc r9.w, r10.w, l(2), r9.w

#line 395
  lt r10.w, cb1[r12.y + 46].x, r5.w
...
#line 278
  iadd r8.w, r8.w, r9.w
  ishl r11.w, r8.w, l(2)
  dp4 r12.x, r4.xyzw, cb1[r11.w + 28].xyzw  // r12.x <- shadowPosition.x
  dp4 r12.y, r4.xyzw, cb1[r11.w + 29].xyzw  // r12.y <- shadowPosition.y
  dp4 r12.w, r4.xyzw, cb1[r11.w + 30].xyzw  // r12.w <- shadowPosition.z
  dp4 r13.x, r4.xyzw, cb1[r11.w + 31].xyzw  // r13.x <- shadowPosition.w
  add r12.z, r12.w, -cb1[44].x  // r12.z <- shadowPosition.z
  div r12.xyz, r12.xyzx, r13.xxxx

#line 219
  mad r12.xy, r12.xyxx, cb1[27].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r13.xy, r12.xyxx  // r13.x <- base_uv.x; r13.y <- base_uv.y
  add r12.xy, r12.xyxx, -r13.xyxx  // r12.x <- s; r12.y <- t
  add r13.xy, r13.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  mul r13.xy, r13.xyxx, cb1[27].zwzz

#line 232
  mad r13.zw, -r12.yyyx, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r13.w <- uw0; r13.z <- vw0
  mad r14.xy, r12.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r14.x <- uw2; r14.y <- vw2
  mad r14.zw, -r12.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r14.zw, r14.zzzw, r13.wwwz
  add r15.xy, r12.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)
  div r12.xy, r12.xyxx, r14.xyxx
  ...
  add r15.xy, r12.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r15.x <- u2; r15.y <- v2
  mul r12.x, r13.z, r13.w
  mad r17.xyzw, r16.xwzw, cb1[27].zwzw, r13.xyxy

#line 199
  sample_c r12.y, r17.xyxx, t4.xxxx, s1, r12.z  // r12.y <- <SampleTextureAndCompare_id109 return value>

#line 241
  mul r14.zw, r13.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 199
  sample_c r12.w, r17.zwzz, t4.xxxx, s1, r12.z  // r12.w <- <SampleTextureAndCompare_id109 return value>

#line 239
  mul r12.w, r12.w, r14.z
  mad r12.x, r12.x, r12.y, r12.w  // r12.x <- shadow

#line 244
  mul r12.yw, r13.zzzw, r14.xxxy
  mov r15.zw, r16.wwwy
  mad r17.xyzw, r15.xzxw, cb1[27].zwzw, r13.xyxy

#line 199
  sample_c r13.z, r17.xyxx, t4.xxxx, s1, r12.z  // r13.z <- <SampleTextureAndCompare_id109 return value>

#line 240
  mad r12.x, r12.y, r13.z, r12.x
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 199
  sample_c r12.y, r18.xyxx, t4.xxxx, s1, r12.z  // r12.y <- <SampleTextureAndCompare_id109 return value>

#line 241
  mad r12.x, r14.w, r12.y, r12.x

#line 199
  sample_c r12.y, r18.zwzz, t4.xxxx, s1, r12.z

#line 242
  mad r12.x, r12.y, l(49.000000), r12.x

#line 245
  mul r13.zw, r14.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 199
  sample_c r12.y, r17.zwzz, t4.xxxx, s1, r12.z

#line 243
  mad r12.x, r13.z, r12.y, r12.x
  mov r16.y, r15.y
  mad r16.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 199
  sample_c r12.y, r16.xyxx, t4.xxxx, s1, r12.z

#line 244
  mad r12.x, r12.w, r12.y, r12.x

#line 199
  sample_c r12.y, r16.zwzz, t4.xxxx, s1, r12.z

#line 245
  mad r12.x, r13.w, r12.y, r12.x
  mul r12.y, r14.y, r14.x
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 199
  sample_c r12.z, r13.xyxx, t4.xxxx, s1, r12.z  // r12.z <- <SampleTextureAndCompare_id109 return value>

#line 246
  mad r12.x, r12.y, r12.z, r12.x
  mul r12.y, r12.x, l(0.006944)  // r12.y <- shadow

#line 407
  iadd r12.z, r8.w, l(-1)
  add r12.z, -cb1[r12.z + 46].x, cb1[r8.w + 46].x
  movc r9.w, r9.w, r12.z, cb1[r8.w + 46].x  // r9.w <- splitSize
  add r8.w, -r5.w, cb1[r8.w + 46].x
...
#line 278
  ...
  dp4 r12.z, r4.xyzw, cb1[r11.w + 30].xyzw  // r12.z <- shadowPosition.z
  dp4 r4.x, r4.xyzw, cb1[r11.w + 31].xyzw  // r4.x <- shadowPosition.w
  add r13.z, r12.z, -cb1[44].x  // r13.z <- shadowPosition.z
...
#line 219
  ...
  round_ni r12.zw, r4.xxxy  // r12.z <- base_uv.x; r12.w <- base_uv.y
  add r4.xy, r4.xyxx, -r12.zwzz  // r4.x <- s; r4.y <- t
  add r12.zw, r12.zzzw, l(0.000000, 0.000000, -0.500000, -0.500000)
  mul r12.zw, r12.zzzw, cb1[27].zzzw

#line 232
  mad r13.xy, -r4.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r13.y <- uw0; r13.x <- vw0
  mad r13.zw, r4.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r13.z <- uw2; r13.w <- vw2
  mad r14.xy, -r4.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r14.xy, r14.xyxx, r13.yxyy
  add r14.zw, r4.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  div r4.xy, r4.xyxx, r13.zwzz
  add r15.xw, r14.xxxy, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r15.x <- u0; r15.w <- v0
  mul r15.yz, r14.wwzw, l(0.000000, 0.142857, 0.142857, 0.000000)  // r15.z <- u1; r15.y <- v1
  add r14.xy, r4.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r14.x <- u2; r14.y <- v2
  mad r16.xyzw, r15.xwzw, cb1[27].zwzw, r12.zwzw

#line 199
  sample_c r4.x, r16.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id109 return value>
  sample_c r4.y, r16.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id109 return value>

#line 243
  mov r14.zw, r15.wwwy
  mad r16.xyzw, r14.xzxw, cb1[27].zwzw, r12.zwzw

#line 199
  sample_c r11.w, r16.xyxx, t4.xxxx, s1, r4.z  // r11.w <- <SampleTextureAndCompare_id109 return value>

#line 242
  mad r17.xyzw, r15.xyzy, cb1[27].zwzw, r12.zwzw

#line 199
  sample_c r14.z, r17.xyxx, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id109 return value>
  sample_c r14.w, r17.zwzz, t4.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id109 return value>
  sample_c r15.w, r16.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id109 return value>

#line 244
  mov r15.y, r14.y
  mad r16.xyzw, r15.xyzy, cb1[27].zwzw, r12.zwzw

#line 199
  sample_c r15.x, r16.xyxx, t4.xxxx, s1, r4.z  // r15.x <- <SampleTextureAndCompare_id109 return value>
  sample_c r15.y, r16.zwzz, t4.xxxx, s1, r4.z  // r15.y <- <SampleTextureAndCompare_id109 return value>

#line 246
  mad r12.zw, r14.xxxy, cb1[27].zzzw, r12.zzzw

#line 199
  sample_c r4.z, r12.zwzz, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id109 return value>
...
#line 238
      mul r9.w, r13.x, r13.y
      mul r4.y, r13.x, r4.y
      mul r4.y, r4.y, l(7.000000)
      mad r4.x, r9.w, r4.x, r4.y  // r4.x <- shadow

#line 244
      mul r12.zw, r13.xxxy, r13.zzzw

#line 240
      mad r4.x, r12.z, r11.w, r4.x
      mul r4.y, r13.y, r14.z
      mad r4.x, r4.y, l(7.000000), r4.x
      mad r4.x, r14.w, l(49.000000), r4.x
      mul r4.y, r13.z, r15.w
      mad r4.x, r4.y, l(7.000000), r4.x
      mad r4.x, r12.w, r15.x, r4.x
      mul r4.y, r13.w, r15.y
      mad r4.x, r4.y, l(7.000000), r4.x
      mul r4.y, r13.w, r13.z
      mad r4.x, r4.y, r4.z, r4.x
      mul r4.x, r4.x, l(0.006944)

#line 418
      mad r4.y, r12.x, l(0.006944), -r4.x
      mad r12.y, r8.w, r4.y, r4.x
    endif 
  endif   // r12.y <- shadow

#line 531
  mul r4.xyz, r12.yyyy, cb1[26].xyzx
...
#line 578
  add r12.xyz, r7.xyzx, -cb1[25].xyzx
...
#line 267
  ...
  mul r8.w, r8.w, r8.w
  mul r7.w, r7.w, r8.w
  mad r13.xyz, r13.xyzx, r7.wwww, r10.xyzx  // r13.x <- <FresnelSchlick_id194 return value>.x; r13.y <- <FresnelSchlick_id194 return value>.y; r13.z <- <FresnelSchlick_id194 return value>.z
...
#line 728
  mad r11.xyz, r4.xyzx, l(0.079577, 0.079577, 0.079577, 0.000000), r12.xyzx  // r11.x <- directLightingContribution.x; r11.y <- directLightingContribution.y; r11.z <- directLightingContribution.z
...
#line 383
mul r3.xyz, r0.wwww, r3.xyzx  // r3.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id227 return value>.x; r3.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id227 return value>.y; r3.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id227 return value>.z

#line 513
mul r4.xyz, r3.xyzx, cb1[50].xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id439 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id439 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id439 return value>.z
...
#line 348
mad r5.xyz, cb1[52].xyzx, r1.wwww, cb1[51].xyzx  // r5.x <- color.x; r5.y <- color.y; r5.z <- color.z
mad r5.xyz, cb1[53].xyzx, -r2.wwww, r5.xyzx
...
mad r5.xyz, cb1[57].xyzx, r1.wwww, r5.xyzx
...
mul r5.xyz, r5.xyzx, cb0[2].yyyy  // r5.x <- streams.envLightDiffuseColor_id41.x; r5.y <- streams.envLightDiffuseColor_id41.y; r5.z <- streams.envLightDiffuseColor_id41.z
...
#line 335
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, cb1[59].w  // r0.x <- <Compute_id277 return value>.x; r0.y <- <Compute_id277 return value>.y; r0.z <- <Compute_id277 return value>.z

#line 508
mul r0.xyz, r0.xyzx, cb1[64].xxxx
mul r0.xyz, r0.xyzx, cb0[2].yyyy  // r0.x <- streams.envLightSpecularColor_id42.x; r0.y <- streams.envLightSpecularColor_id42.y; r0.z <- streams.envLightSpecularColor_id42.z
...
float FilterShadow_id105(float2 position, float positionDepth)
{
    float shadow = 0.0f;
...

    {
        ...
        float v1 = (3 + t) / vw1;
        float v2 = t / vw2 + 2;
        shadow += uw0 * vw0 * SampleTextureAndCompare_id109(base_uv + float2(u0, v0) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw1 * vw0 * SampleTextureAndCompare_id109(base_uv + float2(u1, v0) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw2 * vw0 * SampleTextureAndCompare_id109(base_uv + float2(u2, v0) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw0 * vw1 * SampleTextureAndCompare_id109(base_uv + float2(u0, v1) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw1 * vw1 * SampleTextureAndCompare_id109(base_uv + float2(u1, v1) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw2 * vw1 * SampleTextureAndCompare_id109(base_uv + float2(u2, v1) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw0 * vw2 * SampleTextureAndCompare_id109(base_uv + float2(u0, v2) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw1 * vw2 * SampleTextureAndCompare_id109(base_uv + float2(u1, v2) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw2 * vw2 * SampleTextureAndCompare_id109(base_uv + float2(u2, v2) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow /= 144.0f;
    }
    return shadow;
}
float GetAngleAttenuation_id95(float3 lightVector, float3 lightDirection, float lightAngleScale, float lightAngleOffset)
{
...
float GetDistanceAttenuation_id94(float3 lightVector, float lightInvSquareRadius)
{
...
float ComputeShadowFromCascade_id108(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    ...
    return FilterShadow_id105(shadowPosition.xy, shadowPosition.z);
}
...
void ProcessLight_id96(inout PS_STREAMS streams, SpotLightDataInternal light)
{
    ...
    float attenuation = 1;
    attenuation *= GetDistanceAttenuation_id94(lightVector, lightInvSquareRadius);
    attenuation *= GetAngleAttenuation_id95(lightVectorNorm, lightDirection, lightAngleAndOffset.x, lightAngleAndOffset.y);
    streams.lightColor_id39 = light.Color * attenuation;
    streams.lightDirectionWS_id38 = lightDirection;
}
float NormalDistributionBlinnPhong_id226(float alphaR, float nDotH)
{
    float alphaR2 = max(alphaR * alphaR, 0.1);
    return pow(nDotH, 2 / alphaR2 - 2) / (PI_id197 * alphaR2);
}
float VisibilityImplicit_id213(float nDotL, float nDotV)
{
    return 1.0f;
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id227(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
void ComputeShadow_id100(inout PS_STREAMS streams, int lightIndex)
{
    ...
    shadowPosition += GetShadowPositionOffset_id107(OffsetScales_id162[lightIndex], streams.NdotL_id43, streams.normalWS_id16);
    if (cascadeIndex < TCascadeCount_id163)
    {
        shadow = ComputeShadowFromCascade_id108(shadowPosition, cascadeIndex, lightIndex);
        ...
        if (splitDist < 0.2)
        {
            ...
            {
                float nextShadow = ComputeShadowFromCascade_id108(shadowPosition, cascadeIndex + 1, lightIndex);
...
{
    return NormalDistributionBlinnPhong_id226(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id329(inout PS_STREAMS streams)
{
    return VisibilityImplicit_id213(streams.NdotL_id43, streams.NdotV_id65);
}
float3 Compute_id300(inout PS_STREAMS streams, float3 f0)
{
...
void PrepareEnvironmentLight_id289(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id272(sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id277(streams, sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeEnvironmentLightContribution_id439(inout PS_STREAMS streams)
{
    ...
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id227(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
...
void PrepareDirectLight_id266(inout PS_STREAMS streams, int lightIndex)
{
    ...
    ComputeShadow_id100(streams, lightIndex);
...
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id300(streams, specularColor);
    float geometricShadowing = Compute_id329(streams);
    float normalDistribution = Compute_id359(streams);
...
void PrepareDirectLights_id249(inout PS_STREAMS streams)
{
    PrepareLightData_id87(streams);
}
void PrepareMaterialForLightingAndShading_id229(inout PS_STREAMS streams)
{
...
void ResetLightStream_id228(inout PS_STREAMS streams)
{
...
void Compute_id479(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id228(streams);
    PrepareMaterialForLightingAndShading_id229(streams);
    float3 directLightingContribution = 0;

    {
        PrepareDirectLights_id249(streams);
