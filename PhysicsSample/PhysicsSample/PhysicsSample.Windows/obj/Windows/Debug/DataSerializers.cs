...
[assembly: SiliconStudio.Core.Serialization.Serializers.AssemblySerializerFactory(Type = typeof(SiliconStudio.DataSerializers.PhysicsSampleSerializerFactory))]
...
namespace SiliconStudio.DataSerializers
{
    // Assembly attributes that defines supported serializer (only generics one so that other assemblies can do generic instantiations by themselves)
   	public static class PhysicsSampleSerializerFactory
	{
	    [SiliconStudio.Core.ModuleInitializer]
        internal static void Initialize()
        {
			var assemblySerializers = new AssemblySerializers(typeof(PhysicsSampleSerializerFactory).GetTypeInfo().Assembly);
			...
			assemblySerializers.Modules.Add(typeof(SiliconStudio.DataSerializers.PhysicsSample_GameSerializerFactory).GetTypeInfo().Module);
            ...
            AssemblyRegistry.Register(typeof(PhysicsSampleSerializerFactory).GetTypeInfo().Assembly, AssemblyCommonCategories.Engine);
        }
	}
}
