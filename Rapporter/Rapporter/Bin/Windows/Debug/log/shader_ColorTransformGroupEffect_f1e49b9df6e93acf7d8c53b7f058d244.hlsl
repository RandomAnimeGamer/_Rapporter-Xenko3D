...
//
#line 146 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Bin\Windows\Debug\log\shader_ColorTransformGroupEffect_f1e49b9df6e93acf7d8c53b7f058d244.hlsl"
...
@G    Pixel => 24f023bed26c09936fc6211a39bdcbee
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 117 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Bin\Windows\Debug\log\shader_ColorTransformGroupEffect_f1e49b9df6e93acf7d8c53b7f058d244.hlsl"
sample_indexable(texture2d)(float,float,float,float) r0.xyz, v1.xyxx, t0.xyzw, s0  // r0.x <- <Shading_id2 return value>.x; r0.y <- <Shading_id2 return value>.y; r0.z <- <Shading_id2 return value>.z

#line 102
lt r0.w, l(0.000000), cb0[5].z
if_nz r0.w
  sample_indexable(texture2d)(float,float,float,float) r0.w, v1.xyxx, t1.yzwx, s1  // r0.w <- luminanceAverageLocal
  add r0.w, r0.w, -cb0[5].w
