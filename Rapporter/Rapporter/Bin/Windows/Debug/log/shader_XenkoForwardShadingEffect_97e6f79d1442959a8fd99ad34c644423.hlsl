...
@C    constantFloat_id197 => Material.SpecularIntensityValue
...
@R    Sampler_id181 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Texture_id192 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
@R    Texture_id192 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
...
@R    Texture_id192 => Material.SpecularMap [Stage: Pixel, Slot: (1-1)]
...
//
#line 855 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_97e6f79d1442959a8fd99ad34c644423.hlsl"
...
@G    Pixel => 0ec6c64a4559bd66f35190dc6f9b8b07
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id194;                // Offset:   20 Size:     8
//   float2 offset_id195;               // Offset:   32 Size:     8
//   float constantFloat_id197;         // Offset:   40 Size:     4
//
// }
//
// cbuffer PerView
...
// Texture_id192                     texture  float4          2d    1        1
...
//
#line 884 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_97e6f79d1442959a8fd99ad34c644423.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t0.xyzw, s2  // r2.x <- <Compute_id272 return value>.x; r2.y <- <Compute_id272 return value>.y; r2.z <- <Compute_id272 return value>.z; r2.w <- <Compute_id272 return value>.w

#line 645
mad r3.xy, v3.xyxx, cb0[1].yzyy, cb0[2].xyxx
sample_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t1.xyzw, s2  // r3.x <- <Compute_id276 return value>.x; r3.y <- <Compute_id276 return value>.y; r3.z <- <Compute_id276 return value>.z

#line 620
mul r3.xyz, r3.xyzx, cb0[2].zzzz  // r3.x <- streams.matSpecularVisible_id64.x; r3.y <- streams.matSpecularVisible_id64.y; r3.z <- streams.matSpecularVisible_id64.z
...
mov r5.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r4.xy, r5.xyzw, t2.xyzw  // r4.x <- streams.lightData_id83.x; r4.y <- streams.lightData_id83.y

#line 610
and r3.w, r4.y, l(0x0000ffff)  // r3.w <- <GetMaxLightCount_id232 return value>
...
#line 483
  ld_indexable(buffer)(uint,uint,uint,uint) r7.w, r10.xxxx, t3.yzwx  // r7.w <- realLightIndex
  iadd r10.x, r10.x, l(1)  // r10.x <- streams.lightIndex_id84
  ishl r8.w, r7.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyzw, r8.wwww, t4.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  bfi r7.w, l(31), l(1), r7.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r7.wwww, t4.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 218
  ...
  mul r6.x, r6.x, r6.x  // r6.x <- <SmoothDistanceAttenuation_id80 return value>
...
#line 281
  ...
  mul r8.z, r8.z, r8.z
  mul r7.w, r7.w, r8.z
  mad r14.xyz, r14.xyzx, r7.wwww, r9.yzwy  // r14.x <- <FresnelSchlick_id180 return value>.x; r14.y <- <FresnelSchlick_id180 return value>.y; r14.z <- <FresnelSchlick_id180 return value>.z

#line 276
  mul r7.w, r4.z, l(0.500000)  // r7.w <- k
  mad r8.z, -r4.z, l(0.500000), l(1.000000)
  mad r8.w, r6.x, r8.z, r7.w
  div r8.w, r6.x, r8.w  // r8.w <- <VisibilityhSchlickGGX_id198 return value>
  mad r7.w, r10.z, r8.z, r7.w
  div r7.w, r10.z, r7.w  // r7.w <- <VisibilityhSchlickGGX_id198 return value>

#line 328
  mul r7.w, r7.w, r8.w
  mul r6.x, r10.z, r6.x
  div r6.x, r7.w, r6.x  // r6.x <- <VisibilitySmithSchlickGGX_id200 return value>
...
#line 323
  ...
  div r7.x, r7.w, r7.x  // r7.x <- <NormalDistributionGGX_id214 return value>
...
#line 571
ushr r3.w, r4.y, l(16)  // r3.w <- <GetMaxLightCount_id241 return value>
...
#line 452
  ld_indexable(buffer)(uint,uint,uint,uint) r6.w, r4.wwww, t3.yzwx  // r6.w <- realLightIndex
  iadd r4.w, r4.w, l(1)  // r4.w <- streams.lightIndex_id84
  ishl r7.w, r6.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r7.wwww, t5.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z
...
#line 212
  ...
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id88 return value>
...
#line 281
  ...
  mul r9.y, r9.y, r9.y
  mul r8.w, r8.w, r9.y
  mad r14.xyz, r14.xyzx, r8.wwww, r8.xyzx  // r14.x <- <FresnelSchlick_id180 return value>.x; r14.y <- <FresnelSchlick_id180 return value>.y; r14.z <- <FresnelSchlick_id180 return value>.z

#line 276
  mul r8.w, r9.x, l(0.500000)  // r8.w <- k
  mad r9.y, -r9.x, l(0.500000), l(1.000000)
  mad r9.w, r6.w, r9.y, r8.w
  div r9.w, r6.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id198 return value>
  mad r8.w, r9.z, r9.y, r8.w
  div r8.w, r9.z, r8.w  // r8.w <- <VisibilityhSchlickGGX_id198 return value>

#line 328
  mul r8.w, r8.w, r9.w
  mul r6.w, r9.z, r6.w
  div r6.w, r8.w, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id200 return value>
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r18.xyxx, t6.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id104 return value>

#line 250
  mul r13.xy, r14.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r18.zwzz, t6.xxxx, s1, r13.z  // r13.w <- <SampleTextureAndCompare_id104 return value>
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r19.xyxx, t6.xxxx, s1, r13.z

#line 250
  mad r11.w, r13.y, r12.w, r11.w

#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r19.zwzz, t6.xxxx, s1, r13.z
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r18.zwzz, t6.xxxx, s1, r13.z
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r17.xyxx, t6.xxxx, s1, r13.z

#line 253
  mad r11.w, r13.w, r12.w, r11.w

#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r12.w, r17.zwzz, t6.xxxx, s1, r13.z
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r13.x, r13.xyxx, t6.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id104 return value>
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r4.x, r17.xyxx, t6.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id104 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r4.y, r17.zwzz, t6.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id104 return value>
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r8.w, r17.xyxx, t6.xxxx, s1, r4.z  // r8.w <- <SampleTextureAndCompare_id104 return value>

#line 251
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.yzyz

#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r9.w, r18.xyxx, t6.xxxx, s1, r4.z  // r9.w <- <SampleTextureAndCompare_id104 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r13.w, r18.zwzz, t6.xxxx, s1, r4.z  // r13.w <- <SampleTextureAndCompare_id104 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r15.z, r17.zwzz, t6.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id104 return value>
...
#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r15.w, r16.xyxx, t6.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id104 return value>
  sample_c_indexable(texture2d)(float,float,float,float) r16.x, r16.zwzz, t6.xxxx, s1, r4.z  // r16.x <- <SampleTextureAndCompare_id104 return value>

#line 255
  mad r13.yz, r15.xxyx, cb1[27].zzwz, r13.yyzy

#line 208
  sample_c_indexable(texture2d)(float,float,float,float) r4.z, r13.yzyy, t6.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id104 return value>
...
#line 281
  ...
  mul r10.x, r10.x, r10.x
  mul r9.w, r9.w, r10.x
  mad r14.xyz, r14.xyzx, r9.wwww, r9.xyzx  // r14.x <- <FresnelSchlick_id180 return value>.x; r14.y <- <FresnelSchlick_id180 return value>.y; r14.z <- <FresnelSchlick_id180 return value>.z

#line 276
  mul r9.w, r11.x, l(0.500000)  // r9.w <- k
  mad r10.x, -r11.x, l(0.500000), l(1.000000)
  mad r11.y, r7.w, r10.x, r9.w
  div r11.y, r7.w, r11.y  // r11.y <- <VisibilityhSchlickGGX_id198 return value>
  mad r9.w, r11.z, r10.x, r9.w
  div r9.w, r11.z, r9.w  // r9.w <- <VisibilityhSchlickGGX_id198 return value>
...
mad r3.xyz, r3.xyzx, r0.wwww, r3.wwww  // r3.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id215 return value>.x; r3.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id215 return value>.y; r3.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id215 return value>.z

#line 527
mul r4.xyz, r3.xyzx, cb1[50].xyzx  // r4.x <- <ComputeEnvironmentLightContribution_id417 return value>.x; r4.y <- <ComputeEnvironmentLightContribution_id417 return value>.y; r4.z <- <ComputeEnvironmentLightContribution_id417 return value>.z
...
sample_l_indexable(texturecube)(float,float,float,float) r0.xyz, r1.xyzx, t7.xyzw, s0, r0.x  // r0.x <- <Compute_id259 return value>.x; r0.y <- <Compute_id259 return value>.y; r0.z <- <Compute_id259 return value>.z
...
float SampleTextureAndCompare_id104(float2 position, float positionDepth)
{
...
float FilterShadow_id100(float2 position, float positionDepth)
{
    float shadow = 0.0f;
...

    {
        ...
        float v1 = (3 + t) / vw1;
        float v2 = t / vw2 + 2;
        shadow += uw0 * vw0 * SampleTextureAndCompare_id104(base_uv + float2(u0, v0) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw1 * vw0 * SampleTextureAndCompare_id104(base_uv + float2(u1, v0) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw2 * vw0 * SampleTextureAndCompare_id104(base_uv + float2(u2, v0) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw0 * vw1 * SampleTextureAndCompare_id104(base_uv + float2(u0, v1) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw1 * vw1 * SampleTextureAndCompare_id104(base_uv + float2(u1, v1) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw2 * vw1 * SampleTextureAndCompare_id104(base_uv + float2(u2, v1) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw0 * vw2 * SampleTextureAndCompare_id104(base_uv + float2(u0, v2) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw1 * vw2 * SampleTextureAndCompare_id104(base_uv + float2(u1, v2) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow += uw2 * vw2 * SampleTextureAndCompare_id104(base_uv + float2(u2, v2) * ShadowMapTextureTexelSize_id99, positionDepth);
        shadow /= 144.0f;
    }
    return shadow;
}
...
float ComputeShadowFromCascade_id103(float3 shadowPositionWS, int cascadeIndex, int lightIndex)
{
    ...
    return FilterShadow_id100(shadowPosition.xy, shadowPosition.z);
}
float3 GetShadowPositionOffset_id102(float offsetScale, float nDotL, float3 normal)
{
    float normalOffsetScale = saturate(1.0f - nDotL);
    return 2.0f * ShadowMapTextureTexelSize_id99.x * offsetScale * normalOffsetScale * normal;
}
void ComputeShadow_id101(inout PS_STREAMS streams, int lightIndex)
{
...
float NormalDistributionGGX_id214(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id203 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    ComputeShadow_id101(streams, lightIndex);
    ...
    shadowPosition += GetShadowPositionOffset_id102(OffsetScales_id162[lightIndex], streams.NdotL_id43, streams.normalWS_id16);
    if (cascadeIndex < TCascadeCount_id163)
    {
        shadow = ComputeShadowFromCascade_id103(shadowPosition, cascadeIndex, lightIndex);
        ...
        if (splitDist < 0.2)
        {
            ...
            {
                float nextShadow = ComputeShadowFromCascade_id103(shadowPosition, cascadeIndex + 1, lightIndex);
...
float3 Compute_id280(inout PS_STREAMS streams, float3 f0)
{
...
void PrepareEnvironmentLight_id271(inout PS_STREAMS streams)
{
    ...
    streams.envLightDiffuseColor_id41 = Compute_id254(sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.x;
    ...
    sampleDirection = float3(sampleDirection.xy, -sampleDirection.z);
    streams.envLightSpecularColor_id42 = Compute_id259(streams, sampleDirection).rgb * Intensity_id177 * ambientAccessibility * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
...
int GetLightCount_id249()
{
    return LightCount_id94;
}
int GetMaxLightCount_id250()
{
...
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id280(streams, specularColor);
    float geometricShadowing = Compute_id309(streams);
    float normalDistribution = Compute_id338(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id203 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
float4 Compute_id278()
{
    return float4(constantFloat_id197, constantFloat_id197, constantFloat_id197, constantFloat_id197);
}
float4 Compute_id276(inout PS_STREAMS streams)
{
    return Texture_id192.Sample(Sampler_id181, streams.TexCoord_id148 * scale_id194 + offset_id195).rgba;
}
...
void Compute_id452(inout PS_STREAMS streams)
{
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id250();
        int count = GetLightCount_id249();
