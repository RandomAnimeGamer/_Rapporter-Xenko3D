...
@C    constantFloat_id166 => Material.GlossinessValue
@C    scale_id173 => Material.TextureScale.i2
@C    offset_id174 => Material.TextureOffset.i2
...
@R    Sampler_id157 => Material.Sampler.i0 [Stage: None, Slot: (-1--1)]
@R    Texture_id162 => Material.GlossinessMap [Stage: None, Slot: (-1--1)]
@R    Texture_id162 => Material.GlossinessMap [Stage: None, Slot: (-1--1)]
@R    Texture_id171 => Material.MetalnessMap [Stage: None, Slot: (-1--1)]
@R    Texture_id171 => Material.MetalnessMap [Stage: None, Slot: (-1--1)]
...
@R    Texture_id162 => Material.GlossinessMap [Stage: Pixel, Slot: (1-1)]
@R    Texture_id171 => Material.MetalnessMap [Stage: Pixel, Slot: (2-2)]
...
//
#line 686 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Rapporter.Windows\log\shader_XenkoEditorMaterialPreviewEffect_90b46b5e907c684fdb23ea6318f76e18.hlsl"
...
@G    Pixel => 7456cb1f5d715690dcbff3e3a58655a3
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id173;                // Offset:   36 Size:     8
//   float2 offset_id174;               // Offset:   48 Size:     8
//
// }
//
// cbuffer PerView
...
// Texture_id171                     texture  float4          2d    2        1
...
//
#line 715 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Rapporter.Windows\log\shader_XenkoEditorMaterialPreviewEffect_90b46b5e907c684fdb23ea6318f76e18.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t0.xyzw, s0  // r2.x <- <Compute_id220 return value>.x; r2.y <- <Compute_id220 return value>.y; r2.z <- <Compute_id220 return value>.z; r2.w <- <Compute_id220 return value>.w

#line 369
mad r3.xy, v3.xyxx, cb0[1].xyxx, cb0[1].zwzz
sample_indexable(texture2d)(float,float,float,float) r0.w, r3.xyxx, t1.yzwx, s0  // r0.w <- <Compute_id222 return value>.x

#line 497
add r1.w, r0.w, cb0[2].x  // r1.w <- interColor.x

#line 361
mul r3.x, r0.w, cb0[2].x
add r3.y, -r0.w, l(1.000000)
mul r3.z, cb0[2].x, cb0[2].x
mul r3.y, r3.y, r3.z
mad r1.w, r3.x, r1.w, r3.y
add r3.x, -cb0[2].x, l(1.000000)
mul r0.w, r0.w, r0.w
mad r0.w, r0.w, r3.x, r1.w  // r0.w <- <BasicBlend_id402 return value>.x

#line 491
mad r3.xy, v3.xyxx, cb0[2].yzyy, cb0[3].xyxx
sample_indexable(texture2d)(float,float,float,float) r1.w, r3.xyxx, t2.yzwx, s0  // r1.w <- <Compute_id228 return value>.x

#line 606
add r3.xyz, r2.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r3.xyz, r1.wwww, r3.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r3.x <- streams.matSpecular_id49.x; r3.y <- streams.matSpecular_id49.y; r3.z <- streams.matSpecular_id49.z
...
#line 460
and r3.w, r4.y, l(0x0000ffff)  // r3.w <- <GetMaxLightCount_id195 return value>
...
mov r9.w, r0.w  // r9.w <- streams.alphaRoughness_id63
mov r4.w, r1.w  // r4.w <- streams.NdotV_id65
...
#line 332
  ld_indexable(buffer)(uint,uint,uint,uint) r8.w, r4.zzzz, t4.yzwx  // r8.w <- realLightIndex
  iadd r4.z, r4.z, l(1)  // r4.z <- streams.lightIndex_id142
  ishl r10.w, r8.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r11.xyzw, r10.wwww, t5.xyzw  // r11.x <- pointLight1.x; r11.y <- pointLight1.y; r11.z <- pointLight1.z; r11.w <- pointLight1.w
  bfi r8.w, l(31), l(1), r8.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r8.wwww, t5.xyzw  // r12.x <- pointLight2.x; r12.y <- pointLight2.y; r12.z <- pointLight2.z
...
#line 190
  ...
  mul r8.w, r8.w, r8.w  // r8.w <- <SmoothDistanceAttenuation_id73 return value>
...
#line 210
  ...
  div r11.w, r8.w, r11.w  // r11.w <- <VisibilityhSchlickGGX_id161 return value>
...
#line 246
  mul r7.y, r7.y, r11.w
  mul r8.w, r4.w, r8.w
  div r7.y, r7.y, r8.w  // r7.y <- <VisibilitySmithSchlickGGX_id163 return value>
...
#line 421
ushr r3.w, r4.y, l(16)  // r3.w <- <GetMaxLightCount_id204 return value>
...
#line 301
  ld_indexable(buffer)(uint,uint,uint,uint) r8.w, r6.wwww, t4.yzwx  // r8.w <- realLightIndex
  iadd r6.w, r6.w, l(1)  // r6.w <- streams.lightIndex_id142
  ishl r9.y, r8.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r12.xyz, r9.yyyy, t6.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z
...
#line 184
  ...
  mad r8.w, -r8.w, r8.w, l(1.000000)
  max r8.w, r8.w, l(0.000000)  // r8.w <- smoothFactor
  mul r8.w, r8.w, r8.w  // r8.w <- <SmoothDistanceAttenuation_id81 return value>
...
#line 215
  ...
  mul r9.w, r9.w, r9.w
  mul r9.y, r9.w, r9.y
  mad r14.xyz, r14.xyzx, r9.yyyy, r8.xyzx  // r14.x <- <FresnelSchlick_id143 return value>.x; r14.y <- <FresnelSchlick_id143 return value>.y; r14.z <- <FresnelSchlick_id143 return value>.z

#line 210
  mul r9.y, r9.x, l(0.500000)  // r9.y <- k
  mad r9.w, -r9.x, l(0.500000), l(1.000000)
  mad r10.w, r8.w, r9.w, r9.y
  div r10.w, r8.w, r10.w  // r10.w <- <VisibilityhSchlickGGX_id161 return value>
  mad r9.y, r9.z, r9.w, r9.y
  div r9.y, r9.z, r9.y  // r9.y <- <VisibilityhSchlickGGX_id161 return value>

#line 246
  mul r9.y, r9.y, r10.w
  mul r8.w, r9.z, r8.w
  div r8.w, r9.y, r8.w  // r8.w <- <VisibilitySmithSchlickGGX_id163 return value>
...
#line 241
  ...
  mul r7.x, r7.x, r7.x
  mul r7.x, r7.x, l(3.141593)
  div r7.x, r9.y, r7.x  // r7.x <- <NormalDistributionGGX_id177 return value>
...
#line 215
  ...
  mul r7.w, r7.w, r7.w
  mul r5.w, r5.w, r7.w
  mad r13.xyz, r13.xyzx, r5.wwww, r7.xyzx  // r13.x <- <FresnelSchlick_id143 return value>.x; r13.y <- <FresnelSchlick_id143 return value>.y; r13.z <- <FresnelSchlick_id143 return value>.z

#line 210
  mul r5.w, r8.x, l(0.500000)  // r5.w <- k
  mad r7.w, -r8.x, l(0.500000), l(1.000000)
  mad r8.y, r6.w, r7.w, r5.w
  div r8.y, r6.w, r8.y  // r8.y <- <VisibilityhSchlickGGX_id161 return value>
  mad r5.w, r8.z, r7.w, r5.w
  div r5.w, r8.z, r5.w  // r5.w <- <VisibilityhSchlickGGX_id161 return value>

#line 246
  mul r5.w, r5.w, r8.y
  mul r6.w, r8.z, r6.w
  div r5.w, r5.w, r6.w  // r5.w <- <VisibilitySmithSchlickGGX_id163 return value>
...
#line 241
  ...
  div r5.x, r6.w, r5.x  // r5.x <- <NormalDistributionGGX_id177 return value>
...
const static bool TInvert_id169 = false;
...
float NormalDistributionGGX_id177(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id180 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
float3 Compute_id230(inout PS_STREAMS streams, float3 f0)
{
...
float4 BasicBlend_id402(float4 backColor, float4 frontColor, float3 interColor)
{
...
{
    return Texture_id162.Sample(Sampler_id157, streams.TexCoord_id124 * scale_id164 + offset_id165).r;
}
...
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id230(streams, specularColor);
    float geometricShadowing = Compute_id259(streams);
    float normalDistribution = Compute_id288(streams);
...
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id180 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
{
    return Texture_id171.Sample(Sampler_id157, streams.TexCoord_id124 * scale_id173 + offset_id174).r;
}
float4 Compute_id227(inout PS_STREAMS streams)
{
    float4 backColor = Compute_id222(streams);
    float4 frontColor = Compute_id224();
    float3 interColor = frontColor.rgb + backColor.rgb;
    return BasicBlend_id402(backColor, frontColor, interColor);
}
...
{
    float metalness = Compute_id228(streams).r;
...
{
    float glossiness = Compute_id227(streams).r;
