...
@C    scale_id181 => Material.TextureScale.i3
@C    offset_id182 => Material.TextureOffset.i3
...
@R    Texture_id170 => Material.GlossinessMap [Stage: None, Slot: (-1--1)]
@R    Texture_id179 => Material.MetalnessMap [Stage: None, Slot: (-1--1)]
@R    Texture_id179 => Material.MetalnessMap [Stage: None, Slot: (-1--1)]
...
@R    Texture_id179 => Material.MetalnessMap [Stage: Pixel, Slot: (3-3)]
...
//
#line 729 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Rapporter.Windows\log\shader_XenkoEditorMaterialPreviewEffect_16439df5c5b735e5baa821c5698b8189.hlsl"
...
@G    Pixel => a4cfd0ed2db60d9e82f072654d07874d
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id181;                // Offset:   52 Size:     8
//   float2 offset_id182;               // Offset:   64 Size:     8
//
// }
//
// cbuffer PerView
...
// Texture_id179                     texture  float4          2d    3        1
...
//
#line 710 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Rapporter.Windows\log\shader_XenkoEditorMaterialPreviewEffect_16439df5c5b735e5baa821c5698b8189.hlsl"
...
sample_indexable(texture2d)(float,float,float,float) r2.xyzw, r2.xyxx, t0.xyzw, s0  // r2.x <- <Compute_id226 return value>.x; r2.y <- <Compute_id226 return value>.y; r2.z <- <Compute_id226 return value>.z; r2.w <- <Compute_id226 return value>.w

#line 511
mad r5.xy, v2.xyxx, cb1[1].xyxx, cb1[1].zwzz
sample_indexable(texture2d)(float,float,float,float) r5.xy, r5.xyxx, t1.xyzw, s0  // r5.x <- <Compute_id228 return value>.x; r5.y <- <Compute_id228 return value>.y
...
sample_indexable(texture2d)(float,float,float,float) r0.w, r6.xyxx, t2.yzwx, s0  // r0.w <- <Compute_id230 return value>.x

#line 500
mad r6.xy, v2.xyxx, cb1[3].yzyy, cb1[4].xyxx
sample_indexable(texture2d)(float,float,float,float) r1.w, r6.xyxx, t3.yzwx, s0  // r1.w <- <Compute_id236 return value>.x

#line 619
add r6.xyz, r2.xyzx, l(-0.020000, -0.020000, -0.020000, 0.000000)
mad r6.xyz, r1.wwww, r6.xyzx, l(0.020000, 0.020000, 0.020000, 0.000000)  // r6.x <- streams.matSpecular_id49.x; r6.y <- streams.matSpecular_id49.y; r6.z <- streams.matSpecular_id49.z
mad r2.xyz, r1.wwww, -r2.xyzx, r2.xyzx  // r2.x <- streams.matDiffuse_id47.x; r2.y <- streams.matDiffuse_id47.y; r2.z <- streams.matDiffuse_id47.z
...
mad r0.w, -r0.w, cb1[3].x, l(1.000000)  // r0.w <- roughness

#line 365
dp3 r3.x, r5.xyzx, r5.xyzx
sqrt r3.y, r3.x  // r3.y <- r
lt r3.z, r3.y, l(1.000000)
add r3.w, -r3.x, l(1.000000)
mul r3.w, r3.w, l(0.500000)
mul r3.x, r3.y, r3.x
mad r3.x, r3.y, l(3.000000), -r3.x
div r3.x, r3.w, r3.x  // r3.x <- roughnessAdjust
and r3.x, r3.x, r3.z
...
#line 357
add r3.x, v1.z, -cb2[22].z
div r3.x, cb2[22].w, r3.x  // r3.x <- depth
ftoi r3.yz, v1.xxyx  // r3.y <- shadingPosition.x; r3.z <- shadingPosition.y
mad r3.x, r3.x, cb2[23].w, cb2[24].x
log r3.x, r3.x
max r3.x, r3.x, l(0.000000)
ftoi r4.z, r3.x  // r4.z <- slice
ushr r4.xy, r3.yzyy, l(6, 6, 0, 0)
mov r4.w, l(0)
ld_indexable(texture3d)(uint,uint,uint,uint) r3.xy, r4.xyzw, t4.xyzw  // r3.x <- streams.lightData_id141.x; r3.y <- streams.lightData_id141.y

#line 468
and r3.z, r3.y, l(0x0000ffff)  // r3.z <- <GetMaxLightCount_id201 return value>
...
mov r8.yzw, r6.xxyz  // r8.y <- streams.matSpecularVisible_id64.x; r8.z <- streams.matSpecularVisible_id64.y; r8.w <- streams.matSpecularVisible_id64.z
mov r3.w, r0.w  // r3.w <- streams.alphaRoughness_id63
...
mov r10.x, r3.x  // r10.x <- streams.lightIndex_id142
...
#line 344
  ld_indexable(buffer)(uint,uint,uint,uint) r6.w, r10.xxxx, t5.yzwx  // r6.w <- realLightIndex
  iadd r10.x, r10.x, l(1)  // r10.x <- streams.lightIndex_id142
  ishl r7.w, r6.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r12.xyzw, r7.wwww, t6.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  bfi r6.w, l(31), l(1), r6.w, l(1)
  ld_indexable(buffer)(float,float,float,float) r13.xyz, r6.wwww, t6.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 202
  ...
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id74 return value>
...
#line 450
  mov r5.x, r4.w
  add r14.xyz, r12.xyzx, r5.xyzx
  dp3 r5.x, r14.xyzx, r14.xyzx
  rsq r5.x, r5.x
  mul r14.xyz, r5.xxxx, r14.xyzx  // r14.x <- streams.H_id68.x; r14.y <- streams.H_id68.y; r14.z <- streams.H_id68.z
  dp3 r5.x, r9.xyzx, r14.xyzx
...
#line 227
  ...
  mul r7.w, r7.w, r7.w
  mul r7.z, r7.w, r7.z
  mad r14.xyz, r14.xyzx, r7.zzzz, r8.yzwy  // r14.x <- <FresnelSchlick_id149 return value>.x; r14.y <- <FresnelSchlick_id149 return value>.y; r14.z <- <FresnelSchlick_id149 return value>.z

#line 222
  mul r7.z, r3.w, l(0.500000)  // r7.z <- k
  mad r7.w, -r3.w, l(0.500000), l(1.000000)
  mad r9.w, r6.w, r7.w, r7.z
  div r9.w, r6.w, r9.w  // r9.w <- <VisibilityhSchlickGGX_id167 return value>
  mad r7.z, r10.y, r7.w, r7.z
  div r7.z, r10.y, r7.z  // r7.z <- <VisibilityhSchlickGGX_id167 return value>

#line 258
  mul r7.z, r7.z, r9.w
  mul r6.w, r10.y, r6.w
  div r6.w, r7.z, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id169 return value>

#line 253
  mul r7.z, r3.w, r3.w  // r7.z <- alphaR2
  mul r5.x, r5.x, r5.x
  ...
  div r5.x, r7.z, r5.x  // r5.x <- <NormalDistributionGGX_id183 return value>
...
#line 429
ushr r3.x, r3.y, l(16)  // r3.x <- <GetMaxLightCount_id210 return value>

#line 558
mov r4.xyz, v0.xyzx
mov r4.w, r10.x  // r4.w <- streams.lightIndex_id142
mov r3.yzw, r0.xxyz  // r3.y <- streams.viewWS_id61.x; r3.z <- streams.viewWS_id61.y; r3.w <- streams.viewWS_id61.z
...
mov r8.xyz, r6.xyzx  // r8.x <- streams.matSpecularVisible_id64.x; r8.y <- streams.matSpecularVisible_id64.y; r8.z <- streams.matSpecularVisible_id64.z
...
#line 313
  ld_indexable(buffer)(uint,uint,uint,uint) r6.w, r4.wwww, t5.yzwx  // r6.w <- realLightIndex
...
#line 196
  ...
  mad r6.w, -r6.w, r6.w, l(1.000000)
  max r6.w, r6.w, l(0.000000)  // r6.w <- smoothFactor
  mul r6.w, r6.w, r6.w  // r6.w <- <SmoothDistanceAttenuation_id82 return value>
...
#line 227
  ...
  mul r9.y, r9.y, r9.y
  mul r8.w, r8.w, r9.y
  mad r14.xyz, r14.xyzx, r8.wwww, r8.xyzx  // r14.x <- <FresnelSchlick_id149 return value>.x; r14.y <- <FresnelSchlick_id149 return value>.y; r14.z <- <FresnelSchlick_id149 return value>.z
...
#line 222
  ...
  div r8.w, r9.z, r8.w  // r8.w <- <VisibilityhSchlickGGX_id167 return value>

#line 258
  mul r8.w, r8.w, r9.w
  mul r6.w, r9.z, r6.w
  div r6.w, r8.w, r6.w  // r6.w <- <VisibilitySmithSchlickGGX_id169 return value>
...
#line 253
  ...
  div r7.w, r8.w, r7.w  // r7.w <- <NormalDistributionGGX_id183 return value>
...
#line 582
mov r3.xyz, r0.xyzx  // r3.x <- streams.viewWS_id61.x; r3.y <- streams.viewWS_id61.y; r3.z <- streams.viewWS_id61.z
mov r4.xyz, r1.xyzx  // r4.x <- streams.normalWS_id16.x; r4.y <- streams.normalWS_id16.y; r4.z <- streams.normalWS_id16.z
mov r5.xyz, r2.xyzx  // r5.x <- streams.matDiffuseVisible_id62.x; r5.y <- streams.matDiffuseVisible_id62.y; r5.z <- streams.matDiffuseVisible_id62.z
mov r7.xyz, r6.xyzx  // r7.x <- streams.matSpecularVisible_id64.x; r7.y <- streams.matSpecularVisible_id64.y; r7.z <- streams.matSpecularVisible_id64.z
...
#line 401
  dp3 r5.w, r4.xyzx, -cb2[r4.w + 25].xyzx
...
#line 450
  add r12.xyz, r3.xyzx, -cb2[r4.w + 25].xyzx
  dp3 r6.w, r12.xyzx, r12.xyzx
  rsq r6.w, r6.w
...
#line 227
  ...
  mul r7.w, r7.w, r7.w
  mul r4.w, r4.w, r7.w
  mad r13.xyz, r13.xyzx, r4.wwww, r7.xyzx  // r13.x <- <FresnelSchlick_id149 return value>.x; r13.y <- <FresnelSchlick_id149 return value>.y; r13.z <- <FresnelSchlick_id149 return value>.z

#line 222
  mul r4.w, r8.x, l(0.500000)  // r4.w <- k
  mad r7.w, -r8.x, l(0.500000), l(1.000000)
  mad r8.y, r5.w, r7.w, r4.w
  div r8.y, r5.w, r8.y  // r8.y <- <VisibilityhSchlickGGX_id167 return value>
  mad r4.w, r8.z, r7.w, r4.w
  div r4.w, r8.z, r4.w  // r4.w <- <VisibilityhSchlickGGX_id167 return value>

#line 258
  mul r4.w, r4.w, r8.y
  mul r5.w, r8.z, r5.w
  div r4.w, r4.w, r5.w  // r4.w <- <VisibilitySmithSchlickGGX_id169 return value>
...
#line 253
  ...
  div r5.w, r5.w, r6.w  // r5.w <- <NormalDistributionGGX_id183 return value>
...
mul_sat r0.y, r6.y, l(50.000000)
mul r0.y, r0.y, r0.z  // r0.y <- bias
mad r0.xyz, r6.xyzx, r0.xxxx, r0.yyyy  // r0.x <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id184 return value>.x; r0.y <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id184 return value>.y; r0.z <- <EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id184 return value>.z

#line 385
mul r0.xyz, r0.xyzx, cb2[41].xyzx  // r0.x <- <ComputeEnvironmentLightContribution_id375 return value>.x; r0.y <- <ComputeEnvironmentLightContribution_id375 return value>.y; r0.z <- <ComputeEnvironmentLightContribution_id375 return value>.z
...
float NormalDistributionGGX_id183(float alphaR, float nDotH)
{
    float alphaR2 = alphaR * alphaR;
    return alphaR2 / (PI_id188 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
float3 EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id184(float3 specularColor, float alphaR, float nDotV)
{
    float x = 1 - alphaR;
    float y = nDotV;
    float b1 = -0.1688;
...
{
    return NormalDistributionGGX_id183(streams.alphaRoughness_id63, streams.NdotH_id69);
}
float Compute_id267(inout PS_STREAMS streams)
{
    return VisibilitySmithSchlickGGX_id169(streams.alphaRoughness_id63, streams.NdotL_id43, streams.NdotV_id65);
}
float3 Compute_id238(inout PS_STREAMS streams, float3 f0)
{
    return FresnelSchlick_id155(f0, streams.LdotH_id70);
}
...
float GetFilterSquareRoughnessAdjustment_id121(inout PS_STREAMS streams, float3 averageNormal)
{
...
float4 Compute_id230(inout PS_STREAMS streams)
{
    return Texture_id170.Sample(Sampler_id157, streams.TexCoord_id124 * scale_id172 + offset_id173).r;
}
void ResetStream_id187()
{
}
float3 ComputeEnvironmentLightContribution_id375(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id64;
    return EnvironmentLightingDFG_GGX_Fresnel_SmithSchlickGGX_id184(specularColor, streams.alphaRoughness_id63, streams.NdotV_id65) * streams.envLightSpecularColor_id42;
}
float3 ComputeEnvironmentLightContribution_id326(inout PS_STREAMS streams)
{
...
float3 ComputeDirectLightContribution_id374(inout PS_STREAMS streams)
{
    float3 specularColor = streams.matSpecularVisible_id64;
    float3 fresnel = Compute_id238(streams, specularColor);
    float geometricShadowing = Compute_id267(streams);
    float normalDistribution = Compute_id296(streams);
    float3 reflected = fresnel * geometricShadowing * normalDistribution / 4;
    return reflected * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.y;
}
float3 ComputeDirectLightContribution_id325(inout PS_STREAMS streams)
{
    float3 diffuseColor = streams.matDiffuseVisible_id62;
    return diffuseColor / PI_id188 * streams.lightColorNdotL_id40 * streams.matDiffuseSpecularAlphaBlend_id58.x;
}
...
void PrepareMaterialForLightingAndShading_id186(inout PS_STREAMS streams)
{
    ...
    float roughnessAdjust = GetFilterSquareRoughnessAdjustment_id121(streams, streams.matNormal_id45);
    streams.alphaRoughness_id63 = max(roughness * roughness + roughnessAdjust, 0.001);
}
void ResetLightStream_id185(inout PS_STREAMS streams)
{
...
{
    return Texture_id179.Sample(Sampler_id157, streams.TexCoord_id124 * scale_id181 + offset_id182).r;
}
float4 Compute_id235(inout PS_STREAMS streams)
{
    float4 tex1 = Compute_id230(streams);
    float4 tex2 = Compute_id232();
    float4 mix1 = tex1 * tex2;
    return mix1;
}
float4 Compute_id228(inout PS_STREAMS streams)
{
    return Texture_id162.Sample(Sampler_id157, streams.TexCoord_id124 * scale_id164 + offset_id165).rgba;
}
float4 Compute_id226(inout PS_STREAMS streams)
{
...
void Compute_id410(inout PS_STREAMS streams)
{
    ...
    ResetLightStream_id185(streams);
    PrepareMaterialForLightingAndShading_id186(streams);
...

    {
        ...
        for (int i = 0; i < maxLightCount; i++)
        {
            ...
            {
                directLightingContribution += ComputeDirectLightContribution_id325(streams);
            }

            {
                directLightingContribution += ComputeDirectLightContribution_id374(streams);
            }
        }
    }
...

    {
        ...
        const int maxLightCount = GetMaxLightCount_id219();
...

    {
        ...
        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id326(streams);
        }

        {
            environmentLightingContribution += ComputeEnvironmentLightContribution_id375(streams);
        }
    }
    streams.shadingColor_id66 += directLightingContribution * PI_id188 + environmentLightingContribution;
    streams.shadingColorAlpha_id67 = streams.matDiffuse_id47.a;
}
void Compute_id395(inout PS_STREAMS streams)
{
    float metalness = Compute_id236(streams).r;
...
{
    float4 colorBase = Compute_id226(streams);
