...
@C    scale_id178 => Material.TextureScale.i2
@C    offset_id179 => Material.TextureOffset.i2
@C    constantFloat_id181 => Material.SpecularIntensityValue
...
@R    Texture_id162 => Material.NormalMap [Stage: None, Slot: (-1--1)]
@R    Texture_id176 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
@R    Texture_id176 => Material.SpecularMap [Stage: None, Slot: (-1--1)]
...
@R    Texture_id176 => Material.SpecularMap [Stage: Pixel, Slot: (2-2)]
...
//
#line 726 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Rapporter.Windows\log\shader_XenkoEditorMaterialPreviewEffect_38e98be1932339c1625cd232054e94ab.hlsl"
...
@G    Pixel => 952c112fe2fe5b6df972163ad8a611dd
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//   float2 scale_id178;                // Offset:   36 Size:     8
//   float2 offset_id179;               // Offset:   48 Size:     8
//   float constantFloat_id181;         // Offset:   56 Size:     4
//
// }
//
// cbuffer PerView
...
// Texture_id176                     texture  float4          2d    2        1
...
//
#line 707 "C:\_Rapporter-Xenko3D\Rapporter\Rapporter\Rapporter.Windows\log\shader_XenkoEditorMaterialPreviewEffect_38e98be1932339c1625cd232054e94ab.hlsl"
...
#line 494
mad r6.xy, v2.xyxx, cb1[2].yzyy, cb1[3].xyxx
sample_indexable(texture2d)(float,float,float,float) r6.xyz, r6.xyxx, t2.xyzw, s0  // r6.x <- <Compute_id243 return value>.x; r6.y <- <Compute_id243 return value>.y; r6.z <- <Compute_id243 return value>.z
...
#line 468
mul r3.xyz, r6.xyzx, cb1[3].zzzz  // r3.x <- streams.matSpecularVisible_id64.x; r3.y <- streams.matSpecularVisible_id64.y; r3.z <- streams.matSpecularVisible_id64.z
...
mov r10.y, r0.w  // r10.y <- streams.NdotV_id65
...
const static bool TIsEnergyConservative_id185 = false;
...
float NormalDistributionGGX_id194(float alphaR, float nDotH)
{
    ...
    return alphaR2 / (PI_id187 * pow(max(nDotH * nDotH * (alphaR2 - 1) + 1, 0.0001), 2.0f));
}
...
{
    return Texture_id176.Sample(Sampler_id157, streams.TexCoord_id124 * scale_id178 + offset_id179).rgba;
}
...
{
    streams.matSpecular_id49 = Compute_id243(streams).rgb;
}
