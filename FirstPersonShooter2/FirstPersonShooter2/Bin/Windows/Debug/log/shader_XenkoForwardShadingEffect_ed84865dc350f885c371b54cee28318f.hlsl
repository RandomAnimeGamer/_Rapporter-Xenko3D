...
*****     Stages      *****
***************************
@G    Vertex => 439ff27ac9879bd66e1ea5f85e362fb1
//
...
//
#line 852 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ed84865dc350f885c371b54cee28318f.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
@G    Pixel => 19e49d286389bbd6625f7a8eb3c36dca
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 891 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ed84865dc350f885c371b54cee28318f.hlsl"
...
sample r4.xyzw, r4.xyxx, t0.xyzw, s2  // r4.x <- <Compute_id273 return value>.x; r4.y <- <Compute_id273 return value>.y
...
ushr r2.xy, r1.zwzz, l(6)
mov r2.w, l(0)
ld r2.xyzw, r2.xyzw, t1.xyzw  // r2.x <- streams.lightData_id87.x; r2.y <- streams.lightData_id87.y

#line 626
and r1.y, r2.y, l(0x0000ffff)  // r1.y <- <GetMaxLightCount_id231 return value>
...
mov r8.x, r6.x  // r8.x <- streams.matDiffuseVisible_id66.x
mov r9.xy, r6.yzyy  // r9.x <- streams.matDiffuseVisible_id66.y; r9.y <- streams.matDiffuseVisible_id66.z
mov r9.zw, r5.xxxy  // r9.z <- streams.matSpecularVisible_id68.x; r9.w <- streams.matSpecularVisible_id68.y
mov r10.x, r5.z  // r10.x <- streams.matSpecularVisible_id68.z
mov r10.y, r1.x  // r10.y <- streams.alphaRoughness_id67
mov r11.xyz, r0.xyzx  // r11.x <- streams.normalWS_id16.x; r11.y <- streams.normalWS_id16.y; r11.z <- streams.normalWS_id16.z
mov r12.z, r0.w  // r12.z <- streams.NdotV_id69
mov r12.x, r2.x  // r12.x <- streams.lightIndex_id88
...
#line 496
  ld r14.xyzw, r12.xxxx, t2.xyzw  // r14.x <- realLightIndex
  iadd r12.x, r12.x, l(1)  // r12.x <- streams.lightIndex_id88
  ishl r1.w, r14.x, l(1)
  ld r14.xyzw, r1.wwww, t3.xyzw  // r14.x <- pointLight1.x; r14.y <- pointLight1.y; r14.z <- pointLight1.z; r14.w <- pointLight1.w
  iadd r1.w, r1.w, l(1)
  ld r15.xyzw, r1.wwww, t3.xyzw  // r15.x <- pointLight2.x; r15.y <- pointLight2.y; r15.z <- pointLight2.z

#line 349
  add r14.xyz, -r4.xyzx, r14.xyzx  // r14.x <- lightVector.x; r14.y <- lightVector.y; r14.z <- lightVector.z
  dp3 r1.w, r14.xyzx, r14.xyzx
  sqrt r2.z, r1.w  // r2.z <- lightVectorLength
  div r14.xyz, r14.xyzx, r2.zzzz  // r14.x <- lightVectorNorm.x; r14.y <- lightVectorNorm.y; r14.z <- lightVectorNorm.z

#line 299
  max r2.z, r1.w, l(0.000100)
  div r2.z, l(1.000000, 1.000000, 1.000000, 1.000000), r2.z  // r2.z <- attenuation
...
#line 300
  mul r1.w, r1.w, r2.z  // r1.w <- attenuation

#line 355
  mul r15.xyz, r1.wwww, r15.xyzx  // r15.x <- streams.lightColor_id43.x; r15.y <- streams.lightColor_id43.y; r15.z <- streams.lightColor_id43.z

#line 616
  dp3 r1.w, r11.xyzx, r14.xyzx
  max r1.w, r1.w, l(0.000100)  // r1.w <- streams.NdotL_id47
  mul r15.xyz, r1.wwww, r15.xyzx  // r15.x <- streams.lightColorNdotL_id44.x; r15.y <- streams.lightColorNdotL_id44.y; r15.z <- streams.lightColorNdotL_id44.z

#line 608
  add r16.xyz, r7.xyzx, r14.xyzx
  dp3 r2.z, r16.xyzx, r16.xyzx
  rsq r2.z, r2.z
  mul r16.xyz, r2.zzzz, r16.xyzx  // r16.x <- streams.H_id72.x; r16.y <- streams.H_id72.y; r16.z <- streams.H_id72.z
  dp3 r2.z, r11.xyzx, r16.xyzx
  dp3 r2.w, r14.xyzx, r16.xyzx
  max r2.zw, r2.zzzw, l(0.000000, 0.000000, 0.000100, 0.000100)  // r2.z <- streams.NdotH_id73; r2.w <- streams.LdotH_id74
...
#line 294
  ...
  mul r3.w, r3.w, r3.w
  mul r2.w, r2.w, r3.w
  mad r14.xyz, r16.xyzx, r2.wwww, r14.xyzx  // r14.x <- <FresnelSchlick_id179 return value>.x; r14.y <- <FresnelSchlick_id179 return value>.y; r14.z <- <FresnelSchlick_id179 return value>.z

#line 289
  mul r2.w, r10.y, l(0.500000)  // r2.w <- k
  mad r3.w, -r10.y, l(0.500000), l(1.000000)
  mad r4.w, r1.w, r3.w, r2.w
  div r4.w, r1.w, r4.w  // r4.w <- <VisibilityhSchlickGGX_id197 return value>
  mad r2.w, r12.z, r3.w, r2.w
  div r2.w, r12.z, r2.w  // r2.w <- <VisibilityhSchlickGGX_id197 return value>

#line 341
  mul r2.w, r2.w, r4.w
  mul r1.w, r12.z, r1.w
  div r1.w, r2.w, r1.w  // r1.w <- <VisibilitySmithSchlickGGX_id199 return value>

#line 336
  mul r2.w, r10.y, r10.y  // r2.w <- alphaR2
  mul r2.z, r2.z, r2.z
  mad r3.w, r10.y, r10.y, l(-1.000000)
  mad r2.z, r2.z, r3.w, l(1.000000)
  max r2.z, r2.z, l(0.000100)
  mul r2.z, r2.z, r2.z
  mul r2.z, r2.z, l(3.141593)
  div r2.z, r2.w, r2.z  // r2.z <- <NormalDistributionGGX_id213 return value>
...
#line 714
endloop   // r12.x <- streams.lightIndex_id88

#line 587
ushr r1.y, r2.y, l(16)  // r1.y <- <GetMaxLightCount_id240 return value>
...
mov r7.xyz, r6.xyzx  // r7.x <- streams.matDiffuseVisible_id66.x; r7.y <- streams.matDiffuseVisible_id66.y; r7.z <- streams.matDiffuseVisible_id66.z
...
mov r1.z, r12.x  // r1.z <- streams.lightIndex_id88
mov r1.w, l(0)  // r1.w <- i
loop 
  ige r2.w, r1.w, r1.y
  breakc_nz r2.w
...
#line 465
  ld r14.xyzw, r1.zzzz, t2.xyzw  // r14.x <- realLightIndex
...
#line 471
  iadd r12.yzw, r2.wwww, l(0, 1, 2, 3)
  ld r15.xyzw, r12.yyyy, t4.xyzw  // r15.x <- spotLight2.x; r15.y <- spotLight2.y; r15.z <- spotLight2.z
  ld r16.xyzw, r12.zzzz, t4.xyzw  // r16.x <- spotLight3.x; r16.y <- spotLight3.y; r16.z <- spotLight3.z
  ld r17.xyzw, r12.wwww, t4.xyzw  // r17.x <- spotLight4.x; r17.y <- spotLight4.y; r17.z <- spotLight4.z

#line 321
  add r12.yzw, -r2.xxyz, r14.xxyz  // r12.y <- lightVector.x; r12.z <- lightVector.y; r12.w <- lightVector.z
  dp3 r2.w, r12.yzwy, r12.yzwy
  sqrt r3.w, r2.w  // r3.w <- lightVectorLength
  div r12.yzw, r12.yyzw, r3.wwww  // r12.y <- lightVectorNorm.x; r12.z <- lightVectorNorm.y; r12.w <- lightVectorNorm.z
...
#line 225
  mul r2.w, r16.z, r2.w  // r2.w <- factor
...
#line 275
  dp3 r3.w, -r15.xyzx, r12.yzwy  // r3.w <- cd
  mad_sat r3.w, r3.w, r16.x, r16.y  // r3.w <- attenuation
  mul r3.w, r3.w, r3.w

#line 330
  mul r2.w, r2.w, r3.w  // r2.w <- attenuation
  mul r12.yzw, r2.wwww, r17.xxyz  // r12.y <- streams.lightColor_id43.x; r12.z <- streams.lightColor_id43.y; r12.w <- streams.lightColor_id43.z

#line 577
  dp3 r2.w, r10.xyzx, -r15.xyzx
  max r2.w, r2.w, l(0.000100)  // r2.w <- streams.NdotL_id47
  mul r12.yzw, r2.wwww, r12.yyzw  // r12.y <- streams.lightColorNdotL_id44.x; r12.z <- streams.lightColorNdotL_id44.y; r12.w <- streams.lightColorNdotL_id44.z

#line 608
  add r14.xyz, r4.xyzx, -r15.xyzx
...
#line 305
  iadd r3.w, r3.w, r5.w
  ishl r7.w, r3.w, l(2)
  dp4 r14.x, r2.xyzw, cb1[r7.w + 28].xyzw  // r14.x <- shadowPosition.x
  dp4 r14.y, r2.xyzw, cb1[r7.w + 29].xyzw  // r14.y <- shadowPosition.y
  dp4 r8.w, r2.xyzw, cb1[r7.w + 30].xyzw  // r8.w <- shadowPosition.z
  dp4 r9.w, r2.xyzw, cb1[r7.w + 31].xyzw  // r9.w <- shadowPosition.w
  add r14.z, r8.w, -cb1[44].x  // r14.z <- shadowPosition.z
...
#line 221
  sample_c r9.w, r18.xyxx, t5.xxxx, s1, r14.z  // r9.w <- <SampleTextureAndCompare_id107 return value>

#line 263
  mul r10.yw, r15.xxxy, l(0.000000, 7.000000, 0.000000, 7.000000)

#line 221
  sample_c r11.w, r18.zwzz, t5.xxxx, s1, r14.z  // r11.w <- <SampleTextureAndCompare_id107 return value>
...
#line 221
  sample_c r9.w, r19.xyxx, t5.xxxx, s1, r14.z

#line 263
  mad r8.w, r10.w, r9.w, r8.w

#line 221
  sample_c r9.w, r19.zwzz, t5.xxxx, s1, r14.z
...
#line 221
  sample_c r9.w, r18.zwzz, t5.xxxx, s1, r14.z
...
#line 221
  sample_c r9.w, r17.xyxx, t5.xxxx, s1, r14.z

#line 266
  mad r8.w, r15.y, r9.w, r8.w

#line 221
  sample_c r9.w, r17.zwzz, t5.xxxx, s1, r14.z
...
#line 221
  sample_c r10.y, r10.ywyy, t5.xxxx, s1, r14.z  // r10.y <- <SampleTextureAndCompare_id107 return value>
...
#line 434
  iadd r10.y, r3.w, l(-1)
  add r10.y, -cb1[r10.y + 46].x, cb1[r3.w + 46].x
  movc r5.w, r5.w, r10.y, cb1[r3.w + 46].x  // r5.w <- splitSize
  add r3.w, -r4.w, cb1[r3.w + 46].x
  div r3.w, r3.w, r5.w  // r3.w <- splitDist
  lt r5.w, r3.w, l(0.200000)

#line 305
  iadd r7.w, r7.w, l(4)
  dp4 r14.x, r2.xyzw, cb1[r7.w + 28].xyzw  // r14.x <- shadowPosition.x
  dp4 r14.y, r2.xyzw, cb1[r7.w + 29].xyzw  // r14.y <- shadowPosition.y
  dp4 r10.y, r2.xyzw, cb1[r7.w + 30].xyzw  // r10.y <- shadowPosition.z
  dp4 r2.x, r2.xyzw, cb1[r7.w + 31].xyzw  // r2.x <- shadowPosition.w
  add r14.z, r10.y, -cb1[44].x  // r14.z <- shadowPosition.z
...
#line 241
  ...
  round_ni r10.yw, r2.xxxy  // r10.y <- base_uv.x; r10.w <- base_uv.y
  add r2.xy, r2.xyxx, -r10.ywyy  // r2.x <- s; r2.y <- t
  add r10.yw, r10.yyyw, l(0.000000, -0.500000, 0.000000, -0.500000)
  mul r10.yw, r10.yyyw, cb1[27].zzzw

#line 254
  mad r14.xy, -r2.yxyy, l(3.000000, 3.000000, 0.000000, 0.000000), l(4.000000, 4.000000, 0.000000, 0.000000)  // r14.y <- uw0; r14.x <- vw0
  mad r14.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 1.000000, 1.000000)  // r14.z <- uw2; r14.w <- vw2
  mad r15.xy, -r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(3.000000, 3.000000, 0.000000, 0.000000)
  div r15.xy, r15.xyxx, r14.yxyy
  add r15.zw, r2.xxxy, l(0.000000, 0.000000, 3.000000, 3.000000)
  div r2.xy, r2.xyxx, r14.zwzz
  ...
  add r15.xy, r2.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r15.x <- u2; r15.y <- v2
  mad r17.xyzw, r16.xwzw, cb1[27].zwzw, r10.ywyw

#line 221
  sample_c r2.x, r17.xyxx, t5.xxxx, s1, r2.z  // r2.x <- <SampleTextureAndCompare_id107 return value>
  sample_c r2.y, r17.zwzz, t5.xxxx, s1, r2.z  // r2.y <- <SampleTextureAndCompare_id107 return value>

#line 265
  mov r15.zw, r16.wwwy
  mad r17.xyzw, r15.xzxw, cb1[27].zwzw, r10.ywyw

#line 221
  sample_c r7.w, r17.xyxx, t5.xxxx, s1, r2.z  // r7.w <- <SampleTextureAndCompare_id107 return value>

#line 264
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r10.ywyw

#line 221
  sample_c r11.w, r18.xyxx, t5.xxxx, s1, r2.z  // r11.w <- <SampleTextureAndCompare_id107 return value>
  sample_c r12.w, r18.zwzz, t5.xxxx, s1, r2.z  // r12.w <- <SampleTextureAndCompare_id107 return value>
  sample_c r13.w, r17.zwzz, t5.xxxx, s1, r2.z  // r13.w <- <SampleTextureAndCompare_id107 return value>

#line 266
  mov r16.y, r15.y
  mad r16.xyzw, r16.xyzy, cb1[27].zwzw, r10.ywyw

#line 221
  sample_c r15.z, r16.xyxx, t5.xxxx, s1, r2.z  // r15.z <- <SampleTextureAndCompare_id107 return value>
  sample_c r15.w, r16.zwzz, t5.xxxx, s1, r2.z  // r15.w <- <SampleTextureAndCompare_id107 return value>

#line 268
  mad r10.yw, r15.xxxy, cb1[27].zzzw, r10.yyyw

#line 221
  sample_c r2.z, r10.ywyy, t5.xxxx, s1, r2.z  // r2.z <- <SampleTextureAndCompare_id107 return value>
...
#line 260
      mul r5.w, r14.x, r14.y
      mul r2.y, r14.x, r2.y
      mul r2.y, r2.y, l(7.000000)
      mad r2.x, r5.w, r2.x, r2.y  // r2.x <- shadow

#line 266
      mul r10.yw, r14.xxxy, r14.zzzw

#line 262
      mad r2.x, r10.y, r7.w, r2.x
      mul r2.y, r11.w, r14.y
      mad r2.x, r2.y, l(7.000000), r2.x
      mad r2.x, r12.w, l(49.000000), r2.x
      mul r2.y, r13.w, r14.z
      mad r2.x, r2.y, l(7.000000), r2.x
      mad r2.x, r10.w, r15.z, r2.x
      mul r2.y, r14.w, r15.w
      mad r2.x, r2.y, l(7.000000), r2.x
      mul r2.y, r14.w, r14.z
      mad r2.x, r2.y, r2.z, r2.x
      mul r2.x, r2.x, l(0.006944)

#line 445
      mad r2.y, r8.w, l(0.006944), -r2.x
      mad r9.w, r3.w, r2.y, r2.x
    endif 
  endif   // r9.w <- shadow
...
sample_l r0.xyzw, r3.xyzx, t6.xyzw, s0, r0.x  // r0.x <- <Compute_id258 return value>.x; r0.y <- <Compute_id258 return value>.y; r0.z <- <Compute_id258 return value>.z
