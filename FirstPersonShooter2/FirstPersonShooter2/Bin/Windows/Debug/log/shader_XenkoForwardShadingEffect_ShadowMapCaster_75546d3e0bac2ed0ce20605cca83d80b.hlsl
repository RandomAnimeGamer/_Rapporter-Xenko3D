...
*****     Stages      *****
***************************
@G    Vertex => d64fa48c030fd122c207b45cd7fa59e1
//
...
//
#line 96 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ShadowMapCaster_75546d3e0bac2ed0ce20605cca83d80b.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
cbuffer PerMaterial 
{
    ...
    float constantFloat_id152;
    float constantFloat_id154;
