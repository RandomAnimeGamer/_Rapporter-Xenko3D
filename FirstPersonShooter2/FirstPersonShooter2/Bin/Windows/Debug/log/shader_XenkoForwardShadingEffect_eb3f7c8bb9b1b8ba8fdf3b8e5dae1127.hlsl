...
//
#line 862 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_eb3f7c8bb9b1b8ba8fdf3b8e5dae1127.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
@G    Pixel => 0dbc1803749b63aa3e52254e7b470836
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 952 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_eb3f7c8bb9b1b8ba8fdf3b8e5dae1127.hlsl"
...
#line 318
  mul r7.w, r7.w, r8.w  // r7.w <- attenuation
  mul r12.xyz, r7.wwww, r13.xyzx  // r12.x <- streams.lightColor_id43.x; r12.y <- streams.lightColor_id43.y; r12.z <- streams.lightColor_id43.z

#line 565
  dp3 r7.w, r5.xyzx, -r14.xyzx
  max r7.w, r7.w, l(0.000100)  // r7.w <- streams.NdotL_id47
  mul r12.xyz, r7.wwww, r12.xyzx
  mul r12.xyz, r4.wwww, r12.xyzx  // r12.x <- streams.lightColorNdotL_id44.x; r12.y <- streams.lightColorNdotL_id44.y; r12.z <- streams.lightColorNdotL_id44.z

#line 596
  add r13.xyz, r6.xyzx, -r14.xyzx
  dp3 r8.w, r13.xyzx, r13.xyzx
  rsq r8.w, r8.w
  mul r13.xyz, r8.wwww, r13.xyzx  // r13.x <- streams.H_id72.x; r13.y <- streams.H_id72.y; r13.z <- streams.H_id72.z
