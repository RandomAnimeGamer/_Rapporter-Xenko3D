...
//
#line 870 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ba2065c47386dc979ba0ecf0ab9ff70a.hlsl"
...
@G    Pixel => 946db4fdfc4ffbd95db90ef6f13d72f6
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 899 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ba2065c47386dc979ba0ecf0ab9ff70a.hlsl"
...
#line 445
  ...
  ishl r5.x, r12.x, l(2)
  ld r12.xyzw, r5.xxxx, t3.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z

#line 451
  iadd r13.xyz, r5.xxxx, l(1, 2, 3, 0)
...
#line 255
  ...
  mad_sat r5.z, r5.z, r15.x, r15.y  // r5.z <- attenuation
  mul r5.z, r5.z, r5.z

#line 310
  mul r5.x, r5.z, r5.x  // r5.x <- attenuation
  mul r12.xyz, r5.xxxx, r13.xyzx  // r12.x <- streams.lightColor_id39.x; r12.y <- streams.lightColor_id39.y; r12.z <- streams.lightColor_id39.z
...
#line 285
  iadd r6.z, r6.z, r7.w
  ishl r9.w, r6.z, l(2)
  dp4 r13.x, r4.xyzw, cb1[r9.w + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r9.w + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r10.x, r4.xyzw, cb1[r9.w + 30].xyzw  // r10.x <- shadowPosition.z
  dp4 r11.w, r4.xyzw, cb1[r9.w + 31].xyzw  // r11.w <- shadowPosition.w
  add r13.z, r10.x, -cb1[44].x  // r13.z <- shadowPosition.z
...
#line 201
  sample_c r11.w, r18.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id109 return value>

#line 243
  mul r13.xy, r14.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 201
  sample_c r12.w, r18.zwzz, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id109 return value>
...
#line 201
  sample_c r11.w, r17.xyxx, t4.xxxx, s1, r13.z

#line 246
  mad r10.x, r13.w, r11.w, r10.x

#line 201
  sample_c r11.w, r17.zwzz, t4.xxxx, s1, r13.z
...
#line 201
  sample_c r12.w, r13.xyxx, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id109 return value>
...
#line 414
  iadd r12.w, r6.z, l(-1)
  add r12.w, -cb1[r12.w + 46].x, cb1[r6.z + 46].x
  movc r7.w, r7.w, r12.w, cb1[r6.z + 46].x  // r7.w <- splitSize
  add r6.z, -r5.w, cb1[r6.z + 46].x
  div r6.z, r6.z, r7.w  // r6.z <- splitDist
  lt r7.w, r6.z, l(0.200000)

#line 285
  iadd r9.w, r9.w, l(4)
  dp4 r13.x, r4.xyzw, cb1[r9.w + 28].xyzw  // r13.x <- shadowPosition.x
  dp4 r13.y, r4.xyzw, cb1[r9.w + 29].xyzw  // r13.y <- shadowPosition.y
  dp4 r12.w, r4.xyzw, cb1[r9.w + 30].xyzw  // r12.w <- shadowPosition.z
  dp4 r4.x, r4.xyzw, cb1[r9.w + 31].xyzw  // r4.x <- shadowPosition.w
...
#line 201
  sample_c r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id109 return value>
  sample_c r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id109 return value>
...
#line 201
  sample_c r9.w, r17.xyxx, t4.xxxx, s1, r4.z  // r9.w <- <SampleTextureAndCompare_id109 return value>

#line 244
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 201
  sample_c r12.w, r18.xyxx, t4.xxxx, s1, r4.z  // r12.w <- <SampleTextureAndCompare_id109 return value>
  sample_c r14.z, r18.zwzz, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id109 return value>
...
#line 201
  sample_c r15.z, r16.xyxx, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id109 return value>
...
#line 201
  sample_c r4.z, r13.xyxx, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id109 return value>
...
#line 419
    if_z r8.w
      ...
      mad r7.w, r6.z, l(-2.000000), l(3.000000)
      mul r6.z, r6.z, r6.z
      mul r6.z, r6.z, r7.w  // r6.z <- lerpAmt

#line 240
      mul r7.w, r13.z, r13.w
      mul r4.y, r13.z, r4.y
      mul r4.y, r4.y, l(7.000000)
      mad r4.x, r7.w, r4.x, r4.y  // r4.x <- shadow

#line 246
      mul r13.xy, r13.zwzz, r14.xyxx

#line 242
      mad r4.x, r13.x, r9.w, r4.x
...
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id275 return value>.x; r0.y <- <Compute_id275 return value>.y; r0.z <- <Compute_id275 return value>.z
