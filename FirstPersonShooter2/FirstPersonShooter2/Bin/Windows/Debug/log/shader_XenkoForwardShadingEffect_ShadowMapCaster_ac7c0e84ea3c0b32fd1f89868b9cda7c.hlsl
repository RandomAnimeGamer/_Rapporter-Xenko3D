...
*****     Stages      *****
***************************
@G    Vertex => 24fac607c96db2c11019996a326136d7
//
...
//
#line 80 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_ShadowMapCaster_ac7c0e84ea3c0b32fd1f89868b9cda7c.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
cbuffer PerMaterial 
{
    ...
    float2 scale_id85;
    float2 offset_id86;
    float constantFloat_id91;
    float constantFloat_id94;
};
cbuffer PerView 
{
    float4x4 View_id22;
