...
//
#line 842 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d54f67aa841775d9b7abf35deaa5e685.hlsl"
...
@G    Pixel => 7b87eac5da923ab321d0665d0899265b
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 871 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d54f67aa841775d9b7abf35deaa5e685.hlsl"
...
#line 480
  ...
  ishl r7.w, r12.x, l(1)
  ld r12.xyzw, r7.wwww, t3.xyzw  // r12.x <- pointLight1.x; r12.y <- pointLight1.y; r12.z <- pointLight1.z; r12.w <- pointLight1.w
  iadd r7.w, r7.w, l(1)
  ld r13.xyzw, r7.wwww, t3.xyzw  // r13.x <- pointLight2.x; r13.y <- pointLight2.y; r13.z <- pointLight2.z
...
#line 449
  ld r12.xyzw, r4.wwww, t2.xyzw  // r12.x <- realLightIndex
  iadd r4.w, r4.w, l(1)  // r4.w <- streams.lightIndex_id84
  ishl r6.w, r12.x, l(2)
  ld r12.xyzw, r6.wwww, t4.xyzw  // r12.x <- spotLight1.x; r12.y <- spotLight1.y; r12.z <- spotLight1.z

#line 455
  iadd r13.xyz, r6.wwww, l(1, 2, 3, 0)
...
#line 314
  mul r6.w, r6.w, r7.w  // r6.w <- attenuation
  mul r12.xyz, r6.wwww, r13.xyzx  // r12.x <- streams.lightColor_id39.x; r12.y <- streams.lightColor_id39.y; r12.z <- streams.lightColor_id39.z
...
#line 205
  sample_c r12.w, r18.xyxx, t5.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id102 return value>

#line 247
  mul r13.xy, r14.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 205
  sample_c r13.w, r18.zwzz, t5.xxxx, s1, r13.z  // r13.w <- <SampleTextureAndCompare_id102 return value>
...
#line 205
  sample_c r12.w, r19.xyxx, t5.xxxx, s1, r13.z

#line 247
  mad r11.w, r13.y, r12.w, r11.w

#line 205
  sample_c r12.w, r19.zwzz, t5.xxxx, s1, r13.z
...
#line 205
  sample_c r12.w, r18.zwzz, t5.xxxx, s1, r13.z
...
#line 205
  sample_c r12.w, r17.xyxx, t5.xxxx, s1, r13.z

#line 250
  mad r11.w, r13.w, r12.w, r11.w

#line 205
  sample_c r12.w, r17.zwzz, t5.xxxx, s1, r13.z
...
#line 205
  sample_c r13.x, r13.xyxx, t5.xxxx, s1, r13.z  // r13.x <- <SampleTextureAndCompare_id102 return value>
...
#line 205
  sample_c r11.y, r17.xyxx, t5.xxxx, s1, r4.z  // r11.y <- <SampleTextureAndCompare_id102 return value>

#line 248
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 205
  sample_c r14.z, r18.xyxx, t5.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id102 return value>
  sample_c r14.w, r18.zwzz, t5.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id102 return value>
  sample_c r15.z, r17.zwzz, t5.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id102 return value>
...
#line 205
  sample_c r15.w, r16.xyxx, t5.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id102 return value>
  sample_c r16.x, r16.zwzz, t5.xxxx, s1, r4.z  // r16.x <- <SampleTextureAndCompare_id102 return value>
