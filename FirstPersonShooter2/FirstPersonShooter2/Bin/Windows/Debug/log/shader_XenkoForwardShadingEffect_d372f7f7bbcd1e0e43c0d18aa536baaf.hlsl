...
//
#line 840 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d372f7f7bbcd1e0e43c0d18aa536baaf.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
//
#line 922 "C:\_Rapporter-Xenko3D\FirstPersonShooter2\FirstPersonShooter2\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_d372f7f7bbcd1e0e43c0d18aa536baaf.hlsl"
...
#line 316
  ...
  mul r12.xyz, r5.xxxx, r13.xyzx  // r12.x <- streams.lightColor_id43.x; r12.y <- streams.lightColor_id43.y; r12.z <- streams.lightColor_id43.z

#line 563
  dp3 r5.x, r6.xyzx, -r14.xyzx
  max r5.x, r5.x, l(0.000100)  // r5.x <- streams.NdotL_id47
  mul r12.xyz, r5.xxxx, r12.xyzx  // r12.x <- streams.lightColorNdotL_id44.x; r12.y <- streams.lightColorNdotL_id44.y; r12.z <- streams.lightColorNdotL_id44.z

#line 594
  add r13.xyz, r7.xyzx, -r14.xyzx
  dp3 r5.z, r13.xyzx, r13.xyzx
  rsq r5.z, r5.z
  mul r13.xyz, r5.zzzz, r13.xyzx  // r13.x <- streams.H_id72.x; r13.y <- streams.H_id72.y; r13.z <- streams.H_id72.z
...
#line 207
  sample_c r11.w, r18.xyxx, t4.xxxx, s1, r13.z  // r11.w <- <SampleTextureAndCompare_id113 return value>

#line 249
  mul r13.xy, r14.zwzz, l(7.000000, 7.000000, 0.000000, 0.000000)

#line 207
  sample_c r12.w, r18.zwzz, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c r12.w, r13.xyxx, t4.xxxx, s1, r13.z  // r12.w <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c r4.x, r17.xyxx, t4.xxxx, s1, r4.z  // r4.x <- <SampleTextureAndCompare_id113 return value>
  sample_c r4.y, r17.zwzz, t4.xxxx, s1, r4.z  // r4.y <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c r9.w, r17.xyxx, t4.xxxx, s1, r4.z  // r9.w <- <SampleTextureAndCompare_id113 return value>

#line 250
  mad r18.xyzw, r16.xyzy, cb1[27].zwzw, r13.xyxy

#line 207
  sample_c r12.w, r18.xyxx, t4.xxxx, s1, r4.z  // r12.w <- <SampleTextureAndCompare_id113 return value>
  sample_c r14.z, r18.zwzz, t4.xxxx, s1, r4.z  // r14.z <- <SampleTextureAndCompare_id113 return value>
  sample_c r14.w, r17.zwzz, t4.xxxx, s1, r4.z  // r14.w <- <SampleTextureAndCompare_id113 return value>
...
#line 207
  sample_c r15.z, r16.xyxx, t4.xxxx, s1, r4.z  // r15.z <- <SampleTextureAndCompare_id113 return value>
  sample_c r15.w, r16.zwzz, t4.xxxx, s1, r4.z  // r15.w <- <SampleTextureAndCompare_id113 return value>

#line 254
  mad r13.xy, r15.xyxx, cb1[27].zwzz, r13.xyxx

#line 207
  sample_c r4.z, r13.xyxx, t4.xxxx, s1, r4.z  // r4.z <- <SampleTextureAndCompare_id113 return value>
...
sample_l r0.xyzw, r1.xyzx, t5.xyzw, s0, r0.x  // r0.x <- <Compute_id279 return value>.x; r0.y <- <Compute_id279 return value>.y; r0.z <- <Compute_id279 return value>.z
